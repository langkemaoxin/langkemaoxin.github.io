---
title: "MySQL 为什么 InnoDB 是默认引擎"
sidebarGroup: "大厂真题"
shortTitle: "MySQL 为什么 InnoDB 是默认引擎"
order: 62
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "MySQL中的InnoDB引擎是默认引擎，主要基于以下几个原因：事务支持：InnoDB是MySQL唯一一个提供事务支持的引擎。事务是一组操作的集合，要么全部成功，要么全部失败，确保数据的一致性和可靠性。对于具有高并发读写需求的应用，如电子商"
article: false
---

> 来源：[MySQL 为什么 InnoDB 是默认引擎](https://www.yuque.com/tulingzhouyu/db22bv/ea6i8e7zsdfdzd6c)
