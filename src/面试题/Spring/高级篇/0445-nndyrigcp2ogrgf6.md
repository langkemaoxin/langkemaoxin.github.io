---
title: "Spring事件监听的核心机制是什么？"
sidebarGroup: "高级篇"
shortTitle: "Spring事件监听的核心机制是什么？"
order: 445
date: 2026-05-13
category: "面试题"
tag:
  - "面试题"
description: "Spring事件监听的核心机制围绕观察者模式展开：观察者模式： 它允许一个对象（称为主题或被观察者）维护一组依赖于它的对象（称为观察者），并在主题状态发生变化时通知观察者。它包含三个核心：事件： 事件是观察者模式中的主题状态变化的具体表示，"
article: false
---

> 来源：[Spring事件监听的核心机制是什么？](https://www.yuque.com/tulingzhouyu/db22bv/nndyrigcp2ogrgf6)
