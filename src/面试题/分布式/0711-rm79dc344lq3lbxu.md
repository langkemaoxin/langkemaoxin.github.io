...
tag:
  - "面试题"
description: "最近有一位粉丝在后台留言，面试的时候被问到什么CAP原则，当时回答的不是很好，导致错失offer，今天我们就来好好聊聊这个问题其实CAP原则是分布式系统设计中的一个基本原则，它指的是在分布式计算中，一致性-C、可用性-A、分区容错性-P 这"
article: false
---

> 来源：[短视频](https://www.yuque.com/tulingzhouyu/db22bv/rm79dc344lq3lbxu)
