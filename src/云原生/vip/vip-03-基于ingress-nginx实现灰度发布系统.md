...
工作中，我们会经常对应用进行升级发版，在互联网公司尤为频繁，主要是为了满足快速的业务发展。我们经常用到的发布方式有滚动更新、蓝绿发布、灰度发布。
...
![image-20231013083429600](/云原生/vip/vip-03-基于ingress-nginx实现灰度发布系统/image-20231013083429600.png)
...
![image-20231013084523997](/云原生/vip/vip-03-基于ingress-nginx实现灰度发布系统/image-20231013084523997.png)
...
![image-20231013093528604](/云原生/vip/vip-03-基于ingress-nginx实现灰度发布系统/image-20231013093528604.png)

![image-20231013093709673](/云原生/vip/vip-03-基于ingress-nginx实现灰度发布系统/image-20231013093709673.png)
...
![image-20231013094055365](/云原生/vip/vip-03-基于ingress-nginx实现灰度发布系统/image-20231013094055365.png)

![image-20231013094123408](/云原生/vip/vip-03-基于ingress-nginx实现灰度发布系统/image-20231013094123408.png)

![image-20231013094243973](/云原生/vip/vip-03-基于ingress-nginx实现灰度发布系统/image-20231013094243973.png)

![image-20231013094322906](/云原生/vip/vip-03-基于ingress-nginx实现灰度发布系统/image-20231013094322906.png)

![image-20231013094402166](/云原生/vip/vip-03-基于ingress-nginx实现灰度发布系统/image-20231013094402166.png)
...
> 使用 Cookie 则无法自定义 value，以模拟灰度成都地域用户为例，仅将带有名为 `user_from_shenzhen` 的 Cookie 的请求转发给当前 Canary Ingress
