...
shortTitle: 49 kubernetes集群客户端命令 kubect
order: 49
...
![](/云原生/k8s-ops/k8s-ops-49-kubernetes集群客户端命令-kubectl/kubectl命令帮助1.png)

![](/云原生/k8s-ops/k8s-ops-49-kubernetes集群客户端命令-kubectl/kubectl命令帮助2.png)
