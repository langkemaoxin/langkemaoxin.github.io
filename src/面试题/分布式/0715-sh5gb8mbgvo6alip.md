...
title: "说下paxos算法"
sidebarGroup: "分布式"
shortTitle: "说下paxos算法"
order: 715
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "Paxos 有点类似前面说的 2PC，3PC，但比这两种算法更加完善。在很多多大厂都得到了工程实践，比如阿里的 OceanBase 的 分布式数据库， Google 的 chubby 分布式锁 。Paxos算法是什么？Paxos 算法是 基"
article: false
---

> 来源：[说下paxos算法](https://www.yuque.com/tulingzhouyu/db22bv/sh5gb8mbgvo6alip)
