...
tag:
  - "面试题"
description: "线程调度1、线程状态线程是cpu任务调度的最小执行单位，每个线程拥有自己独立的程序计数器、虚拟机栈、本地方法栈。线程状态：创建、就绪、运行、阻塞、死亡2、线程状态切换3、阻塞唤醒过程阻塞：这三个方法的调用都会使当前线程阻塞。该线程将会被放置"
article: false
---

> 来源：[多线程篇](https://www.yuque.com/tulingzhouyu/db22bv/zaghg96a8rlwdryg)
...
![image](/面试题/面试必看/大厂真题/0034-multi-threaded/img-9ecdb8304fc1.png)

**2、线程状态切换**

![image](/面试题/面试必看/大厂真题/0034-multi-threaded/img-659bd90a1379.png)

![image](/面试题/面试必看/大厂真题/0034-multi-threaded/img-15fa6b95a843.png)
...
![image](/面试题/面试必看/大厂真题/0034-multi-threaded/img-d14fa3940eae.png)

**2、线程处理任务过程**

![image](/面试题/面试必看/大厂真题/0034-multi-threaded/img-3111c2d3fbe8.png)
...
![image](/面试题/面试必看/大厂真题/0034-multi-threaded/img-8bd7543c0889.png)
...
![image](/面试题/面试必看/大厂真题/0034-multi-threaded/img-d7dcc9590df1.png)
...
![image](/面试题/面试必看/大厂真题/0034-multi-threaded/img-7bb5f42b743e.png)
...
![image](/面试题/面试必看/大厂真题/0034-multi-threaded/img-4b4b0dfa1bd9.png)
...
![image](/面试题/面试必看/大厂真题/0034-multi-threaded/img-09205ee12a71.png)
