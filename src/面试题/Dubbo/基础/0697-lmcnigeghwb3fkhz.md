---
title: "Dubbo的集群容错策略有哪些？它们的工作原理是什么？"
sidebarGroup: "基础"
shortTitle: "Dubbo的集群容错策略有哪些？它们的工作原理是什么？"
order: 697
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "Dubbo提供了多种集群容错策略，用于处理在分布式环境中可能出现的故障和异常情况，以保障系统的稳定性和可靠性。以下是Dubbo支持的一些集群容错策略及其工作原理： Failover（重试）： 这是默认的容错策略。当调用失败时，Dubbo会自"
article: false
---

> 来源：[Dubbo的集群容错策略有哪些？它们的工作原理是什么？](https://www.yuque.com/tulingzhouyu/db22bv/lmcnigeghwb3fkhz)
