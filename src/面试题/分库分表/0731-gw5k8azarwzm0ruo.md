---
title: "ShardingSphere支持水平分片和垂直分片吗？请解释 它们的区别。"
sidebarGroup: "分库分表"
shortTitle: "ShardingSphere支持水平分片和垂直分片吗？请解释 它们的区别。"
order: 731
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "ShardingSphere是支持水平分片和垂直分片的，但它们的区别在于：垂直分片：是在应用层面上进行的一种策略，它主要是为了解决单台数据库性能瓶颈的问题，将数据根据业务逻辑分类进行分片存储。每个表中的数据会被分散到不同的数据库中。它的优点"
article: false
---

> 来源：[ShardingSphere支持水平分片和垂直分片吗？请解释 它们的区别。](https://www.yuque.com/tulingzhouyu/db22bv/gw5k8azarwzm0ruo)
