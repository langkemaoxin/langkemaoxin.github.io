---
title: "什么是Dubbo？它的主要作用是什么？"
sidebarGroup: "基础"
shortTitle: "什么是Dubbo？它的主要作用是什么？"
order: 693
date: 2026-01-07
category: "面试题"
tag:
  - "面试题"
description: "Dubbo是阿里巴巴开源的一个高性能、轻量级的分布式服务框架，用于构建可扩展的分布式应用和服务治理体系。它提供了一系列功能和特性，旨在简化分布式系统的开发和管理。以下是Dubbo的主要作用： 远程调用： Dubbo允许在分布式系统中通过远程"
article: false
---

> 来源：[什么是Dubbo？它的主要作用是什么？](https://www.yuque.com/tulingzhouyu/db22bv/bcq3p6razr9ga5kx)
