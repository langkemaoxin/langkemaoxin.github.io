---
title: "MySQL为什么默认使用RR隔离级别"
sidebarGroup: "Mysql"
shortTitle: "MySQL为什么默认使用RR隔离级别"
order: 375
date: 2026-03-17
category: "面试题"
tag:
  - "面试题"
description: "MySQL 默认使用 Repeatable Read (RR) 隔离级别主要是为了在性能与一致性之间取得一个较好的平衡。让我们详细探讨一下使用 RR 隔离级别的理由：一致性保证：RR 提供了较高的一致性保障。它保证在同一个事务中, 相同的 "
article: false
---

> 来源：[MySQL为什么默认使用RR隔离级别](https://www.yuque.com/tulingzhouyu/db22bv/lug14uq7bkzgh858)
