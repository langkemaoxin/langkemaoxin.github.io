...
title: "Java中止线程的三种方式"
sidebarGroup: "Java基础"
shortTitle: "Java中止线程的三种方式"
order: 166
date: 2026-06-07
category: "面试题"
tag:
  - "面试题"
description: "停止一个线程通常意味着在线程处理任务完成之前停掉正在做的操作，也就是放弃当前的操作。在 Java 中有以下 3 种方法可以中止正在运行的线程：使用退出标志，使线程正常退出，也就是当 run() 方法完成后线程中止。使用 stop() 方法强"
article: false
---

> 来源：[Java中止线程的三种方式](https://www.yuque.com/tulingzhouyu/db22bv/pf0y1xsbv1g3zb29)
