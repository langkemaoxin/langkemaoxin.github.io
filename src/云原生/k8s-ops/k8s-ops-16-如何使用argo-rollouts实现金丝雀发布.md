...
shortTitle: 16 如何使用argo-rollouts实现金丝雀发布
order: 16
...
![img](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/57937c299eb9e36a75a128bcdb4ac47722d568.jpg)
...
![img](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/e9cf4e268aa738e860f10559e8ce96944a85f3.jpg)
...
![img](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/f2b26c646d5c7537d4e798a59af1ea7cbfbcb0.jpg)
...
![image-20231213100932820](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231213100932820.png)

![image-20231213100955045](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231213100955045.png)

![image-20231213101045674](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231213101045674.png)
...
![image-20231213101512199](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231213101512199.png)

![image-20231213101603479](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231213101603479.png)
...
![image-20231213160527100](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231213160527100.png)

![image-20231213160916599](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231213160916599.png)

点击 Rollout 可以进行详细页面，在详细页面可以看到 Rollout 的配置信息，还可以直接在 UI 界面上执行一些常用的操作，比如重启、重启、中断等。

![image-20231213161346355](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231213161346355.png)
...
![image-20231013093528604](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231013093528604.png)

![image-20231013093709673](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231013093709673.png)
...
![image-20231213161519155](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231213161519155.png)
...
![image-20231013094055365](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231013094055365.png)

![image-20231013094123408](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231013094123408.png)

![image-20231013094243973](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231013094243973.png)

![image-20231013094322906](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231013094322906.png)

![image-20231013094402166](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231013094402166.png)
...
![image-20231213121005824](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231213121005824.png)

通过域名访问，可以看到如下界面。

![image-20231213121328821](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231213121328821.png)
...
![image-20231213122013400](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231213122013400.png)
...
![image-20231213122254495](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231213122254495.png)
...
![image-20231213122645853](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231213122645853.png)
...
![image-20231213122902403](/云原生/k8s-ops/k8s-ops-16-如何使用argo-rollouts实现金丝雀发布/image-20231213122902403.png)
