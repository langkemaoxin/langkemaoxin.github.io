...
title: "数据库三大范式是什么"
sidebarGroup: "Mysql"
shortTitle: "数据库三大范式是什么"
order: 376
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "数据库三大范式是关系数据库设计中的一组规范，旨在提高数据结构的合理性、减少数据冗余和提高数据操作的效率。它们分别是：第一范式（1NF）：确保每个数据列都是不可再分的原子值，即每个单元格中只包含一个值。这可以通过将表拆分为更小的表来实现，每个"
article: false
---

> 来源：[数据库三大范式是什么](https://www.yuque.com/tulingzhouyu/db22bv/rnuihvu5o3vwbh4b)
