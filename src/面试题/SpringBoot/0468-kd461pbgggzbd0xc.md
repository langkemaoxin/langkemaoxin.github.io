...
shortTitle: "Springboot的自动配置原理？"
order: 468
date: 2026-06-21
category: "面试题"
tag:
  - "面试题"
description: "引入@EnableAutoConfiguration： 在Spring Boot应用程序的主配置类（通常是带有@SpringBootApplication注解的类）中，通常会引入@EnableAutoConfiguration注解，该注解负"
article: false
---

> 来源：[Springboot的自动配置原理？](https://www.yuque.com/tulingzhouyu/db22bv/kd461pbgggzbd0xc)
