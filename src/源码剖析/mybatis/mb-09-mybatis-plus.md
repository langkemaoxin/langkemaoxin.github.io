---
title: "09-MyBatis-Plus的使用"
sidebarGroup: "MyBatis"
shortTitle: "09-MyBatis-Plus的使用"
order: 9
date: 2026-08-09
category: "源码剖析"
tag:
  - "MyBatis"
description: "09-MyBatis-Plus的使用"
---

> 来源：[09-MyBatis-Plus的使用](https://share.note.youdao.com/ynoteshare/index.html?id=5d41fd41d970f1af9185ea2ec0647b64&type=notebook#/60EAD9B5E84E42DAB09634B04CAE4B16)
...
![image](/源码剖析/mybatis/mb-09-mybatis-plus/img-001.png)
...
```java
package cn.tulingxueyuan.injector;
...
```xml
 <bean id="globalConfig" class="com.baomidou.mybatisplus.core.config.GlobalConfig">
    ...
    <bean id="myinject" class="cn.tulingxueyuan.injector.MyInjector"></bean>
```
...
```xml
  <bean id="globalConfig" class="com.baomidou.mybatisplus.core.config.GlobalConfig">
    ...
    <bean id="myMeta" class="cn.tulingxueyuan.fill.MyMetaObjectHandler"></bean>
```
