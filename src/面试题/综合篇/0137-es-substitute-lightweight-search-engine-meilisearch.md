---
title: "ES代替品：轻量级搜索引擎MeiliSearch"
sidebarGroup: "综合篇"
shortTitle: "ES代替品：轻量级搜索引擎MeiliSearch"
order: 137
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "谈到搜索引擎，可能大家最先想到的是Elasicsearch。Elasticsearch是一个分布式、高扩展、高实时的搜索与数据分析引擎，能够在大量的数据中搜索、分析和探索需要的数据。数据库排名：https://db-engines.com/"
article: false
---

> 来源：[ES代替品：轻量级搜索引擎MeiliSearch](https://www.yuque.com/tulingzhouyu/db22bv/umueacgcmg5gvwpn)
...
![image](/面试题/综合篇/0137-es-substitute-lightweight-search-engine-meilisearch/img-bf14671413cb.png)
...
![image](/面试题/综合篇/0137-es-substitute-lightweight-search-engine-meilisearch/img-570a347946d4.png)
