---
title: "谈谈对Spring事务和AOP底层实现原理的区别"
sidebarGroup: "高级篇"
shortTitle: "谈谈对Spring事务和AOP底层实现原理的区别"
order: 440
date: 2026-06-06
category: "面试题"
tag:
  - "面试题"
description: "Spring的声明式事务其实也是通过AOP的这一套底层实现原理实现的，都是通过同一个bean的后置处理器来完成的动态代理创建只是： 创建动态代理的匹配方式不一样: 区别就是AOP的增强通常是通过切面+切点+通知来完成的， 在创建bean的时"
article: false
---

> 来源：[谈谈对Spring事务和AOP底层实现原理的区别](https://www.yuque.com/tulingzhouyu/db22bv/zimkfnsvx3m5ogo1)
