---
title: "CHAR 和 VARCHAR 的区别？"
sidebarGroup: "Mysql"
shortTitle: "CHAR 和 VARCHAR 的区别？"
order: 396
date: 2026-03-18
category: "面试题"
tag:
  - "面试题"
description: "CHAR和VARCHAR的区别可以总结如下：存储方式：CHAR是固定长度的字符类型，而VARCHAR是可变长度的字符类型。占用空间：CHAR会以固定的长度存储数据，不论实际存储的字符数目，而VARCHAR则根据实际需要的空间动态分配存储。尾"
article: false
---

> 来源：[CHAR 和 VARCHAR 的区别？](https://www.yuque.com/tulingzhouyu/db22bv/sifgcq659b34bzpz)
