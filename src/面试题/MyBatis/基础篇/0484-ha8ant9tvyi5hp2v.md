---
title: "MyBatis中XML映射有哪些标签？"
sidebarGroup: "基础篇"
shortTitle: "MyBatis中XML映射有哪些标签？"
order: 484
date: 2026-06-21
category: "面试题"
tag:
  - "面试题"
description: "除了常见的select、insert、update和delete标签，MyBatis的XML映射文件中还有一些其他标签用于更复杂的操作和配置。以下是一些常见的额外标签： resultMap： 用于定义查询结果与Java对象之间的映射关系，可"
article: false
---

> 来源：[MyBatis中XML映射有哪些标签？](https://www.yuque.com/tulingzhouyu/db22bv/ha8ant9tvyi5hp2v)
