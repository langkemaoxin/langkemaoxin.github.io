---
title: "Nacos、Eureka、Zookeeper注册中心的区别"
sidebarGroup: "SpringCloud"
shortTitle: "Nacos、Eureka、Zookeeper注册中心的区别"
order: 561
date: 2026-05-09
category: "面试题"
tag:
  - "面试题"
description: "Nacos、Eureka和Zookeeper都是常用的注册中心，它们在功能和实现方式上存在一些不同。Nacos除了作为注册中心外，还提供了配置管理、服务发现和事件通知等功能。Nacos默认情况下采用AP架构保证服务可用性，CP架构底层采用R"
article: false
---

> 来源：[Nacos、Eureka、Zookeeper注册中心的区别](https://www.yuque.com/tulingzhouyu/db22bv/spfvu14fptvuc6un)
