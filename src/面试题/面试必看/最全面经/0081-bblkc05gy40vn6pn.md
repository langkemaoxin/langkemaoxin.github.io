...
tag:
  - "面试题"
description: "Java基础Vector,ArrayList, LinkedList的区别是什么？答：Vector、ArrayList都是以类似数组的形式存储在内存中，LinkedList则以链表的形式进行存储。List中的元素有序、允许有重复的元素，Se"
article: false
---

> 来源：[阿里面试](https://www.yuque.com/tulingzhouyu/db22bv/bblkc05gy40vn6pn)
