---
title: "介绍下SpringAop的底层实现"
sidebarGroup: "高级篇"
shortTitle: "介绍下SpringAop的底层实现"
order: 450
date: 2026-06-06
category: "面试题"
tag:
  - "面试题"
description: "Spring AOP是Spring框架的一个重要组成部分，用于实现面向切面编程。它通过在方法调用前、调用后或异常抛出时插入通知，允许开发者在核心业务逻辑之外执行横切关注点的代码。底层实现主要分两部分：创建AOP动态代理和调用代理在启动Spr"
article: false
---

> 来源：[介绍下SpringAop的底层实现](https://www.yuque.com/tulingzhouyu/db22bv/hqis2gtc02278paf)
