---
title: "两个对象 hashCode（）相同，则equals（）否也一定为true？"
sidebarGroup: "Java基础"
shortTitle: "两个对象 hashCode（）相同，则equals（）否也一定为true？"
order: 174
date: 2026-03-13
category: "面试题"
tag:
  - "面试题"
description: "不一定。根据Java的规范，如果两个对象的hashCode()返回值相同，那么它们可能相等，但并不保证一定相等。在某些情况下，两个不同的对象可能会产生相同的哈希码，这就是所谓的哈希冲突。因此，在判断两个对象是否相等时，还需要使用equals"
article: false
---

> 来源：[两个对象 hashCode（）相同，则equals（）否也一定为true？](https://www.yuque.com/tulingzhouyu/db22bv/gnv3dsz1q549gauk)
