---
title: "DDD 的四层领域模型是怎样的？包含哪些基础概念？"
sidebarGroup: "DDD架构"
shortTitle: "DDD 的四层领域模型是怎样的？包含哪些基础概念？"
order: 756
date: 2026-05-26
category: "面试题"
tag:
  - "面试题"
description: "DDD的四层领域模型如下所示：展现层：这一层负责向用户显示信息和解释用户命令，完成前端界面逻辑。并将用户请求传递给应用层。应用层：这一层是很薄的一层，负责协调领域层中的领域对象，组成具体应用场景。应用层要尽量简单，不包含业务规则或者知识，不"
article: false
---

> 来源：[DDD 的四层领域模型是怎样的？包含哪些基础概念？](https://www.yuque.com/tulingzhouyu/db22bv/mp9ho4zo4eu1zw4u)
