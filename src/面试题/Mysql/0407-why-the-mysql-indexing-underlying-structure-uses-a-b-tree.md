---
title: "MySQL索引底层结构为什么使用 B+树"
sidebarGroup: "Mysql"
shortTitle: "MySQL索引底层结构为什么使用 B+树"
order: 407
date: 2026-07-02
category: "面试题"
tag:
  - "面试题"
description: "MySQL使用B+树作为索引的底层结构有以下几个主要原因：良好的平衡性：B+树是一种自平衡的树结构，不论是在插入、删除还是查询操作中，它都能保持相对较好的平衡状态。这使得B+树能够快速定位到目标数据，提高查询效率。顺序访问性：B+树的所有叶"
article: false
---

> 来源：[MySQL索引底层结构为什么使用 B+树](https://www.yuque.com/tulingzhouyu/db22bv/rmzpopi8qdtbib9g)
