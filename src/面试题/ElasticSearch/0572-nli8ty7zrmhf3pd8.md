---
title: "什么是Analyzer，它用于什么"
sidebarGroup: "ElasticSearch"
shortTitle: "什么是Analyzer，它用于什么"
order: 572
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "Analyzer是ElasticSearch中的一个组件，用于将输入的文本转化为索引时使用的文本特征向量。这主要包括将文本分解成一个个的词汇单元（例如单词或短语），并将这些词汇单元转化为特定的文本特征。Analyzer在ElasticSea"
article: false
---

> 来源：[什么是Analyzer，它用于什么](https://www.yuque.com/tulingzhouyu/db22bv/nli8ty7zrmhf3pd8)
