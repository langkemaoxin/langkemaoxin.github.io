---
title: "Kubernetes中的调度器是什么？请简述其作用"
sidebarGroup: "Docker与K8S"
shortTitle: "Kubernetes中的调度器是什么？请简述其作用"
order: 1366
date: 2026-02-19
category: "面试题"
tag:
  - "面试题"
description: "Kubernetes中的调度器是kube-scheduler，它的主要作用是在整个集群中根据预定的策略和算法，为新创建的Pod分配最优的工作节点。调度器通过监听API Server，发现新创建且尚未被调度的Pod。然后，它会根据一系列预选策"
article: false
---

> 来源：[Kubernetes中的调度器是什么？请简述其作用](https://www.yuque.com/tulingzhouyu/db22bv/fnio7gvhy092w5af)
