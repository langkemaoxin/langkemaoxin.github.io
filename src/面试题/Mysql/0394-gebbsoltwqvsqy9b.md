...
title: "并发事务带来哪些问题?"
sidebarGroup: "Mysql"
shortTitle: "并发事务带来哪些问题?"
order: 394
date: 2026-02-27
category: "面试题"
tag:
  - "面试题"
description: "并发事务可以带来以下几个问题：脏读（Dirty Read）：一个事务读取了另一个事务未提交的数据。假设事务A修改了一条数据但未提交，事务B却读取了这个未提交的数据，导致事务B基于不准确的数据做出了错误的决策。不可重复读（Non-repeat"
article: false
---

> 来源：[并发事务带来哪些问题?](https://www.yuque.com/tulingzhouyu/db22bv/gebbsoltwqvsqy9b)
