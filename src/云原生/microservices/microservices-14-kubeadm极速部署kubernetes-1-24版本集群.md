...
# 一、Kubernetes 1.24版本集群部署

## 1.1 Kubernetes 1.24版本集群部署环境准备
...
![image-20220507120653090](/云原生/microservices/microservices-14-kubeadm极速部署kubernetes-1-24版本集群/image-20220507120653090.png)

![image-20220507120725815](/云原生/microservices/microservices-14-kubeadm极速部署kubernetes-1-24版本集群/image-20220507120725815.png)

![image-20230220180035176](kubeadm极速部署Kubernetes 1.24版本集群.assets\image-20230220180035176.png)

![image-20230220180130670](kubeadm极速部署Kubernetes 1.24版本集群.assets\image-20230220180130670.png)

## 1.3 kubernetes 1.24.X  集群部署
...
~~~powershell
[root@k8s-master01 ~]# kubeadm init --kubernetes-version=v1.24.X --pod-network-cidr=10.244.0.0/16 --apiserver-advertise-address=192.168.10.140  --cri-socket unix:///var/run/cri-dockerd.sock
~~~
...
![image-20230220180313085](kubeadm极速部署Kubernetes 1.24版本集群.assets\image-20230220180313085.png)

![image-20230220180556878](kubeadm极速部署Kubernetes 1.24版本集群.assets\image-20230220180556878.png)
...
~~~powershell
[root@k8s-worker01 ~]# kubeadm join 192.168.10.140:6443 --token 8x4o2u.hslo8xzwwlrncr8s \                              --discovery-token-ca-cert-hash sha256:7323a8b0658fc33d89e627f078f6eb16ac94394f9a91b3335dd3ce73a3f313a0 --cri-socket unix:///var/run/cri-dockerd.sock
~~~

~~~powershell
[root@k8s-worker02 ~]# kubeadm join 192.168.10.140:6443 --token 8x4o2u.hslo8xzwwlrncr8s \
...
k8s-master01   Ready    control-plane   12h   v1.24.9
k8s-worker01   Ready    <none>          12h   v1.24.9
k8s-worker02   Ready    <none>          12h   v1.24.9
~~~
