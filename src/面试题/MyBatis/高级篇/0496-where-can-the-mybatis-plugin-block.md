---
title: "MyBatis的插件能够在哪些地方进行拦截？"
sidebarGroup: "高级篇"
shortTitle: "MyBatis的插件能够在哪些地方进行拦截？"
order: 496
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "MyBatis的插件可以在MyBatis的执行过程中的多个关键点进行拦截和干预。这些关键点包括： Executor（执行器）层面的拦截： 这是SQL语句的执行层面，插件可以在SQL语句执行前后进行拦截。这包括了SQL的预处理、参数设置、查询"
article: false
---

> 来源：[MyBatis的插件能够在哪些地方进行拦截？](https://www.yuque.com/tulingzhouyu/db22bv/bhm90dn40rhcgp94)
