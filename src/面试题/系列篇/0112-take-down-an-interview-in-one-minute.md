...
title: "🚛 一分钟拿下一道面试题"
sidebarGroup: "系列篇"
shortTitle: "🚛 一分钟拿下一道面试题"
order: 112
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "1.int和Integer有什么区别？基本类型/包装类型：Integer是int的包装类型，int则是java的一种基本数据类型。空值表示：Integer的默认值是null，int的默认值是0。类型转换：int通过强制类型转换为其他类型，如"
article: false
---

> 来源：[🚛 一分钟拿下一道面试题](https://www.yuque.com/tulingzhouyu/db22bv/kdhefpgyi2dbcn2b)

# 1.int和Integer有什么区别？

- **基本类型/包装类型：Integer是int的包装类型，int则是java的一种基本数据类型。**
- **空值表示：Integer的默认值是null，int的默认值是0。**
- **类型转换：int通过强制类型转换为其他类型，如 long，float 或double。Integer使用相应的方法进行********类型转换，如intValue() 将其转换为 int 值。**
...
![image](/面试题/系列篇/0112-take-down-an-interview-in-one-minute/img-23575e95b823.png)
...
![image](/面试题/系列篇/0112-take-down-an-interview-in-one-minute/img-cd2db7039e12.png)
