...
| 和前几站 | ACE 仍重要，但不唯一 | 第 5 站「令牌挂在进程上」在这里落地 |

第 16 站的 Kerberos 票据：解决**网上如何证明你是谁**；  
本站：解决**证明之后，本机还有哪些能力、进程实际揣哪张通行证**。别混成一个词。
