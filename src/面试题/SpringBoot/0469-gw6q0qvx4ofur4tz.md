---
title: "Spring和SpringBoot的关系和区别？"
sidebarGroup: "SpringBoot"
shortTitle: "Spring和SpringBoot的关系和区别？"
order: 469
date: 2026-06-11
category: "面试题"
tag:
  - "面试题"
description: "他们的关系是：Spring是框架，Spring Boot是个脚手架： Spring是一个全功能的Java应用程序框架，旨在帮助开发人员构建各种类型的应用程序，包括Web应用、企业级应用、批处理应用等。Spring提供了大量的组件和功能，但需"
article: false
---

> 来源：[Spring和SpringBoot的关系和区别？](https://www.yuque.com/tulingzhouyu/db22bv/gw6q0qvx4ofur4tz)
