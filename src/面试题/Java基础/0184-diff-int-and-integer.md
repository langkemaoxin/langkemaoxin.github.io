...
sidebarGroup: "Java基础"
shortTitle: "int和Integer的区别"
order: 184
date: 2026-07-12
category: "面试题"
tag:
  - "面试题"
description: "int和Integer之间的区别主要在以下几个方面：数据类型：int是Java的基本数据类型，而Integer是int的包装类，属于引用类型。可空性：int是基本数据类型，它不能为null。而Integer是一个对象，可以为null。自动装"
article: false
---

> 来源：[int和Integer的区别](https://www.yuque.com/tulingzhouyu/db22bv/cqglnfrk7wvyoxxw)
