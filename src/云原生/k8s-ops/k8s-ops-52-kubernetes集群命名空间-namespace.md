---
title: Kubernetes集群命名空间（Namespace）
sidebarGroup: K8s 运维笔记
shortTitle: 52 Kubernetes集群命名空间（Namespa
order: 52
...
tag:
  ...
  - 云原生
  - 课程笔记
description: 'Kubernetes集群命名空间（Namespace） 一、命名空间(namespace)作用 Namespace是对一组资源和对象的抽象集合. 常见的 pod, service, deploymen...'
---
