---
title: "什么是ShardingSphere，它的主要功能是什么？"
sidebarGroup: "分库分表"
shortTitle: "什么是ShardingSphere，它的主要功能是什么？"
order: 726
date: 2026-03-05
category: "面试题"
tag:
  - "面试题"
description: "ShardingSphere 是一套开源的分布式数据库中间件解决方案组成的生态圈，主要由 JDBC、Proxy 组成。这两个产品均提供标准化的数据分片、分布式事务和数据库治理功能，可适用于如 Java 同构、异构语言、云原生等各种多样化的应"
article: false
---

> 来源：[什么是ShardingSphere，它的主要功能是什么？](https://www.yuque.com/tulingzhouyu/db22bv/gzhabkzngpg69pqq)
