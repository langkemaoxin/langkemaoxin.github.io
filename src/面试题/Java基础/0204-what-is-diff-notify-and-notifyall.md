...
sidebarGroup: "Java基础"
shortTitle: "notify()和 notifyAll()有什么区别"
order: 204
date: 2026-07-12
category: "面试题"
tag:
  - "面试题"
description: "在Java中，notify()和notifyAll()都属于Object类的方法，用于实现线程间的通信。notify()方法用于唤醒在当前对象上等待的单个线程。如果有多个线程同时在某个对象上等待（通过调用该对象的wait()方法），则只会唤"
article: false
---

> 来源：[notify()和 notifyAll()有什么区别](https://www.yuque.com/tulingzhouyu/db22bv/wg6cczzk8k7b71ug)
