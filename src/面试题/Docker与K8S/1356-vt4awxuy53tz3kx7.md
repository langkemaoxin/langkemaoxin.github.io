...
shortTitle: "5分钟带你弄懂什么是K8s"
order: 1356
date: 2026-06-23
category: "面试题"
tag:
  - "面试题"
description: "K8s 是什么？K8S 是单词 Kubernetes 的缩写，是用于自动部署、扩缩和管理容器化应用程序的开源系统，K8s 源自Google 15 年生产环境的运维经验，同时凝聚了社区的最佳创意和实践。K8s 是用来解决什么问题的？K8S在基"
article: false
---
