---
title: "HashMap底层原理常见面试题"
sidebarGroup: "Java基础"
shortTitle: "HashMap底层原理常见面试题"
order: 163
date: 2026-08-03
category: "面试题"
tag:
  - "面试题"
description: "1、HashMap 的底层数据结构在 JDK 1.7 中 HashMap 是以「数组加链表」的形式组成的，JDK 1.8 之后新增了「红黑树」的组成结构，「当链表长度大于 8 并且 hash 桶的容量大于 64 时，链表结构会转换成红黑树结"
article: false
---

> 来源：[HashMap底层原理常见面试题](https://www.yuque.com/tulingzhouyu/db22bv/flzcleillddvwrm2)

### 1、HashMap 的底层数据结构

在 **JDK 1.7 **中 HashMap 是以**「数组加链表」**的形式组成的，**JDK 1.8** 之后新增了**「红黑树」**的组成结构，**「当链表长度大于 8 并且 hash 桶的容量大于 64 时，链表结构会转换成红黑树结构」**。所以，它的组成结构如下图所示：

![image](/面试题/Java基础/0163-hashmap-underlying-principles-interview/img-01c1b356d0d0.png)
...
![image](/面试题/Java基础/0163-hashmap-underlying-principles-interview/img-7a85adfb3a75.png)

初次 put

以上没 hash 冲突时，若发生 hash 冲突就得引入链表啦。假设我再次 put （"元直"，666），在 HashMap 中插入 "元直" 这个元素，通过 hash 算法算出 index 位置也是 3。这时的结构如下所示：形成了链表。

![image](/面试题/Java基础/0163-hashmap-underlying-principles-interview/img-7ffa51faeb0e.png)
...
![image](/面试题/Java基础/0163-hashmap-underlying-principles-interview/img-b634b6ca1d67.png)
...
![image](/面试题/Java基础/0163-hashmap-underlying-principles-interview/img-8354d6dff870.png)
...
![image](/面试题/Java基础/0163-hashmap-underlying-principles-interview/img-d3f4ff96db82.png)
...
![image](/面试题/Java基础/0163-hashmap-underlying-principles-interview/img-2bc1cd5fc987.png)

链表反转

最终 3 个线程都调整完毕，就会出现下图所示的死循环：这个时候 get (key1) 就会出现 Infinite Loop 异常。

![image](/面试题/Java基础/0163-hashmap-underlying-principles-interview/img-8e122ba6bdb2.png)
