---
title: "高并发场景下，如何安全修改同一行数据"
sidebarGroup: "Mysql"
shortTitle: "高并发场景下，如何安全修改同一行数据"
order: 409
date: 2026-05-06
category: "面试题"
tag:
  - "面试题"
description: "在高并发情况下，多事务安全修改同一行数据可以采用以下方法：乐观锁：在数据表中添加一个版本号（或者时间戳）字段，每次更新数据时都会检查该字段的值。当多个并发的请求同时修改同一行数据时，只有一个请求能够成功执行更新操作，其他请求需要重新检查数据"
article: false
---

> 来源：[高并发场景下，如何安全修改同一行数据](https://www.yuque.com/tulingzhouyu/db22bv/ftxtsp1a7z09q3tb)
