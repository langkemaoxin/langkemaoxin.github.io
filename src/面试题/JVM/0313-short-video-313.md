...
tag:
  - "面试题"
description: "最近有一位工作 3 年的粉丝，在后台留言   面试的时候被问到什么是三色标记法？当时一脸懵逼，天天 CRUD，三色标记是什么鬼啊。其实三色标记法是Java虚拟机中一种用于垃圾回收的算法，主要是用于标记内存中的对象，好确定哪些对象是存活的，哪"
article: false
---

> 来源：[短视频](https://www.yuque.com/tulingzhouyu/db22bv/xnnlrqaa80pnu0zn)
