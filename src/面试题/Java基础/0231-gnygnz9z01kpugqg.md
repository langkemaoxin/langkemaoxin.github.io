---
title: "日期格式化用yyyy还是YYYY"
sidebarGroup: "Java基础"
shortTitle: "日期格式化用yyyy还是YYYY"
order: 231
date: 2026-03-29
category: "面试题"
tag:
  - "面试题"
description: "一个工作6年的小伙伴日期时间格式化还在写大写YYYY，  你是真的没踩过雷啊！哈喽大家好我是徐庶！需要本视频文字版的小伙伴可以在评论区扣666，里面会有更详细的图和代码。如果你现在还在用大写YYYY格式化日期，那赶紧换成小写yyyy。有什么"
article: false
---

> 来源：[日期格式化用yyyy还是YYYY](https://www.yuque.com/tulingzhouyu/db22bv/gnygnz9z01kpugqg)
