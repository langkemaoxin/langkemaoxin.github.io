...
shortTitle: "10 KubeSphere中集成ApiSix"
order: 10
date: 2026-08-13
category: "云原生"
tag:
  ...
  - "云原生"
  - "课程笔记"
description: "KubeSphere集成APISIX 一、Apache APISIX 介绍 Apache APISIX 是一款开源的高性能、动态云原生网关，由深圳支流科技有限公司于 2019 年捐赠给 Apache ..."
---
...
Apache APISIX 是一款开源的高性能、动态云原生网关，由深圳支流科技有限公司于 2019 年捐赠给 Apache 基金会，当前已经成为 Apache 基金会的顶级开源项目，也是 GitHub 上最活跃的网关项目。Apache APISIX 当前已经覆盖了 API网关，LB，Kubernetes Ingress，Service Mesh 等多种场景。

![image-20221109110658198](/云原生/paas/paas-10-kubesphere中集成apisix/image-20221109110658198.png)

# 二、部署Apache APISIX Ingress Controller

## 2.1 进入企业空间添加应用仓库

> 使用admin用户登录kubesphere web控制台。
...
![image-20230301141321599](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301141321599.png)

![image-20230301141440654](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301141440654.png)

![image-20230301141545862](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301141545862.png)

![image-20230301141607751](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301141607751.png)
...
![image-20230301144802180](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301144802180.png)

![image-20230301144838089](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301144838089.png)

![image-20230301145015253](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301145015253.png)

![image-20230301145110572](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301145110572.png)

![image-20230301145131812](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301145131812.png)

![image-20230301145155185](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301145155185.png)

![image-20230301145219641](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301145219641.png)

![image-20230301145246807](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301145246807.png)

![image-20230301145341254](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301145341254.png)
...
gateway:
  ...
  type: LoadBalancer 由默认NodePort修改为LoadBalancer
...
admin:
  ...
  allow:
    ...
    ipList:
      - 0.0.0.0/0 由默认127.0.0.1/24修改为0.0.0.0/24
...
dashboard:
  enabled: true 由false修改为true，并添加下面二行内容
  service:
    type: LoadBalancer

# -- Ingress controller configuration
ingress-controller:
  enabled: true 由false修改为true
  config:
    apisix:
      adminAPIVersion: "v3"
      serviceNamespace: apisix-system 添加此行内容，否侧无法找到apisix-admin
...
![image-20230301132820032](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301132820032.png)

![image-20221109123103193](/云原生/paas/paas-10-kubesphere中集成apisix/image-20221109123103193.png)

>部署成功后，点击应用名称进入详情页面，可以在「资源状态」标签页下看到如下的服务部署和工作状态运行状态展示。

# 三、使用OpenELB结合Apache APISIX实现访问

![image-20230301133847741](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301133847741.png)

![image-20230301133909518](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301133909518.png)

![image-20230301133808864](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301133808864.png)

![image-20230301134020761](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301134020761.png)

![image-20230301134107784](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301134107784.png)

![image-20230301134204618](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301134204618.png)

![image-20230301134312586](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301134312586.png)

![image-20230301134350165](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301134350165.png)

![image-20230301134423036](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301134423036.png)

![image-20230301134443755](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301134443755.png)

# 四、使用 Apache APISIX Ingress Controller

## 4.1 创建应用及服务

> 使用project-regular用户登录后创建服务即可 。

![image-20230301135317539](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301135317539.png)

![image-20230301135349188](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301135349188.png)

![image-20230301135420265](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301135420265.png)

![image-20230301135455767](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301135455767.png)

![image-20230301135528524](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301135528524.png)

![image-20230301135553514](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301135553514.png)

![image-20230301135632234](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301135632234.png)

![image-20230301135703654](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301135703654.png)

![image-20230301135833841](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301135833841.png)

## 4.2 创建应用路由

![image-20230301135735748](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301135735748.png)

![image-20230301135923561](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301135923561.png)

![image-20230301135951493](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301135951493.png)

![image-20230301140040717](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301140040717.png)

![image-20230301140104003](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301140104003.png)

![image-20230301140123432](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301140123432.png)

> 在添加元数据中添加注解为kubernetes.io/ingress.class:apisix键值。

![image-20230301140239240](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301140239240.png)

![image-20230301140306758](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301140306758.png)

![image-20230301140342313](/云原生/paas/paas-10-kubesphere中集成apisix/image-20230301140342313.png)
...
~~~powershell
[root@k8s-master01 ~]# curl http://test1.mashibing.com
<!DOCTYPE html>
<html>
<head>
...
~~~powershell
[root@k8s-master01 ~]# kubectl get pods -n yanxuan-project
NAME                               READY   STATUS    RESTARTS   AGE
apisix-test-1-v1-d7c7f8d6f-b2xm2   1/1     Running   0          9m28s
[root@k8s-master01 ~]# kubectl exec -it apisix-test-1-v1-d7c7f8d6f-b2xm2 -n yanxuan-project -- /bin/bash
root@apisix-test-1-v1-d7c7f8d6f-b2xm2:/# echo "apisix-test-1" > /usr/share/nginx/html/index.html
root@apisix-test-1-v1-d7c7f8d6f-b2xm2:/# exit
exit
~~~
