---
title: "HashMap的扩容机制是怎样的"
sidebarGroup: "大厂真题"
shortTitle: "HashMap的扩容机制是怎样的"
order: 51
date: 2026-06-07
category: "面试题"
tag:
  - "面试题"
description: "HashMap的扩容机制是为了保持负载因子在一定范围内，以提高HashMap的性能和效率。负载因子是指HashMap中已存储的键值对数量与数组容量的比值。当HashMap中的键值对数量超过了负载因子与数组容量的乘积时，就会触发扩容操作。默认"
article: false
---

> 来源：[HashMap的扩容机制是怎样的](https://www.yuque.com/tulingzhouyu/db22bv/qdcazqpoazu0eaa7)
