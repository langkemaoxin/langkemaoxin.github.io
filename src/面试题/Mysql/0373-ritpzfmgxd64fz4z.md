---
title: "Innodb加索引的时候会锁表吗"
sidebarGroup: "Mysql"
shortTitle: "Innodb加索引的时候会锁表吗"
order: 373
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "在 InnoDB 中，操作索引时是否锁表取决于具体的操作类型。有些情况可能会导致表锁，而有些情况则不会。以下是一些需要考虑的方面：1. 添加索引时在线添加索引（Online DDL）：从 MySQL 5.6 开始，InnoDB 支持在线添加"
article: false
---

> 来源：[Innodb加索引的时候会锁表吗](https://www.yuque.com/tulingzhouyu/db22bv/ritpzfmgxd64fz4z)
