---
title: "👍Java虚拟机8-11双版本 -JVM高频面试题-徐庶👍"
sidebarGroup: "系列篇"
shortTitle: "👍Java虚拟机8-11双版本 -JVM高频面试题-徐庶👍"
order: 90
date: 2026-07-24
category: "面试题"
tag:
  - "面试题"
description: "类加载1、类的生命周期薪资范围：6-16K难度：一个类完整的生命周期，会经历五个阶段，分别为：加载、连接、初始化、使用、和卸载。其中的连接又分为验证、准备和解析三个步骤。如下图所示加载（Loading）简单一句话概括，类的加载阶段就是：找到"
article: false
---

> 来源：[👍Java虚拟机8-11双版本 -JVM高频面试题-徐庶👍](https://www.yuque.com/tulingzhouyu/db22bv/td5a84ty4vel22ge)
...
> 薪资范围：6-16K
> 难度：
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-23099f2fa260.png)

![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-23099f2fa260.png)

![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-b9d42edf6a56.png)

![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-b9d42edf6a56.png)

![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-b9d42edf6a56.png)

一个类完整的生命周期，会经历五个阶段，分别为：**加载、连接、初始化、使用**、和**卸载**。其中的连接又分为**验证、准备**和**解析**三个步骤。如下图所示

![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-dc71a0036907.png)
...
1. **解析**：这一阶段的任务就是把常量池中的符号引用转换为直接引用。
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-c7169504a455.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-bb9fb7c3df7e.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-cfee6e2ef12e.png)

Java虚拟机运行时数据区

JVM内存分为线程私有区和线程共享区，其中方法区和堆是线程共享区，虚拟机栈、本地方法栈和程序计数器是线程隔离的数据区。

![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-eb43af8543ab.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-ccb648dc6a4a.jpg)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-eb36e33944a1.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-c0d5996b23b7.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-a09c561f53d4.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-f3bcfeb63039.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-be7440e92c29.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-6471a6bc9503.png)

**对象头区域：**

![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-9c68b41c3bff.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-27a30db473c7.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-4d6e5a43155e.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-4c3f2bfe284e.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-aa1f8fb8f4ec.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-22d1ccb49f00.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-07bf632a7bd8.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-10e8ae5ad721.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-1e4e36ff8b15.gif)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-c195118e5060.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-9fa2ed37a622.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-626d7ebbe724.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-a8b1f3c9d1ae.png)

G1 Heap Regions

每个 Region 都是通过指针碰撞来分配空间

![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-255942e4f747.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-50050e0f3663.png)

G1收集器运行示意图

## 14.有了CMS，为什么还要引入G1？

![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-3f90cff66205.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-20e690ba6b46.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-588692068905.png)

逃逸

除此之外，如果对象还有可能被外部线程访问到，例如赋值给可以在其它线程中访问的实例变量，这种就被称为线程逃逸。

![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-3bbbce2ce570.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-d1a70cf585a1.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-5e8fe86aced9.png)

- VisualVM（jvisualvm）

VisualVM 是一款免费的，集成了多个 JDK 命令行工具的可视化工具，它能为您提供强大的分析能力，对 **Java 应用程序做性能分析和调优**。这些功能包括生成和**分析海量数据、跟踪内存泄漏、监控垃圾回收器、执行内存和 CPU 分析** .

![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-a5c333f87b53.png)
...
- -class (类加载器)
- 
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-21a7b4c1b6f0.png)
- -compiler (JIT)
- -gc (GC 堆状态)
- 
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-08c31db3ae17.png)
- -gccapacity (各区大小)
- 
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-cff1fea5353b.png)
- -gccause (最近一次 GC 统计和原因)
- 
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-c77615e4f5f9.png)
- -gcnew (新区统计)
- 
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-65e9a2f6c17e.png)
- -gcnewcapacity (新区大小)
- -gcold (老区统计)
- -gcoldcapacity (老区大小)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-71e4828f6eed.jpg)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-16445772d58c.jpg)
...
- **MAT**Java 堆内存分析工具。
- 
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-c341b390fd01.jpg)

- **GChisto**GC 日志分析工具。
- 
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-f0e0bfc3ea53.png)

- **GCViewer   **GC 日志分析工具。
- 
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-ebb9ab1c4bfe.jpg)

- **JProfiler**商用的性能分析利器。
- 
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-1981ae451cb6.png)

- **arthas**阿里开源诊断工具。
- 
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-3e86721c1bce.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-ec06ce353440.png)
...
![image](/面试题/系列篇/0090-java-virtual-machine-8-11-dual-version-jvm-faq-interview-xu/img-0a13f5dee252.png)
...
1. 使用jstat -gcutil [pid] 5000 10 每隔 5 秒输出 GC 信息，输出 10 次，查看 **YGC** 和 **Full GC** 次数。通常会出现 YGC 不增加或增加缓慢，而 Full GC 增加很快。或使用 jstat -gccause [pid] 5000 ，同样是输出 GC 摘要信息。或使用 jmap -heap [pid] 查看堆的摘要信息，关注老年代内存使用是否达到阀值，若达到阀值就会执行 Full GC。
