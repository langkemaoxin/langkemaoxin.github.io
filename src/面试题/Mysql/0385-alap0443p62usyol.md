...
title: "B 树和B+树的区别？"
sidebarGroup: "Mysql"
shortTitle: "B 树和B+树的区别？"
order: 385
date: 2026-05-21
category: "面试题"
tag:
  - "面试题"
description: "B树和B+树是常用的数据结构，用于在数据库中进行索引操作。它们之间的区别主要有以下几个方面：数据存储方式：在B树中，每个节点都包含键和对应的值，叶子节点存储了实际的数据记录；而B+树中，只有叶子节点存储了实际的数据记录，非叶子节点只包含键信"
article: false
---

> 来源：[B 树和B+树的区别？](https://www.yuque.com/tulingzhouyu/db22bv/alap0443p62usyol)
