---
title: "💎SpringBoot 面试题集合"
sidebarGroup: "SpringBoot"
shortTitle: "💎SpringBoot 面试题集合"
order: 460
date: 2026-07-27
category: "面试题"
tag:
  - "面试题"
description: "1. SpringBoot 使用 Validation 进行参数校验并统一返回校验异常在 SpringBoot项目开发中，有一个观点是不要相信前端传入的参数，因为你不知道用户是怎么操作我们接口的，所以在后端也需要对参数进行校验，这篇文章主要"
article: false
---

> 来源：[💎SpringBoot 面试题集合](https://www.yuque.com/tulingzhouyu/db22bv/hywzs139hpdk0k3v)
...
1. **主程序入口：** 在一个 Spring Boot 应用程序中，`@SpringBootApplication` 注解通常被标注在应用程序的主类上，即包含 `main` 方法的类。它是应用程序的入口点，通过执行 `main` 方法来启动 Spring Boot 应用。
2. **约定大于配置：** `@SpringBootApplication` 注解代表了 Spring Boot 的约定大于配置的思想。它默认会启用自动配置，扫描并注册需要的组件，从而使得应用程序的配置过程变得简单，并且能够快速搭建一个功能完备的 Spring Boot 应用。
3. **配置扩展：** 尽管 `@SpringBootApplication` 注解已经包含了许多默认的配置，你仍然可以在应用程序中添加自己的配置类、自定义 Bean 和其他相关组件，来进一步定制和扩展应用程序的行为。
...
![image](/面试题/SpringBoot/0460-springboot-interview-collection/img-a137003c25a3.png)
...
![image](/面试题/SpringBoot/0460-springboot-interview-collection/img-b63590feed8e.png)
...
![image](/面试题/SpringBoot/0460-springboot-interview-collection/img-414e51bf2593.png)
...
![image](/面试题/SpringBoot/0460-springboot-interview-collection/img-0d4c197ba983.png)
...
![image](/面试题/SpringBoot/0460-springboot-interview-collection/img-e1be7ab3b209.png)
...
![这么问谁不迷糊](/面试题/SpringBoot/0460-springboot-interview-collection/img-7b95fc1eee0d.jpg)
...
![image](/面试题/SpringBoot/0460-springboot-interview-collection/img-8d0b64fabef1.png)
...
![image](/面试题/SpringBoot/0460-springboot-interview-collection/img-1e505792fe00.png)
...
![image](/面试题/SpringBoot/0460-springboot-interview-collection/img-7ebb7d1c131e.png)
...
- 输出
![image](/面试题/SpringBoot/0460-springboot-interview-collection/img-c35977ab0742.png)

- 当com.tuling.bean.enbaled为false

- 输出
![image](/面试题/SpringBoot/0460-springboot-interview-collection/img-c0103f4a900d.png)
