...
shortTitle: "说说你对图 - 拓扑排序的理解"
order: 881
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "拓扑排序是一种对有向无环图进行排序的算法。在拓扑排序中，图中的节点表示任务或事件，有向边表示任务间的依赖关系。拓扑排序可以确定任务的执行顺序，使得所有依赖关系得到满足，并且没有循环依赖。拓扑排序的基本思想是，首先找到没有前驱节点的节点，将其"
article: false
---

> 来源：[说说你对图 - 拓扑排序的理解](https://www.yuque.com/tulingzhouyu/db22bv/olflgxpfigdgg67x)
