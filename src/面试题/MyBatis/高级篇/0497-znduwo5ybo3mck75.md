---
title: "如何编写一个MyBatis插件？"
sidebarGroup: "高级篇"
shortTitle: "如何编写一个MyBatis插件？"
order: 497
date: 2026-06-21
category: "面试题"
tag:
  - "面试题"
description: "编写一个MyBatis插件可以让你在执行SQL语句前后进行自定义的操作，比如日志记录（有自带STDOUT_LOGGING 不过功能较为简单）、性能监控等。下面我将演示一个简单的MyBatis插件，它会在执行查询SQL语句前打印一条日志。当然"
article: false
---

> 来源：[如何编写一个MyBatis插件？](https://www.yuque.com/tulingzhouyu/db22bv/znduwo5ybo3mck75)
