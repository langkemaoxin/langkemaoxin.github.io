...
title: "51.向量数据库选型对比"
sidebarGroup: "云计算"
shortTitle: "51.向量数据库选型对比"
order: 1414
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "一、答题思路向量数据库选型是构建高效检索增强生成（RAG）系统的核心环节。选型时需结合具体业务场景、数据规模、查询性能、算法兼容性等多维度综合评估。以下为选型对比的核心思路：业务场景需求数据类型：文本、图像、音频等多模态数据需选择支持多模态"
article: false
---

> 来源：[51.向量数据库选型对比](https://www.yuque.com/tulingzhouyu/db22bv/wzcu103wykyssxb0)
