---
title: "👍 一小时快速入门MySQL+傻瓜式安装教程"
sidebarGroup: "系列篇"
shortTitle: "👍 一小时快速入门MySQL+傻瓜式安装教程"
order: 109
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "1.课程介绍2024 年给大家带来一个快速入门 MySQL 的超详细教程，帮助还没有使用过 MySQL 的小伙伴快速掌握 MySQL 的安装与入门使用，接下来就开始 MySQL 的扫盲行动吧。2.MySQL简介MySQL是一个开源的关系型数"
article: false
---

> 来源：[👍 一小时快速入门MySQL+傻瓜式安装教程](https://www.yuque.com/tulingzhouyu/db22bv/bkgyx9eokguvv3tm)
...
![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-8e2cd77416ba.png)

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-0f37343d3d09.png)

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-3568fe04d342.png)

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-21d057c59554.png)

### 3.2 安装

Windows 的安装有图形化界面，非常的方便快捷，直接运行下载好的 msi 文件，大多数都是下一步，极少步骤需要处理，需要单独处理的步骤提到了前面，大家稍微记一下就行，其他无脑下一步。需要注意如下图示： **完整的过程图再文末。**

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-d9c63ca37bc7.png)

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-8d019a607ee4.png)
...
![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-2e0d310649c0.png)
...
![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-f73cb097b6da.png)

### 3.3.2 配置 MySQL 环境变量

#### 3.3.2.1 进入 MySQL 安装目录，打开 bin 目录，复制 bin 所在目录链接

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-0fc426571c4b.png)

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-4bc20c91ed2e.png)

#### 3.3.2.2 打开我的电脑属性 --> 高级系统设置 --> 环境变量 ······ 按图示操作

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-e22ba0cc0321.png)
...
![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-d24a52583d6f.png)

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-394e0def6e1a.png)
...
![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-cf3536beb3ef.png)

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-38fcf64729e1.png)

### 5.2 然后就正常下一步，安装完成后打开软件。连接数据库，如下是连接了本机、虚机 windows、虚机 Linux 三个机器的 MySQL 服务，确认好 ip 地址，填入账号密码即可。

### 5.3 连接 Linux 机器 MySQL

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-d64e26405d33.png)
...
![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-f6826adce736.png)
...
![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-6bc3fddcbce0.png)
...
![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-9f339d70b0d8.png)

### 6.2 使用 HeidiSQL 创建

**选中连接的数据库，然后右键-->创建新的-->数据库**

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-de4f90033c3f.png)

填入数据库名称，这样就创建完成了

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-c8e626f4a2c0.png)

**删除数据库，很简单，直接选中数据库右键删除即可**

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-8ac71916f80d.png)

**细心的小伙伴应该已经发现了，我们在图形化操作时，HeidiSQL 都生成了对应的命令，因此我们接下来都在 HeidiSQL 中完成处理。**

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-66f859cd4d56.png)
...
![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-631a3c701dc8.png)

**日期类型**

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-6de9790e6d5d.png)

**字符类型**

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-2dd321636540.png)
...
![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-8722485e167d.png)

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-85138c08ddbd.png)

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-f74e3a4b9214.png)
...
![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-967a11d35943.png)

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-b4aaf3696a67.png)

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-3a0ddfbb9d1d.png)

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-a3c964f64c68.png)

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-814ac568c7af.png)

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-8d019a607ee4.png)

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-7c72727036b8.png)

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-bb62e6726b63.png)

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-ad35ba4c4a68.png)

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-5f186c193e23.png)

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-26f4c8d02f0f.png)

![image](/面试题/系列篇/0109-one-hour-quick-start-mysql-humbug-installation-tutorial/img-d5c965551d4f.png)
