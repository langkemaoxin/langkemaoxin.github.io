...
tag:
  - "面试题"
description: "被问烂了的面试题， JVM内存模型，还不会的话一定要听我一分钟介绍一下，面试的时候被问到你会来感谢我。JVM内存模型说白了就是Java虚拟机在运行时使用的内存结构。它最主要的几部分有：堆、栈、方法区和程序计数器。那堆呢.   . 是JVM中"
article: false
---

> 来源：[短视频](https://www.yuque.com/tulingzhouyu/db22bv/voem3pgu98wh39q7)
