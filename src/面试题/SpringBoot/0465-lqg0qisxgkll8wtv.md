---
title: "SpringBoot如何自定义Starter"
sidebarGroup: "SpringBoot"
shortTitle: "SpringBoot如何自定义Starter"
order: 465
date: 2026-06-21
category: "面试题"
tag:
  - "面试题"
description: "在开发分布式Springboot项目时， 自定义Starter是一定会用到的。以下是创建自定义Spring Boot Starter的基本步骤：创建项目结构： 创建一个Maven或Gradle项目，确保项目结构符合标准的约定。通常，项目结构"
article: false
---

> 来源：[SpringBoot如何自定义Starter](https://www.yuque.com/tulingzhouyu/db22bv/lqg0qisxgkll8wtv)
