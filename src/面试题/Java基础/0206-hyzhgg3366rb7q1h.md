---
title: "反射中，Class.forName和ClassLoader的区别"
sidebarGroup: "Java基础"
shortTitle: "反射中，Class.forName和ClassLoader的区别"
order: 206
date: 2026-07-12
category: "面试题"
tag:
  - "面试题"
description: "Class.forName和ClassLoader是Java反射中用于加载类的两种不同方式。Class.forName是一个静态方法，通过提供类的完全限定名，在运行时加载类。此方法还会执行类的静态初始化块。如果类名不存在或无法访问，将抛出C"
article: false
---

> 来源：[反射中，Class.forName和ClassLoader的区别](https://www.yuque.com/tulingzhouyu/db22bv/hyzhgg3366rb7q1h)
