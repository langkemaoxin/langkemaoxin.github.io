---
title: "说下Hystrix与Sentinel的区别"
sidebarGroup: "SpringCloud"
shortTitle: "说下Hystrix与Sentinel的区别"
order: 562
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "Hystrix和Sentinel都是服务熔断器，用于提高分布式系统的弹性。它们的主要区别在于实现方式、适用场景和资源模型设计。Hystrix基于命令模式设计，将外部资源的调用封装在命令对象中，通过线程池或信号量来实现隔离。它提供了丰富的配置"
article: false
---

> 来源：[说下Hystrix与Sentinel的区别](https://www.yuque.com/tulingzhouyu/db22bv/elzhqhz3tpllp5kc)
