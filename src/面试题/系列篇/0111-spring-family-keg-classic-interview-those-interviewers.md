---
title: "🔥那些面试官最喜欢问的Spring全家桶经典面试题"
sidebarGroup: "系列篇"
shortTitle: "🔥那些面试官最喜欢问的Spring全家桶经典面试题"
order: 111
date: 2026-03-25
category: "面试题"
tag:
  - "面试题"
description: "单例Bean是单例模式吗？通常来说，单例模式是指在一个JVM中，一个类只能构造出来一个对象，有很多方法来实现单例模式，比如懒汉模式，但是我们通常讲的单例模式有一个前提条件就是规定在一个JVM中，那如果要在两个JVM中保证单例呢？那可能就要用"
article: false
---

> 来源：[🔥那些面试官最喜欢问的Spring全家桶经典面试题](https://www.yuque.com/tulingzhouyu/db22bv/as67zos69fxr6zc0)
...
![image](/面试题/系列篇/0111-spring-family-keg-classic-interview-those-interviewers/img-e7669a0a98ab.png)
...
![image](/面试题/系列篇/0111-spring-family-keg-classic-interview-those-interviewers/img-68e967d5c544.png)
...
![image](/面试题/系列篇/0111-spring-family-keg-classic-interview-those-interviewers/img-636f9ef6ee37.png)
...
![image](/面试题/系列篇/0111-spring-family-keg-classic-interview-those-interviewers/img-e6ab9372584f.png)
...
5.然后读取所有的**/META-INF/org.springframework.boot.autoconfigure.AutoConfiguration.imports**文件（SPI)

6.过滤出所有**AutoConfigurtionClass**类型的类

7.最后通过**@ConditioOnXXX**排除无效的自动配置类

![image](/面试题/系列篇/0111-spring-family-keg-classic-interview-those-interviewers/img-240645636829.png)
