...
tag:
  - "面试题"
description: "在Kubernetes中，滚动升级和回滚可以通过以下步骤实现：滚动升级：创建一个新的Replica Set（RS），它包含新的Pod模板，该模板定义了新的Pod配置。通过增加Replica Set的副本数量，逐渐将流量从旧的Pod转移到新的"
article: false
---

> 来源：[在Kubernetes中，如何实现滚动升级和回滚](https://www.yuque.com/tulingzhouyu/db22bv/cgcwk65bnovnkxfy)
