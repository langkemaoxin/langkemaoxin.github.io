...
![image](/面试题/分布式/0716-paxos-algorithm-guide/img-57152962244e.png)
...
![image](/面试题/分布式/0716-paxos-algorithm-guide/img-180eb6e15029.jpg)
...
![image](/面试题/分布式/0716-paxos-algorithm-guide/img-e92e88782900.png)

接下来，节点 A，B 接收到客户端 1 的准备请求（提案编号为 1），节点 C 接收到客户端 2 的准备请求（提案编号为 5）。

![image](/面试题/分布式/0716-paxos-algorithm-guide/img-5943fd5c9013.png)
...
![image](/面试题/分布式/0716-paxos-algorithm-guide/img-659b0420e301.png)
...
![image](/面试题/分布式/0716-paxos-algorithm-guide/img-30e0f326de42.png)
...
![image](/面试题/分布式/0716-paxos-algorithm-guide/img-4fe0648887d5.png)
...
![image](/面试题/分布式/0716-paxos-algorithm-guide/img-81b65c4cce9b.png)

 节点 A, B 接收到客户端 3 的准备请求，由于节点 A, B 已通过提案 [5, "百里"]，故在准备响应中，包含此提案信息。

节点 C 接收到客户端 3 的准备请求，由于节点 C 未通过任何提案，故节点 C 将返回“尚无提案”的准备响应。

![image](/面试题/分布式/0716-paxos-algorithm-guide/img-f266e0997101.png)
...
![image](/面试题/分布式/0716-paxos-algorithm-guide/img-908f7cdaa1f9.png)

节点 A, B, C 接收到客户端 3 的接受请求，由于提案编号 8 不小于三个节点承诺可以通过的最小提案编号，故均通过提案 [8, 百里]。

![image](/面试题/分布式/0716-paxos-algorithm-guide/img-9358f1b022fa.png)
...
![image](/面试题/分布式/0716-paxos-algorithm-guide/img-80acb9bb4daa.jpg)
...
![image](/面试题/分布式/0716-paxos-algorithm-guide/img-690f0bdd4c82.jpg)

1. Chubby 所有的读请求由主节点来处理

当主节点接收到读请求，主节点只需要查询本地数据，然后返回给客户端。

![image](/面试题/分布式/0716-paxos-algorithm-guide/img-917ca0815b06.jpg)
