---
title: "SpringBoot为什么默认使用CGLIB"
sidebarGroup: "SpringBoot"
shortTitle: "SpringBoot为什么默认使用CGLIB"
order: 471
date: 2026-08-06
category: "面试题"
tag:
  - "面试题"
description: "SpringBoot默认使用CGLIB 原因如下：无需接口： CGLIB能够代理那些没有实现接口的类，而JDK动态代理只能代理实现了接口的类。这使得Spring Boot可以更灵活地使用代理，而无需依赖于接口。AOP支持： Spring B"
article: false
---

> 来源：[SpringBoot为什么默认使用CGLIB](https://www.yuque.com/tulingzhouyu/db22bv/big13fgmk149wb5l)
