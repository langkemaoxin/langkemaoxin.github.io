---
title: "当一个Docker容器运行异常时，如何通过Docker命令查看日志信息"
sidebarGroup: "Docker与K8S"
shortTitle: "当一个Docker容器运行异常时，如何通过Docker命令查看日志信息"
order: 1376
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "当一个Docker容器运行异常时，你可以使用Docker命令查看容器的日志信息。有三种方法可以实现：使用docker logs命令。该命令可以查看容器的日志输出。例如，要查看名为\"my-container\"的容器的日志，可以运行以下命令：d"
article: false
---

> 来源：[当一个Docker容器运行异常时，如何通过Docker命令查看日志信息](https://www.yuque.com/tulingzhouyu/db22bv/lg3thlrkpf2zi6kx)
