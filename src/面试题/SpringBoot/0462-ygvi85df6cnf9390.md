...
shortTitle: "SpringBoot可以同时处理多少请求"
order: 462
date: 2026-06-06
category: "面试题"
tag:
  - "面试题"
description: "SpringBoot默认的内嵌容器是Tomcat，也就是我们的程序实际上是运行在Tomcat里的。所以与其说SpringBoot可以处理多少请求，到不如说Tomcat可以处理多少请求。 在SpringBoot中处理请求数量相关的参数有四个："
article: false
---

> 来源：[SpringBoot可以同时处理多少请求](https://www.yuque.com/tulingzhouyu/db22bv/ygvi85df6cnf9390)
