---
title: "ShardingSpehre 的分库分表功能是如何工作的？"
sidebarGroup: "分库分表"
shortTitle: "ShardingSpehre 的分库分表功能是如何工作的？"
order: 736
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "ShardingSphere 的分库分表功能主要通过如下几个步骤完成：配置管控：ShardingSphere 需要解析复杂的配置信息，并且支持将配置信息上传到第三方注册中心。SQL 解析：将要执行的 SQL 语句解析成抽象语法树。SQL 路"
article: false
---

> 来源：[ShardingSpehre 的分库分表功能是如何工作的？](https://www.yuque.com/tulingzhouyu/db22bv/llezowetw2ia6qkc)
