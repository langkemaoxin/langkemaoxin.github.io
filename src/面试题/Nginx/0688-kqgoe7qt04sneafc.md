---
title: "什么是缓冲区溢出？NGINX是如何防止缓冲区溢出攻击的？"
sidebarGroup: "Nginx"
shortTitle: "什么是缓冲区溢出？NGINX是如何防止缓冲区溢出攻击的？"
order: 688
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "缓冲区溢出（Buffer Overflow）是一种常见的安全漏洞，它发生在程序试图向一个缓冲区写入超出其预分配大小的数据时。这可能导致数据覆盖了相邻的内存区域，可能破坏程序的执行流程，甚至可以被恶意攻击者利用来执行恶意代码。NGINX作为一"
article: false
---

> 来源：[什么是缓冲区溢出？NGINX是如何防止缓冲区溢出攻击的？](https://www.yuque.com/tulingzhouyu/db22bv/kqgoe7qt04sneafc)
