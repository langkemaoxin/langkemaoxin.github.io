...
shortTitle: "百亿级超大流量红包架构方案"
order: 812
date: 2026-02-09
category: "面试题"
tag:
  - "面试题"
description: "话说每逢双十一节或春节等节假日，对大家来讲是最欢乐的日子，可以在微信群中收发红包，此外今年微信还推出了面对面红包，让大家拜年时可直接收发，对于用户来讲很爽也很方便。但对于技术架构侧的考量，这使得微信红包的收发数据成几何倍数上升，处理的复杂度"
article: false
---

> 来源：[百亿级超大流量红包架构方案](https://www.yuque.com/tulingzhouyu/db22bv/cy32uw7gte1y304l)
...
![image](/面试题/项目设计场景题/0812-billion-scale-red-packet-architecture/img-010b1b641b96.png)
...
![image](/面试题/项目设计场景题/0812-billion-scale-red-packet-architecture/img-b3f1c04ef5d5.png)
...
![image](/面试题/项目设计场景题/0812-billion-scale-red-packet-architecture/img-9f23fd825682.png)
...
![image](/面试题/项目设计场景题/0812-billion-scale-red-packet-architecture/img-af9450134bbe.png)
...
![image](/面试题/项目设计场景题/0812-billion-scale-red-packet-architecture/img-27ea5c88cac7.png)
...
![image](/面试题/项目设计场景题/0812-billion-scale-red-packet-architecture/img-6bb71d4343e9.png)
...
![image](/面试题/项目设计场景题/0812-billion-scale-red-packet-architecture/img-14bc2a687d21.png)
...
![image](/面试题/项目设计场景题/0812-billion-scale-red-packet-architecture/img-55268d3b3dbd.png)
...
![image](/面试题/项目设计场景题/0812-billion-scale-red-packet-architecture/img-affa386e680c.png)
...
![image](/面试题/项目设计场景题/0812-billion-scale-red-packet-architecture/img-80787e352104.png)
...
![image](/面试题/项目设计场景题/0812-billion-scale-red-packet-architecture/img-72b8ca9428cd.png)
...
![image](/面试题/项目设计场景题/0812-billion-scale-red-packet-architecture/img-217ea3288a0d.png)
...
![image](/面试题/项目设计场景题/0812-billion-scale-red-packet-architecture/img-568ab2fc35e5.png)
...
![image](/面试题/项目设计场景题/0812-billion-scale-red-packet-architecture/img-9148bfc3e021.png)
...
1. 对外暴露的 sdk 直接返回本地缓存的值即可。
2. 有个问题需要注意下，每次实例启动第一秒内是没有数据的，所以会阻塞读，等有数据再返回。
...
1. 容灾方案是使用备份 Redis 集群，写入时进行双写，

一旦主机群挂掉，设计了一个配置开关支持读取备份 Redis。两个 Redis 集群的数据一致性，通过定时任务兜底实现。

具体写入流程图如下：

![image](/面试题/项目设计场景题/0812-billion-scale-red-packet-architecture/img-9c5d2f8fea3f.png)
...
方案一
1. 实现成本简单
1. 浪费存储资源； 2. 难以做容灾； 3. 不能做到一直累加；

方案二
1. 节约资源； 2. 容灾方案比较简单，同时也节约资源成本；
...
![image](/面试题/项目设计场景题/0812-billion-scale-red-packet-architecture/img-65dab14edaac.png)

准实时对账流程图：

![image](/面试题/项目设计场景题/0812-billion-scale-red-packet-architecture/img-7f33652baff3.png)
