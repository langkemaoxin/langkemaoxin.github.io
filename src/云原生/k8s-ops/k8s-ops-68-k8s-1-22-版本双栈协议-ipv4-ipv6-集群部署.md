...
shortTitle: 68 K8S 1.22 版本双栈协议（IPv4&IPv
order: 68
...
![image-20230324174008962](/云原生/k8s-ops/k8s-ops-68-k8s-1-22-版本双栈协议-ipv4-ipv6-集群部署/image-20230324174008962.png)

Open vSwitch 是一种广泛采用的高性能可编程虚拟交换机；Antrea 利用它来实现 Pod 网络和安全功能。例如，Open vSwitch 使 Antrea 能够以非常有效的方式实施 Kubernetes 网络策略。

## 5.1 获取antrea部署文件

![image-20230324173843525](/云原生/k8s-ops/k8s-ops-68-k8s-1-22-版本双栈协议-ipv4-ipv6-集群部署/image-20230324173843525.png)

![image-20230324173901871](/云原生/k8s-ops/k8s-ops-68-k8s-1-22-版本双栈协议-ipv4-ipv6-集群部署/image-20230324173901871.png)

![image-20230324174249721](/云原生/k8s-ops/k8s-ops-68-k8s-1-22-版本双栈协议-ipv4-ipv6-集群部署/image-20230324174249721.png)

![image-20230324174316268](/云原生/k8s-ops/k8s-ops-68-k8s-1-22-版本双栈协议-ipv4-ipv6-集群部署/image-20230324174316268.png)
...
![image-20230324202324615](/云原生/k8s-ops/k8s-ops-68-k8s-1-22-版本双栈协议-ipv4-ipv6-集群部署/image-20230324202324615.png)

![image-20230324202133124](/云原生/k8s-ops/k8s-ops-68-k8s-1-22-版本双栈协议-ipv4-ipv6-集群部署/image-20230324202133124.png)
