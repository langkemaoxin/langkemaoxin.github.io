---
title: "Class常量池和运行时常量池的区别"
sidebarGroup: "JVM"
shortTitle: "Class常量池和运行时常量池的区别"
order: 306
date: 2026-03-08
category: "面试题"
tag:
  - "面试题"
description: "Class 常量池（Class Constant Pool）定义：Class 常量池是Java类文件的一部分，它由编译器在编译Java源文件时生成，存储在.class文件中。它包含了类或接口的字面量（如字符串、整数常量等）以及符号引用（如类"
article: false
---

> 来源：[Class常量池和运行时常量池的区别](https://www.yuque.com/tulingzhouyu/db22bv/eipi6t9x8bueoqgl)
