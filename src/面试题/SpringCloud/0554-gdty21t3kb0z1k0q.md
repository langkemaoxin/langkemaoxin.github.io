...
shortTitle: "说说Seata的执行流程"
order: 554
date: 2026-02-05
category: "面试题"
tag:
  - "面试题"
description: "Seata的整体执行流程设计为两阶段提交，其执行流程如下：第一阶段：所有RM（Resource Manager，资源管理者，业务代码中被远程调用的部分）执行自己的本地事务。在执行本地事务时，seata使用数据源代理，在执行SQL前，对SQL"
article: false
---

> 来源：[说说Seata的执行流程](https://www.yuque.com/tulingzhouyu/db22bv/gdty21t3kb0z1k0q)
