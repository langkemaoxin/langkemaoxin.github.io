---
title: "说说你对算法思想 - 贪心算法的理解"
sidebarGroup: "数据结构与算法"
shortTitle: "说说你对算法思想 - 贪心算法的理解"
order: 887
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "贪心算法是一种常用的求解最优化问题的算法思想。它通过每一步的局部最优选择，希望最终达到全局最优解。贪心算法的核心思想是在求解过程中做出当前情况下的最优选择，并相信这个选择对全局来说也是最优的。它不考虑子问题的解决过程，只关注当前状态下的最优"
article: false
---

> 来源：[说说你对算法思想 - 贪心算法的理解](https://www.yuque.com/tulingzhouyu/db22bv/kyqftlcr0z644609)
