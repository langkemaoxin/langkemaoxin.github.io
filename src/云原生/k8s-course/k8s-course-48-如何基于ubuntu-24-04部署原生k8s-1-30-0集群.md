---
title: 如何基于Ubuntu 24.04部署原生K8S 1.30.0集群
sidebarGroup: K8s 课程笔记
shortTitle: 48 如何基于Ubuntu 24.04部署原生K8...
order: 48
...
tag:
  ...
  - 云原生
  - 课程笔记
description: '如何使用kube-vip基于Ubuntu 24.04部署原生K8S 1.30.0高可用集群？ 一、K8S集群主机准备 1.1 主机操作系统说明 | 序号 | 操作系统及版本 | 备注 | | :--:...'
---
...
# 如何使用kube-vip基于Ubuntu 24.04部署原生K8S 1.30.0高可用集群？
...
| 值   | 8C   | 8G   | 1024GB | master       | k8s-master02 |
| 值   | 8C   | 8G   | 1024GB | master       | k8s-master03 |
...
![image-20230404104037517](/云原生/k8s-course/k8s-course-48-如何基于ubuntu-24-04部署原生k8s-1-30-0集群/image-20230404104037517.png)

![image-20230404104105753](/云原生/k8s-course/k8s-course-48-如何基于ubuntu-24-04部署原生k8s-1-30-0集群/image-20230404104105753.png)

![image-20230816134446235](/云原生/k8s-course/k8s-course-48-如何基于ubuntu-24-04部署原生k8s-1-30-0集群/image-20230816134446235.png)

![image-20230816134545079](/云原生/k8s-course/k8s-course-48-如何基于ubuntu-24-04部署原生k8s-1-30-0集群/image-20230816134545079.png)
...
![image-20240428192520980](/云原生/k8s-course/k8s-course-48-如何基于ubuntu-24-04部署原生k8s-1-30-0集群/image-20240428192520980.png)

![image-20240428192603749](/云原生/k8s-course/k8s-course-48-如何基于ubuntu-24-04部署原生k8s-1-30-0集群/image-20240428192603749.png)
...
![image-20231207141350306](/云原生/k8s-course/k8s-course-48-如何基于ubuntu-24-04部署原生k8s-1-30-0集群/image-20231207141350306.png)
...
~~~powershell
root@k8s-master01:~# scp /etc/kubernetes/manifests/kube-vip.yaml tom@k8s-master02:/home/tom
~~~

~~~powershell
root@k8s-master02:~# mv /home/tom/kube-vip.yaml /etc/kubernetes/manifests/
~~~

~~~powershell
root@k8s-master01:~# scp /etc/kubernetes/manifests/kube-vip.yaml tom@k8s-master03:/home/tom
~~~

~~~powershell
root@k8s-master03:~# mv /home/tom/kube-vip.yaml /etc/kubernetes/manifests/
~~~
...
~~~powershell
root@k8s-master02:~# kubeadm join lb.kubex.com:6443 --token abcdef.0123456789abcdef \
        --discovery-token-ca-cert-hash sha256:935add45f6bb060ff98a1ffc07e5b485cc874a3899dc16b1aa6dde511bdad103 \
        --control-plane --certificate-key a4c5c97121cadd6de37cf48a0812c60827180bef8a2d818828804380cccfb9a1
~~~
...
~~~powershell
root@k8s-worker01:~# kubeadm join lb.kubex.com:6443 --token abcdef.0123456789abcdef \
        --discovery-token-ca-cert-hash sha256:935add45f6bb060ff98a1ffc07e5b485cc874a3899dc16b1aa6dde511bdad103
~~~

~~~powershell
root@k8s-worker02:~# kubeadm join lb.kubex.com:6443 --token abcdef.0123456789abcdef \
        --discovery-token-ca-cert-hash sha256:935add45f6bb060ff98a1ffc07e5b485cc874a3899dc16b1aa6dde511bdad103
~~~
...
![image-20230404115348450](/云原生/k8s-course/k8s-course-48-如何基于ubuntu-24-04部署原生k8s-1-30-0集群/image-20230404115348450.png)

![image-20230907161355282](/云原生/k8s-course/k8s-course-48-如何基于ubuntu-24-04部署原生k8s-1-30-0集群/image-20230907161355282.png)
...
![image-20230907172509898](/云原生/k8s-course/k8s-course-48-如何基于ubuntu-24-04部署原生k8s-1-30-0集群/image-20230907172509898.png)
