---
title: "Redis的内存淘汰策略详解"
sidebarGroup: "Redis"
shortTitle: "Redis的内存淘汰策略详解"
order: 503
date: 2026-06-05
category: "面试题"
tag:
  - "面试题"
description: "Redis中的内存淘汰策略用于在内存不足时选择要淘汰的键，以释放内存空间。以下是几种常见的内存淘汰策略：1. noeviction（不淘汰策略）这种方式呢，当写入缓存时，发现现当内存无法容纳新数据时，Redis会  直接返回错误。这是Red"
article: false
---

> 来源：[Redis的内存淘汰策略详解](https://www.yuque.com/tulingzhouyu/db22bv/fn1agyxs0t15wlvu)
...
![image](/面试题/Redis/0503-redis-memory-retirement-strategy-explained-in-detail/img-e375891f58a0.png)

![image](/面试题/Redis/0503-redis-memory-retirement-strategy-explained-in-detail/img-60035f726baf.png)

再过一下源码流程图

![image](/面试题/Redis/0503-redis-memory-retirement-strategy-explained-in-detail/img-d7f2e7d58377.png)

![image](/面试题/Redis/0503-redis-memory-retirement-strategy-explained-in-detail/img-6dd2892c2413.png)
