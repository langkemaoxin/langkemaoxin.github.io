...
tag:
  - "面试题"
description: "在MyBatis中，#{}和${}都是用于参数替换的标记，用于将参数值插入到SQL语句中。然而，它们在处理参数值的方式上有一些重要的区别。 #{}（预编译）: #{}是用于预编译的参数标记。当使用#{}时，MyBatis会将参数值放入一个预"
article: false
---

> 来源：[#{}和${}的区别是什么？](https://www.yuque.com/tulingzhouyu/db22bv/tknazmlfcguqf4l3)
