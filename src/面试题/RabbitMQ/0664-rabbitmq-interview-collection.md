...
shortTitle: "💎RabbitMQ面试题合集"
order: 664
date: 2026-01-22
category: "面试题"
tag:
  - "面试题"
description: "1. RabbitMQ交换机类型1.1. direct(直连交换机)作为默认交换机。路由键与队列名完全匹配交换机，此种类型交换机，通过RoutingKey路由键将交换机和队列进行绑定， 消息被发送到exchange时，需要根据消息的Rout"
article: false
---

> 来源：[💎RabbitMQ面试题合集](https://www.yuque.com/tulingzhouyu/db22bv/gmmoedg89h3z6576)
...
> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2023/jpeg/35335154/1679310864234-c192ec99-527b-4817-ae45-1a7c6b4f03c9.jpeg)
...
> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2023/jpeg/35335154/1679299526347-dc96e5ca-a196-4ebe-8f24-63c276f8cab8.jpeg)
...
> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2024/jpeg/35268836/1704200146344-220bdcb8-9ba6-45a0-81ce-2f2e70431fd8.jpeg)
...
> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2024/jpeg/35268836/1704200149544-03424a81-6f57-4765-b34d-ae3f276a48d0.jpeg)
...
![image](/面试题/RabbitMQ/0664-rabbitmq-interview-collection/img-bcdd4e814399.png)
...
1. **队列（Queue）：** 队列是消息的存储区，用于存储生产者发送的消息。消息最终会被消费者从队列中取出并处理。每个队列都有一个名称，并且可以绑定到一个或多个交换机。
2. **消费者（Consumer）：** 消费者是消息的接收方，负责从队列中获取消息并进行处理。消费者通过订阅队列来接收消息。
3. **绑定（Binding）：** 绑定是交换机和队列之间的关联关系。生产者将消息发送到交换机，而队列通过绑定与交换机关联，从而接收到消息。
4. **虚拟主机（Virtual Host）：** 虚拟主机是 RabbitMQ 的基本工作单元，每个虚拟主机拥有自己独立的用户、权限、交换机、队列等资源，完全隔离于其他虚拟主机。
5. **连接（Connection）：** 连接是指生产者、消费者与 RabbitMQ 之间的网络连接。每个连接可以包含多个信道（Channel），每个信道是一个独立的会话通道，可以进行独立的消息传递。
6. **消息：** 消息是生产者和消费者之间传递的数据单元。消息通常包含消息体和可选的属性，如路由键等。
...
![image](/面试题/RabbitMQ/0664-rabbitmq-interview-collection/img-8dbaf4a3354e.png)
...
![image](/面试题/RabbitMQ/0664-rabbitmq-interview-collection/img-a711939ac47a.png)

## 消息堆积原因

> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2024/jpeg/35268836/1704289639905-c57088e7-c9d1-4cf0-bcc6-0538ca0d69a6.jpeg)
...
> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2025/jpeg/43518495/1744190246157-4823a12f-cb71-4c37-a58a-c06e5922e714.jpeg)
...
> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2025/jpeg/43518495/1744190298564-df185c31-7260-4b85-8fd3-13462c8f7b18.jpeg)
...
> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2023/jpeg/35335154/1680264333510-7b9563f6-dc90-4975-9892-611114e3d25b.jpeg)
...
> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2023/jpeg/35335154/1680264352458-cc74e8ee-5b40-432d-94c4-ba354abcf771.jpeg)
