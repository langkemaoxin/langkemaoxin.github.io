...
tag:
  - "面试题"
description: "在Java中，对象分配规则是关于如何为新对象分配内存的一套规则，以确保内存的有效使用和对象的正确初始化。以下是关于对象分配的主要规则：内存分配：新对象通常在堆内存中分配内存空间。对象头：在为对象分配内存空间后，Java虚拟机会为对象分配一个"
article: false
---

> 来源：[说说对象分配规则](https://www.yuque.com/tulingzhouyu/db22bv/ri355483wrs69dyk)
