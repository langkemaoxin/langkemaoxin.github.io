---
title: "💎 备战金三银四-Java面试题"
sidebarGroup: "系列篇"
shortTitle: "💎 备战金三银四-Java面试题"
order: 97
date: 2026-04-05
category: "面试题"
tag:
  - "面试题"
description: "前言技术为王的时代已经过去了，希望看到本篇笔记的小伙伴能够有些自己的收获，有些自己的理解，现在大行情不太好，很多时候面试不止是面技术，还面人情世故，还面思想境界，因为技术好并不一定工作好。因此我们在准备面试的时候，不单单要背八股，要熟悉项目"
article: false
---

> 来源：[💎 备战金三银四-Java面试题](https://www.yuque.com/tulingzhouyu/db22bv/gdggs5asoyhqku5n)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-815395e0ec3c.png)

在这个场景中，A 系统跟其它各种乱七八糟的系统严重耦合，A 系统产生一条比较关键的数据，很多系统都需要 A 系统将这个数据发送过来。A 系统要时时刻刻考虑 BCDE 四个系统如果挂了该咋办？要不要重发，要不要把消息存起来？头发都白了啊！

如果使用 MQ，A 系统产生一条数据，发送到 MQ 里面去，哪个系统需要数据自己去 MQ 里面消费。如果新系统需要数据，直接从 MQ 里消费即可；如果某个系统不需要这条数据了，就取消对 MQ 消息的消费即可。这样下来，A 系统压根儿不需要去考虑要给谁发送数据，不需要维护这个代码，也不需要考虑人家是否调用成功、失败超时等情况。

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-2e449ee1878d.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-53f85eee0fd0.png)

一般互联网类的企业，对于用户直接的操作，一般要求是每个请求都必须在 200 ms 以内完成，对用户几乎是无感知的。

如果**使用 MQ**，那么 A 系统连续发送 3 条消息到 MQ 队列中，假如耗时 5ms，A 系统从接受一个请求到返回响应给用户，总时长是 3 + 5 = 8ms，对于用户而言，其实感觉上就是点个按钮，8ms 以后就直接返回了。

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-5d5d63dfe8d9.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-19d5ea91368a.png)

如果使用 MQ，每秒 5k 个请求写入 MQ，A 系统每秒钟最多处理 2k 个请求，因为 MySQL 每秒钟最多处理 2k 个。A 系统从 MQ 中慢慢拉取请求，每秒钟就拉取 2k 个请求，不要超过自己每秒能处理的最大请求数量就 ok，这样下来，哪怕是高峰期的时候，A 系统也绝对不会挂掉。而 MQ 每秒钟 5k 个请求进来，就 2k 个请求出去，结果就导致在中午高峰期（1 个小时），可能有几十万甚至几百万的请求积压在 MQ 中。

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-3d4f69b266e9.png)
...
- **系统可用性降低** 系统引入的外部依赖越多，越容易挂掉。本来你就是 A 系统调用 BCD 三个系统的接口就好了，人 ABCD 四个系统好好的，没啥问题，你偏加个 MQ 进来，万一 MQ 挂了咋整，MQ 一挂，整套系统崩溃的，你不就完了？如何保证消息队列的高可用，查看后续的高可用面试题
...
基于 MQ 功能较为完善，还是分布式的，良好的可伸缩性和高可用性
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-9735dab580e1.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-100f02ff36bb.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-45f8942793f1.png)

Kafka 0.8 以后，提供了 HA 机制，就是 replica（复制品） 副本机制。每个 partition 的数据都会同步到其它机器上，形成自己的多个 replica 副本。所有 replica 会选举一个 leader 出来，那么生产和消费都跟这个 leader 打交道，然后其他 replica 就是 follower。写的时候，leader 会负责把数据同步到所有 follower 上去，读的时候就直接读 leader 上的数据即可。只能读写 leader？很简单，**要是你可以随意读写每个 follower，那么就要 care 数据一致性的问题**，系统复杂度太高，很容易出问题。Kafka 会均匀地将一个 partition 的所有 replica 分布在不同的机器上，这样才可以提高容错性。

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-509d56992dc9.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-bc65310eaefb.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-d9e77a72e43e.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-ce4c22719e58.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-81dadc50d9d8.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-88301d92c6c7.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-3c4b629d231b.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-70b1c6f305a8.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-cff75581301f.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-6c5b38b4861d.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-0561959cf62b.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-e0a84691ccbd.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-fa441fc6db5f.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-5914a815cde8.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-e3a4cbb4fca1.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-8ad2354238c7.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-0109808f2f19.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-b3248e37ea7d.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-ae96d47c3f2a.png)
...
## [https://xiaolincoding.com/mysql/base/how_select.html#mysql-%E6%89%A7%E8%A1%8C%E6%B5%81%E7%A8%8B%E6%98%AF%E6%80%8E%E6%A0%B7%E7%9A%84](https://xiaolincoding.com/mysql/base/how_select.html#mysql-%E6%89%A7%E8%A1%8C%E6%B5%81%E7%A8%8B%E6%98%AF%E6%80%8E%E6%A0%B7%E7%9A%84)MySQL 执行流程是怎样的？

先来一个上帝视角图，下面就是 MySQL 执行一条 SQL 查询语句的流程，也从图中可以看到 MySQL 内部架构里的各个功能模块。

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-8bf5c2bdf273.png)
...
## [https://xiaolincoding.com/mysql/base/how_select.html#%E7%AC%AC%E4%B8%80%E6%AD%A5-%E8%BF%9E%E6%8E%A5%E5%99%A8](https://xiaolincoding.com/mysql/base/how_select.html#%E7%AC%AC%E4%B8%80%E6%AD%A5-%E8%BF%9E%E6%8E%A5%E5%99%A8)第一步：连接器
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-0735415f50ef.png)

如果 MySQL 服务正常运行，完成 TCP 连接的建立后，连接器就要开始验证你的用户名和密码，如果用户名或密码不对，就收到一个"Access denied for user"的错误，然后客户端程序结束执行。

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-75da9212cb50.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-587f8b368466.png)
...
## [https://xiaolincoding.com/mysql/base/how_select.html#%E7%AC%AC%E4%BA%8C%E6%AD%A5-%E6%9F%A5%E8%AF%A2%E7%BC%93%E5%AD%98](https://xiaolincoding.com/mysql/base/how_select.html#%E7%AC%AC%E4%BA%8C%E6%AD%A5-%E6%9F%A5%E8%AF%A2%E7%BC%93%E5%AD%98)第二步：查询缓存
...
## [https://xiaolincoding.com/mysql/base/how_select.html#%E7%AC%AC%E4%B8%89%E6%AD%A5-%E8%A7%A3%E6%9E%90-sql](https://xiaolincoding.com/mysql/base/how_select.html#%E7%AC%AC%E4%B8%89%E6%AD%A5-%E8%A7%A3%E6%9E%90-sql)第三步：解析 SQL

在正式执行 SQL 查询语句之前， MySQL 会先对 SQL 语句做解析，这个工作交由「解析器」来完成。

### [https://xiaolincoding.com/mysql/base/how_select.html#%E8%A7%A3%E6%9E%90%E5%99%A8](https://xiaolincoding.com/mysql/base/how_select.html#%E8%A7%A3%E6%9E%90%E5%99%A8)解析器
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-1b438d0abbed.png)

如果我们输入的 SQL 语句语法不对，就会在解析器这个阶段报错。比如，我下面这条查询语句，把 from 写成了 form，这时 MySQL 解析器就会给报错。

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-4715a71dbb2d.png)
...
## [https://xiaolincoding.com/mysql/base/how_select.html#%E7%AC%AC%E5%9B%9B%E6%AD%A5-%E6%89%A7%E8%A1%8C-sql](https://xiaolincoding.com/mysql/base/how_select.html#%E7%AC%AC%E5%9B%9B%E6%AD%A5-%E6%89%A7%E8%A1%8C-sql)第四步：执行 SQL
...
### [https://xiaolincoding.com/mysql/base/how_select.html#%E9%A2%84%E5%A4%84%E7%90%86%E5%99%A8](https://xiaolincoding.com/mysql/base/how_select.html#%E9%A2%84%E5%A4%84%E7%90%86%E5%99%A8)预处理器
...
### [https://xiaolincoding.com/mysql/base/how_select.html#%E4%BC%98%E5%8C%96%E5%99%A8](https://xiaolincoding.com/mysql/base/how_select.html#%E4%BC%98%E5%8C%96%E5%99%A8)优化器
...
### [https://xiaolincoding.com/mysql/base/how_select.html#%E6%89%A7%E8%A1%8C%E5%99%A8](https://xiaolincoding.com/mysql/base/how_select.html#%E6%89%A7%E8%A1%8C%E5%99%A8)执行器
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-e4d32eafc9e5.png)

然后，我们进入 /var/lib/mysql/my_test 目录，看看里面有什么文件？

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-d407c1880da7.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-13d3d3f36c43.png)

下面我们从下往上一个个看看。

#### [https://xiaolincoding.com/mysql/base/row_format.html#_1%E3%80%81%E8%A1%8C-row](https://xiaolincoding.com/mysql/base/row_format.html#_1%E3%80%81%E8%A1%8C-row)1、行（row）

数据库表中的记录都是按行（row）进行存放的，每行记录根据不同的行格式，有不同的存储结构。

后面我们详细介绍 InnoDB 存储引擎的行格式，也是本文重点介绍的内容。

#### [https://xiaolincoding.com/mysql/base/row_format.html#_2%E3%80%81%E9%A1%B5-page](https://xiaolincoding.com/mysql/base/row_format.html#_2%E3%80%81%E9%A1%B5-page)2、页（page）
...
#### [https://xiaolincoding.com/mysql/base/row_format.html#_3%E3%80%81%E5%8C%BA-extent](https://xiaolincoding.com/mysql/base/row_format.html#_3%E3%80%81%E5%8C%BA-extent)3、区（extent）
...
#### [https://xiaolincoding.com/mysql/base/row_format.html#_4%E3%80%81%E6%AE%B5-segment](https://xiaolincoding.com/mysql/base/row_format.html#_4%E3%80%81%E6%AE%B5-segment)4、段（segment）
...
## [https://xiaolincoding.com/mysql/base/row_format.html#compact-%E8%A1%8C%E6%A0%BC%E5%BC%8F%E9%95%BF%E4%BB%80%E4%B9%88%E6%A0%B7](https://xiaolincoding.com/mysql/base/row_format.html#compact-%E8%A1%8C%E6%A0%BC%E5%BC%8F%E9%95%BF%E4%BB%80%E4%B9%88%E6%A0%B7)COMPACT 行格式长什么样？

先跟 Compact 行格式混个脸熟，它长这样：

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-d912021e1e1d.png)

可以看到，一条完整的记录分为「记录的额外信息」和「记录的真实数据」两个部分。

接下里，分别详细说下。

### [https://xiaolincoding.com/mysql/base/row_format.html#%E8%AE%B0%E5%BD%95%E7%9A%84%E9%A2%9D%E5%A4%96%E4%BF%A1%E6%81%AF](https://xiaolincoding.com/mysql/base/row_format.html#%E8%AE%B0%E5%BD%95%E7%9A%84%E9%A2%9D%E5%A4%96%E4%BF%A1%E6%81%AF)记录的额外信息

记录的额外信息包含 3 个部分：变长字段长度列表、NULL 值列表、记录头信息。

#### [https://xiaolincoding.com/mysql/base/row_format.html#_1-%E5%8F%98%E9%95%BF%E5%AD%97%E6%AE%B5%E9%95%BF%E5%BA%A6%E5%88%97%E8%A1%A8](https://xiaolincoding.com/mysql/base/row_format.html#_1-%E5%8F%98%E9%95%BF%E5%AD%97%E6%AE%B5%E9%95%BF%E5%BA%A6%E5%88%97%E8%A1%A8)1. 变长字段长度列表
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-7d15c24ff443.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-7ab8670b9e2a.png)

同样的道理，我们也可以得出**第二条记录**的行格式中，「变长字段长度列表」里的内容是「 04 02」，如下图：

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-f402faff445b.png)

**第三条记录**中 phone 列的值是 NULL，**NULL 是不会存放在行格式中记录的真实数据部分里的**，所以「变长字段长度列表」里不需要保存值为 NULL 的变长字段的长度。

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-3a2f7b377859.png)
...
#### [https://xiaolincoding.com/mysql/base/row_format.html#_2-null-%E5%80%BC%E5%88%97%E8%A1%A8](https://xiaolincoding.com/mysql/base/row_format.html#_2-null-%E5%80%BC%E5%88%97%E8%A1%A8)2. NULL 值列表
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-e2afa2894db1.png)

接下来，我们看看看看这三条记录的行格式中的 NULL 值列表是怎样存储的。

先来看**第一条记录**，第一条记录所有列都有值，不存在 NULL 值，所以用二进制来表示是酱紫的：

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-674c3619f0b7.png)

但是 InnoDB 是用整数字节的二进制位来表示 NULL 值列表的，现在不足 8 位，所以要在高位补 0，最终用二进制来表示是酱紫的：

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-122f5e512337.png)

所以，对于第一条数据，NULL 值列表用十六进制表示是 0x00。

接下来看**第二条记录**，第二条记录 age 列是 NULL 值，所以，对于第二条数据，NULL值列表用十六进制表示是 0x04。

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-e60281fb0b14.png)

最后**第三条记录**，第三条记录 phone 列 和 age 列是 NULL 值，所以，对于第三条数据，NULL 值列表用十六进制表示是 0x06。

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-886038fce40b.png)

我们把三条记录的 NULL 值列表都填充完毕后，它们的行格式是这样的：

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-fd7ed0bbc0a3.png)
...
#### [https://xiaolincoding.com/mysql/base/row_format.html#_3-%E8%AE%B0%E5%BD%95%E5%A4%B4%E4%BF%A1%E6%81%AF](https://xiaolincoding.com/mysql/base/row_format.html#_3-%E8%AE%B0%E5%BD%95%E5%A4%B4%E4%BF%A1%E6%81%AF)3. 记录头信息
...
### [https://xiaolincoding.com/mysql/base/row_format.html#%E8%AE%B0%E5%BD%95%E7%9A%84%E7%9C%9F%E5%AE%9E%E6%95%B0%E6%8D%AE](https://xiaolincoding.com/mysql/base/row_format.html#%E8%AE%B0%E5%BD%95%E7%9A%84%E7%9C%9F%E5%AE%9E%E6%95%B0%E6%8D%AE)记录的真实数据

记录真实数据部分除了我们定义的字段，还有三个隐藏字段，分别为：row_id、trx_id、roll_pointer，我们来看下这三个字段是什么。

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-9a1db72a09e0.png)
...
## [https://xiaolincoding.com/mysql/base/row_format.html#varchar-n-%E4%B8%AD-n-%E6%9C%80%E5%A4%A7%E5%8F%96%E5%80%BC%E4%B8%BA%E5%A4%9A%E5%B0%91](https://xiaolincoding.com/mysql/base/row_format.html#varchar-n-%E4%B8%AD-n-%E6%9C%80%E5%A4%A7%E5%8F%96%E5%80%BC%E4%B8%BA%E5%A4%9A%E5%B0%91)varchar(n) 中 n 最大取值为多少？
...
### [https://xiaolincoding.com/mysql/base/row_format.html#%E5%8D%95%E5%AD%97%E6%AE%B5%E7%9A%84%E6%83%85%E5%86%B5](https://xiaolincoding.com/mysql/base/row_format.html#%E5%8D%95%E5%AD%97%E6%AE%B5%E7%9A%84%E6%83%85%E5%86%B5)单字段的情况
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-e25dca34b44f.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-5d2c3a9f0f98.png)

可以看到，还是不行，接下来看看 varchar(65532) 是否可行？

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-d64216a67502.png)
...
### [https://xiaolincoding.com/mysql/base/row_format.html#%E5%A4%9A%E5%AD%97%E6%AE%B5%E7%9A%84%E6%83%85%E5%86%B5](https://xiaolincoding.com/mysql/base/row_format.html#%E5%A4%9A%E5%AD%97%E6%AE%B5%E7%9A%84%E6%83%85%E5%86%B5)多字段的情况

**如果有多个字段的话，要保证所有字段的长度 + 变长字段字节数列表所占用的字节数 + NULL值列表所占用的字节数 。

## [https://xiaolincoding.com/mysql/base/row_format.html#%E8%A1%8C%E6%BA%A2%E5%87%BA%E5%90%8E-mysql-%E6%98%AF%E6%80%8E%E4%B9%88%E5%A4%84%E7%90%86%E7%9A%84](https://xiaolincoding.com/mysql/base/row_format.html#%E8%A1%8C%E6%BA%A2%E5%87%BA%E5%90%8E-mysql-%E6%98%AF%E6%80%8E%E4%B9%88%E5%A4%84%E7%90%86%E7%9A%84)行溢出后，MySQL 是怎么处理的？
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-e5584d6462dd.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-4897fb15f52d.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-87396b7e00b7.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-64d94dbc4788.png)
...
*为什么表加了非索引字段，执行同样的查询语句后，会变成全表扫描呢？*
...
> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2024/jpeg/35268836/1711872490760-cb5d50a0-1b6a-4745-b2f0-1ec23ee9404b.jpeg)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-95871fbbbef3.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-cce15cc92682.png)

### redo log记录形式

前面说过，redo log实际上记录数据页的变更，而这种变更记录是没必要全部保存，因此redo log实现上采用了大小固定，循环写入的方式，当写到结尾时，会回到开头循环写日志。如下图：

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-b5bed8378c69.png)
...
> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2024/jpeg/35268836/1711958574297-7f332076-4731-42d8-b8b9-4ac6cffc1e4c.jpeg)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-9413d040bd37.png)
...
![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-e4d120a4a524.png)
...
> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2024/jpeg/35268836/1712488289506-b995b049-5fa6-4981-9375-6b200326e8ba.jpeg)

# 防御性编程

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-661e050c6b37.png)

# 优雅的进行异常处理

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-68b1dd87e106.png)

# 在 mapper 中如何传递多个参数？

![image](/面试题/系列篇/0097-prepare-for-the-three-silver-four-java-interview/img-99791bbf38c8.png)
