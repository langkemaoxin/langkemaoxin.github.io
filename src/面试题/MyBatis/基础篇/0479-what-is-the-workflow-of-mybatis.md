---
title: "MyBatis的工作流程是怎样的？"
sidebarGroup: "基础篇"
shortTitle: "MyBatis的工作流程是怎样的？"
order: 479
date: 2026-07-12
category: "面试题"
tag:
  - "面试题"
description: "首先，你要配置 MyBatis，就是告诉它怎么干活。你得创建一个配置文件，里面得写上数据库怎么连接，还有映射文件在哪，还有其他的一些设置。然后，你得写映射文件，这个东西定义了咱们的 Java 对象和数据库表是怎么对应的。就是告诉 MyBat"
article: false
---

> 来源：[MyBatis的工作流程是怎样的？](https://www.yuque.com/tulingzhouyu/db22bv/nzu2vt1n8rcew03m)
