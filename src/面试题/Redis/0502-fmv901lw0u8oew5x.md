...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-f4580d0a33f2.png)

从执行效果上看，ex参数和expire命令基本一样。还有一个需要特别注意的地方是如果一个字符串已经设置了过期时间，然后你调用了set 方法修改了它，它的过期时间会消失。

而nx和xx执行效果如下

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-9e414ce835d6.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-e0963390ac29.png)

setnx示例：

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-a6c5fde97cf4.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-af8951229e82.png)

##### mset 批量设置值

通过mset命令一次性设置4个键值对

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-ef0b189578ad.png)

##### mget 批量获取值

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-64e61dbef4b2.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-7c6e442422d2.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-848af37fa9a7.png)

##### strlen 字符串长度

返回字符串长度

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-28daa32af1d7.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-7a1ed44767f7.png)

##### setrange 设置指定位置的字符

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-a34d29cab7da.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-8cc6abc5574a.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-040b01a685c6.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-cc0ce3ee5bbb.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-95f9359128be.png)

##### hdel删除field

hdel会删除一个或多个field，返回结果为成功删除field的个数。

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-3d69d60f806d.png)

##### hlen计算field个数

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-c583acd5ce0e.png)

##### hmset批量设值

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-0c23ca4495c9.png)

##### hmget批量取值

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-fabcaabafad6.png)

##### hexists判断field是否存在

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-e2a1aa0a8b27.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-6a6feca9ce27.png)

##### hvals获取所有value

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-05e82f66e7d2.png)

##### hgetall获取所有field与value

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-19d88ca15573.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-4926fb8cd154.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-4268c4a0f0e7.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-786e97436481.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-807eaa9f62d7.png)

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-998b26f0fed2.png)

##### lpush 向左插入

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-9c77988c033d.png)

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-68363cc1bcde.png)

##### linsert 在某个元素前或后插入新元素

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-02da7054eeb9.png)

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-c59399acbd1e.png)

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-71d8e4db68b0.png)

这三个返回结果为命令完成后当前列表的长度，也就是列表中包含的元素个数，同时rpush和lpush都支持同时插入多个元素。

##### lpop 从列表左侧弹出（会删除元素）

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-03ebb7a879e7.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-734462dedcbd.png)

##### lrem 对指定元素进行删除

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-fae14446193e.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-9fe186083eb9.png)

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-b97ffe5dcb02.png)

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-869ab214041e.png)

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-aca6317f37c7.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-0675f9a1bad1.png)

ls

##### lset修改指定索引下标的元素

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-3c388ff5c9e4.png)

##### lindex 获取列表指定索引下标的元素

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-6523f1639c12.png)

l

##### llen 获取列表长度

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-ee123a9420d1.png)

##### blpop和brpop阻塞式弹出元素

blpop和brpop是lpop和rpop的阻塞版本，除此之外还支持多个列表类型，也支持设定阻塞时间，单位秒，如果阻塞时间为0，表示一直阻塞下去。我们以brpop为例说明。

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-2f39ef9f634e.png)

A客户端阻塞了（因为没有元素就会阻塞）

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-ef750e0a7b6a.png)

A客户端一直处于阻塞状态。此时我们从另一个客户端B执行

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-fd1a8237fe95.png)

A客户端则输出

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-c894fa26e15d.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-f6860980e474.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-a8868203dec3.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-34cd26805ee6.png)

##### srem 删除元素

允许删除多个，返回结果为成功删除元素个数

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-763b50d2ac39.png)

##### scard 计算元素个数

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-c043535bc93b.png)

##### sismember 判断元素是否在集合中

如果给定元素element在集合内返回1，反之返回0

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-e1fa68eeb63b.png)

##### srandmember 随机从集合返回指定个数元素

指定个数如果不写默认为1

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-f3e2f46e3d53.png)

##### spop 从集合随机弹出元素

同样可以指定个数，如果不写默认为1，注意，既然是弹出，spop命令执行后,元素会从集合中删除,而srandmember不会。

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-ff1075b4c900.png)

##### smembers 获取所有元素(不会弹出元素)

返回结果是无序的

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-3058007b54b7.png)

#### 集合间操作命令

现在有两个集合,它们分别是set1和set2

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-1eddfd7e6e72.png)

##### sinter 求多个集合的交集

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-91f49edb6dc5.png)

##### suinon 求多个集合的并集

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-3d34c3eb021d.png)

##### sdiff 求多个集合的差集

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-33fa5e169cc4.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-f33926b25ca7.png)

#### 存储结构

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-0cc08ec7ea8f.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-5e7039591cea.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-4291f99e07df.png)

返回结果代表成功添加成员的个数

要注意:

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-0ed7435d6599.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-0caf7978d2a0.png)

##### zscore 计算某个成员的分数

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-01bfbdaa63cd.png)

如果成员不存在则返回nil

##### zrank计算成员的排名

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-daff687b5da4.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-a64764d10760.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-d747ca1e47eb.png)

##### zrange和zrevrange返回指定排名范围的成员

有序集合是按照分值排名的，zrange是从低到高返回,zrevrange反之。如果加上withscores选项，同时会返回成员的分数

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-2c24e6b7c71b.png)

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-60b66b518133.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-4695aa1d7d32.png)

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-049b32da3769.png)

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-c4960c786873.png)

##### zcount 返回指定分数范围成员个数

zcount key min max

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-83b0f95adc46.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-ab130d7108fa.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-98f7f858b1f2.png)

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-60b33ceadec0.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-06944e088b34.png)

源码server.h

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-16ffeb3073a8.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-a3346c3d1af9.png)

redis根据数据类型组合使用不同编码方式，共计11种

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-844a172db7ac.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-63dab83673b7.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-ee53704d1f16.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-655a28b684c1.png)

##### bitop Bitmaps 间的运算

bitop op destkey key [key . ...]

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-f18526b62001.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-16d813dfd23e.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-7bd7936179e1.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-8470c439440a.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-0fef543108dd.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-c7e2174cd967.png)

##### 自行实现

就是利用Redis的bitmaps来实现。

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-18f211c484f7.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-3da0fe29b51d.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-62d49b87f044.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-ed6587f03324.png)

如果此时向插入一些用户，用户并且有重复

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-b81c3fe64ea1.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-0b9fef6020af.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-ecae28fe7753.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-86e53391b200.png)
...
![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-c5d4e26ac6b3.png)

然后把每个桶的值做调和平均数，就可以算出一个算法值。

同时，在具体的算法实现上，HLL还有一个分阶段偏差修正算法。我们就不做更深入的了解了。

![image](/面试题/Redis/0502-fmv901lw0u8oew5x/img-371118e031f9.png)
