---
title: "Kubernetes中的Service是什么？请简述其作用"
sidebarGroup: "Docker与K8S"
shortTitle: "Kubernetes中的Service是什么？请简述其作用"
order: 1369
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "在Kubernetes中，Service是一个抽象概念，用于将一组Pod定义为提供某种服务的能力。Service定义了一个服务的访问入口地址，前端的应用或者ingress通过这个地址访问其背后一组由Pod副本组成的集群实例。Service的"
article: false
---

> 来源：[Kubernetes中的Service是什么？请简述其作用](https://www.yuque.com/tulingzhouyu/db22bv/fezu43varlsz2d6r)
