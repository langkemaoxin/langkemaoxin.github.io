---
title: "电商系统开发中会都遇到了哪些问题？"
sidebarGroup: "项目设计场景题"
shortTitle: "电商系统开发中会都遇到了哪些问题？"
order: 843
date: 2026-07-24
category: "面试题"
tag:
  - "面试题"
description: "现在简历中你的项目不写个高并发项目你都不好意思说自己是java程序员！！但是现实是哪有这么多高并发项目。 那大部分同学会包装一个高并发项目，没错！这么干就对了，要不然你简历真的已读不回，环境所致嘛。 大家好，我是徐庶，那如果你简历写了高并发"
article: false
---

> 来源：[电商系统开发中会都遇到了哪些问题？](https://www.yuque.com/tulingzhouyu/db22bv/kuhe0bz9p8xovzt4)
...
1. **弱网支付问题**：  在网络信号较差的情况下进行支付操作时可能出现的一系列问题:比如   **订单状态和支付结果不一致**、**用户响应和实际支付结果不一致**， 最终导致**重复付款**或者**未付款却下单成功**等问题。

那可以通过：  依赖**支付平台提供回调方法来进行更新支付状态以保证一致性**

当然也**不能傻傻地只等三方的回调通知**因为有可能**网络故障没有收到回调**，而要**主动去查询**，通过定时任务进行轮询，直到拿到支付的最终状态，

1. **黄牛刷单**：可以通过 **添加图形验证码**、**IP 黑名单**等方式实现。
2. **订单问题**：
