...
title: "揭秘一致性Hash算法"
sidebarGroup: "综合篇"
shortTitle: "揭秘一致性Hash算法"
order: 136
date: 2026-05-20
category: "面试题"
tag:
  - "面试题"
description: "哈喽，各位小伙伴，我是一锅炖不下的北冥今天给大家带来的一致性hash算法。它在很多领域都有广泛的应用，比如负载均衡、分布式存储、分布式缓存等等。那Hash算法和一致性Hash算法有什么区别呢？hash算法想必大家伙都很熟了，就是把一段任意长"
article: false
---

> 来源：[揭秘一致性Hash算法](https://www.yuque.com/tulingzhouyu/db22bv/ylpphyge5d6oowqc)
...
![image](/面试题/综合篇/0136-secret-consistency-hash-algorithm/img-397217dc8235.png)
...
![image](/面试题/综合篇/0136-secret-consistency-hash-algorithm/img-f068f08ce461.png)
...
![image](/面试题/综合篇/0136-secret-consistency-hash-algorithm/img-deaf08c31004.png)
...
![image](/面试题/综合篇/0136-secret-consistency-hash-algorithm/img-c459cb654af1.png)
...
![image](/面试题/综合篇/0136-secret-consistency-hash-algorithm/img-b03f3807685d.png)
...
![image](/面试题/综合篇/0136-secret-consistency-hash-algorithm/img-e900bd121c39.png)
...
![image](/面试题/综合篇/0136-secret-consistency-hash-algorithm/img-da1a57d51244.png)
...
![image](/面试题/综合篇/0136-secret-consistency-hash-algorithm/img-f80952f98130.png)
...
![image](/面试题/综合篇/0136-secret-consistency-hash-algorithm/img-72a4550d2576.png)
...
![image](/面试题/综合篇/0136-secret-consistency-hash-algorithm/img-97b6f443b078.png)

但是，理想很丰满，现实很骨感，我们想象的与实际情况往往不一样。在实际的映射中，服务器可能会被映射成如下模样。

![image](/面试题/综合篇/0136-secret-consistency-hash-algorithm/img-1574fe8a6783.png)

聪明如你一定想到了，如果服务器被映射成上图中的模样，那么被缓存的对象很有可能大部分集中缓存在某一台服务器上，如下图所示。

![image](/面试题/综合篇/0136-secret-consistency-hash-algorithm/img-0ab2ed8bd445.png)
...
![image](/面试题/综合篇/0136-secret-consistency-hash-algorithm/img-1fc2e8b70cf6.png)
