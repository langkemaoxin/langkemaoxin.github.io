...
title: "什么是对称加密与非对称加密"
sidebarGroup: "网络安全"
shortTitle: "什么是对称加密与非对称加密"
order: 1336
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "对称加密和非对称加密是两种常见的加密算法。对称加密使用相同的密钥来进行加密和解密。发送方使用密钥将消息转化为加密形式，接收方使用相同的密钥将密文还原为明文。对称加密的主要优点是处理速度快，适用于大量数据的加密。然而，这也带来了一个安全挑战："
article: false
---

> 来源：[什么是对称加密与非对称加密](https://www.yuque.com/tulingzhouyu/db22bv/nxyk1fk0l465qsqc)
