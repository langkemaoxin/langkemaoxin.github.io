---
title: "请简述Docker和LXC的区别"
sidebarGroup: "Docker与K8S"
shortTitle: "请简述Docker和LXC的区别"
order: 1372
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "Docker和LXC在以下四个方面存在差异：镜像管理：Docker将应用的所有配置打包到一个容器中，具有可移植性。LXC仅仅实现了进程沙盒化，并不能在不同机器上进行移植。范围和规模：Docker不仅可以运行在Linux环境，还可以运行在Wi"
article: false
---

> 来源：[请简述Docker和LXC的区别](https://www.yuque.com/tulingzhouyu/db22bv/fgoq0axgqgnhp77o)
