---
title: kubernetes集群使用容器镜像仓库Harbor
sidebarGroup: K8s 课程笔记
shortTitle: 02 kubernetes集群使用容器镜像仓库Ha...
order: 2
...
tag:
  ...
  - 云原生
  - 课程笔记
description: Kubernetes集群使用容器镜像仓库Harbor 一、容器镜像仓库Harbor部署 1.1 在docker主机部署harbor 1.1.1 docker-ce安装 1.1.1.1 获取YUM源 使...
---
...
![image-20220125232445910](/云原生/k8s-course/k8s-course-02-kubernetes集群使用容器镜像仓库harbor/image-20220125232445910.png)

![image-20220125232519365](/云原生/k8s-course/k8s-course-02-kubernetes集群使用容器镜像仓库harbor/image-20220125232519365.png)

![image-20220614112423090](/云原生/k8s-course/k8s-course-02-kubernetes集群使用容器镜像仓库harbor/image-20220614112423090.png)

![image-20220614112444701](/云原生/k8s-course/k8s-course-02-kubernetes集群使用容器镜像仓库harbor/image-20220614112444701.png)

![image-20220614112508085](/云原生/k8s-course/k8s-course-02-kubernetes集群使用容器镜像仓库harbor/image-20220614112508085.png)

![image-20220614112527380](/云原生/k8s-course/k8s-course-02-kubernetes集群使用容器镜像仓库harbor/image-20220614112527380.png)
...
![image-20220614121150040](/云原生/k8s-course/k8s-course-02-kubernetes集群使用容器镜像仓库harbor/image-20220614121150040.png)

![image-20220614121218531](/云原生/k8s-course/k8s-course-02-kubernetes集群使用容器镜像仓库harbor/image-20220614121218531.png)
...
![image-20220614121936871](/云原生/k8s-course/k8s-course-02-kubernetes集群使用容器镜像仓库harbor/image-20220614121936871.png)

![image-20220614122029572](/云原生/k8s-course/k8s-course-02-kubernetes集群使用容器镜像仓库harbor/image-20220614122029572.png)
...
![image-20220614123555567](/云原生/k8s-course/k8s-course-02-kubernetes集群使用容器镜像仓库harbor/image-20220614123555567.png)
