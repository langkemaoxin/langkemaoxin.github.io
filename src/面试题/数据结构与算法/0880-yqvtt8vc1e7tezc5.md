---
title: "说说你对图 - 最小生成树的理解"
sidebarGroup: "数据结构与算法"
shortTitle: "说说你对图 - 最小生成树的理解"
order: 880
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "最小生成树是图论中的一个重要概念，指的是一个连通图的一棵生成树，使得该生成树上所有边的权重之和最小。普里姆算法和克鲁斯卡尔算法是求解最小生成树的经典方法。普里姆算法从任意一个节点开始，逐步扩展生成树，每次选择与当前生成树连接的权重最小且未被"
article: false
---

> 来源：[说说你对图 - 最小生成树的理解](https://www.yuque.com/tulingzhouyu/db22bv/yqvtt8vc1e7tezc5)
