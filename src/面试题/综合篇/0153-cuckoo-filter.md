...
sidebarGroup: "综合篇"
shortTitle: "布谷鸟过滤器（Cuckoo Filter)"
order: 153
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "1 概述在允许一定误判率的大数据量下的查找是否存在问题上可以使用布隆过滤器，详情上篇文章。布隆过滤器在工程应用方面已经比较成熟了，上一篇文章中，谈到了布隆过滤器的一些缺点，比如不支持删除操作、查询效率弱，因为多个随机哈希函数探测的是bit数"
article: false
---

> 来源：[布谷鸟过滤器（Cuckoo Filter)](https://www.yuque.com/tulingzhouyu/db22bv/kxb1pes1rv2mltqe)
...
![image](/面试题/综合篇/0153-cuckoo-filter/img-5a92a3560033.png)
...
![image](/面试题/综合篇/0153-cuckoo-filter/img-ee2d23168c1c.png)

## 3 布谷鸟过滤器

![image](/面试题/综合篇/0153-cuckoo-filter/img-bfad8d7d1656.jpg)
...
![image](/面试题/综合篇/0153-cuckoo-filter/img-c70b2d87a85a.png)
...
![image](/面试题/综合篇/0153-cuckoo-filter/img-b4ff25be44d7.jpg)
