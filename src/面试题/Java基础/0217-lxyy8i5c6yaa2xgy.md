---
title: "char型变量能存贮一个中文汉字吗"
sidebarGroup: "Java基础"
shortTitle: "char型变量能存贮一个中文汉字吗"
order: 217
date: 2026-05-19
category: "面试题"
tag:
  - "面试题"
description: "在Java中，char类型是用来表示单个字符的数据类型，它采用Unicode编码，可以存储各种字符，包括中文汉字。由于Unicode编码使用16位来表示一个字符，char类型占用2个字节的内存空间。而中文汉字通常使用UTF-8编码，一个中文"
article: false
---

> 来源：[char型变量能存贮一个中文汉字吗](https://www.yuque.com/tulingzhouyu/db22bv/lxyy8i5c6yaa2xgy)
