...
title: "谈谈你对Spring的理解"
sidebarGroup: "基础篇"
shortTitle: "谈谈你对Spring的理解"
order: 434
date: 2026-06-11
category: "面试题"
tag:
  - "面试题"
description: "可以从2个层面理解Spring:首先Spring是一个生态：可以构建企业级应用程序所需的一切基础设施 但是，通常Spring指的就是Spring Framework，它有两大核心：IOC 和 DI 的支持Spring 的核心就是一个大的工厂"
article: false
---

> 来源：[谈谈你对Spring的理解](https://www.yuque.com/tulingzhouyu/db22bv/raaan4q8yg1zulg3)
