...
sidebarGroup: "Mysql"
shortTitle: "MySQL InnoDB的MVCC实现机制"
order: 353
date: 2026-01-07
category: "面试题"
tag:
  - "面试题"
description: "MySQL 中InnoDB中实现了事务（多版本并发控制MVCC+锁）， 其中通过MVCC解决隔离性问题。具体而言，MVCC就是为了实现读-写冲突不加锁，而这个读指的就是快照读, 而非当前读，当前读实际上是一种加锁的操作，是悲观锁的实现; 本"
article: false
---

> 来源：[MySQL InnoDB的MVCC实现机制](https://www.yuque.com/tulingzhouyu/db22bv/dramscudnm47xh5s)
