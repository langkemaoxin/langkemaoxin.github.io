---
title: "42.LoRA的原理及参数量计算"
sidebarGroup: "云计算"
shortTitle: "42.LoRA的原理及参数量计算"
order: 1423
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "一、答题思路回答需覆盖四大核心：LoRA原理：低秩分解思想、训练与推理机制 参数量计算：公式拆解、对比全量微调秩r选择经验：任务复杂度、显存限制、效果平衡的量化策略项目案例：真实场景中r值调优过程及效果对比二、项目案例案例1：医疗问答系统微"
article: false
---

> 来源：[42.LoRA的原理及参数量计算](https://www.yuque.com/tulingzhouyu/db22bv/lclpu9a6lvfsvs8y)

### 一、答题思路

![image](/面试题/云计算/1423-lora-principles-parameter-count/img-ea559b307783.png)
...
![image](/面试题/云计算/1423-lora-principles-parameter-count/img-3d29ed49495c.png)
...
- 以`q_proj`层为例（d_in=4096, d_out=4096）： `8 × (4096 + 4096) = 65,536`
...
![image](/面试题/云计算/1423-lora-principles-parameter-count/img-e04e539537bc.png)
