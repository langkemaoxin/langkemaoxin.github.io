---
title: "为什么CAP原则不能全部满足"
sidebarGroup: "分布式"
shortTitle: "为什么CAP原则不能全部满足"
order: 712
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "(1) 场景如下图，是我们证明CAP的基本场景，分布式网络中有两个节点Host1和Host2，他们之间网络可以连通，Host1中运行Process1程序和对应的数据库Data，Host2中运行Process2程序和对应数据库Data。(2)"
article: false
---

> 来源：[为什么CAP原则不能全部满足](https://www.yuque.com/tulingzhouyu/db22bv/hoqweg9el3zbuhpv)

## (1) 场景

如下图，是我们证明CAP的基本场景，分布式网络中有两个节点Host1和Host2，他们之间网络可以连通，Host1中运行Process1程序和对应的数据库Data，Host2中运行Process2程序和对应数据库Data。

![image](/面试题/分布式/0712-why-cap-cannot-all-be-satisfied/img-03f953c98f71.png)
...
![image](/面试题/分布式/0712-why-cap-cannot-all-be-satisfied/img-8d9fb432ea1a.png)
...
![image](/面试题/分布式/0712-why-cap-cannot-all-be-satisfied/img-ad08ff3b55a4.png)
...
![image](/面试题/分布式/0712-why-cap-cannot-all-be-satisfied/img-f23db2e0dc0b.png)
