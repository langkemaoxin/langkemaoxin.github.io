...
sidebarGroup: "Java基础"
shortTitle: "String，Stringbuffer，StringBuilder的区别"
order: 176
date: 2026-03-17
category: "面试题"
tag:
  - "面试题"
description: "三者均是Java中用来处理字符串的类，它们之间的主要区别如下：可变性：String是不可变的类，一旦创建就不能被修改。每次对String进行操作时，都会创建一个新的String对象。StringBuffer和StringBuilder是可变"
article: false
---

> 来源：[String，Stringbuffer，StringBuilder的区别](https://www.yuque.com/tulingzhouyu/db22bv/maogc2ulwzntgc6q)
