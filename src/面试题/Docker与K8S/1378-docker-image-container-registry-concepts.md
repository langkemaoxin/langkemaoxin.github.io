---
title: "请解释Docker的镜像、容器、仓库的概念"
sidebarGroup: "Docker与K8S"
shortTitle: "请解释Docker的镜像、容器、仓库的概念"
order: 1378
date: 2026-04-28
category: "面试题"
tag:
  - "面试题"
description: "Docker的镜像、容器、仓库是Docker技术中的三个核心概念，以下是它们的解释：镜像（Image）：镜像是一个只读的模板，它包含了运行应用程序所需的环境和文件。例如，一个镜像可以包含一个完整的Ubuntu操作系统环境，里面仅安装了Apa"
article: false
---

> 来源：[请解释Docker的镜像、容器、仓库的概念](https://www.yuque.com/tulingzhouyu/db22bv/agxx8047cc5io7vl)
