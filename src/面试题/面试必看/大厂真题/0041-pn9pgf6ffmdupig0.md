...
tag:
  - "面试题"
description: "WhyMysql?NoSQL数据库四大家族      列存储 HbaseK-V存储 Redis图像存储 Neo4j文档存储 MongoDB云存储OSS海量 AerospikeAerospike（简称AS）是一个分布式，可扩展的键值存储的No"
article: false
---

> 来源：[MySQL篇](https://www.yuque.com/tulingzhouyu/db22bv/pn9pgf6ffmdupig0)
