...
shortTitle: "说说你对图 - 遍历的理解"
order: 879
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "在计算机科学中，图是由一些点（节点或顶点）和连接这些点的线（边或权重）组成的数据结构。遍历是对图进行搜索的过程，它可以访问所有节点，并按照一定顺序处理它们。图遍历分为深度优先搜索和广度优先搜索两种方法。深度优先搜索先访问一个节点及其相邻未访"
article: false
---

> 来源：[说说你对图 - 遍历的理解](https://www.yuque.com/tulingzhouyu/db22bv/xi8zn8cdzbnsgaa5)
