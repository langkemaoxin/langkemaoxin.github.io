...
title: "什么时候不要使用索引？"
sidebarGroup: "Mysql"
shortTitle: "什么时候不要使用索引？"
order: 382
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "在大多数情况下，使用索引可以提高数据库查询的性能和效率。但也有一些情况下，不使用索引可能更合适：小型表：对于非常小的表，可能不需要使用索引。因为索引的维护需要额外的存储空间和计算资源，而对于小型表来说，全表扫描的开销可能相对较小。插入、更新"
article: false
---

> 来源：[什么时候不要使用索引？](https://www.yuque.com/tulingzhouyu/db22bv/bgrh92s14ifi3o0t)
