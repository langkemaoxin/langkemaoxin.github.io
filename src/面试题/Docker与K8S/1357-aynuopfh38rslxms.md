---
title: "简述Kubernetes的工作流程"
sidebarGroup: "Docker与K8S"
shortTitle: "简述Kubernetes的工作流程"
order: 1357
date: 2026-06-07
category: "面试题"
tag:
  - "面试题"
description: "Kubernetes的工作流程可以分为以下几个步骤：创建一个包含应用程序的Deployment的yml文件，然后通过kubectl客户端工具发送给ApiServer。ApiServer接收到客户端的请求并将资源内容存储到数据库(etcd)中"
article: false
---

> 来源：[简述Kubernetes的工作流程](https://www.yuque.com/tulingzhouyu/db22bv/aynuopfh38rslxms)
