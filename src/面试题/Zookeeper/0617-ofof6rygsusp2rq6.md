---
title: "ZAB 和 Paxos 算法的联系与区别"
sidebarGroup: "Zookeeper"
shortTitle: "ZAB 和 Paxos 算法的联系与区别"
order: 617
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "ZAB（ZooKeeper Atomic Broadcast）算法和Paxos算法都是分布式系统中用于实现数据一致性的算法。两者的主要联系在于它们都采用了类似领导者的选举机制，通过多数派的投票来保证系统的稳定性。在ZAB中，这体现在它使用了"
article: false
---

> 来源：[ZAB 和 Paxos 算法的联系与区别](https://www.yuque.com/tulingzhouyu/db22bv/ofof6rygsusp2rq6)
