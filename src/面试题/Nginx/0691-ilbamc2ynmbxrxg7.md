---
title: "解释一下NGINX的反向代理和正向代理的区别。"
sidebarGroup: "Nginx"
shortTitle: "解释一下NGINX的反向代理和正向代理的区别。"
order: 691
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "NGINX可以用作正向代理和反向代理，它们在代理服务器的使用方式和作用方向上有所不同。下面是正向代理和反向代理的区别：正向代理： 代理对象不同：正向代理是代理服务器位于客户端和目标服务器之间。客户端发送请求到正向代理服务器，然后代理服务器将"
article: false
---

> 来源：[解释一下NGINX的反向代理和正向代理的区别。](https://www.yuque.com/tulingzhouyu/db22bv/ilbamc2ynmbxrxg7)
