---
title: "如何定位慢 SQL 产生的原因"
sidebarGroup: "大厂真题"
shortTitle: "如何定位慢 SQL 产生的原因"
order: 67
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "要定位慢SQL产生的原因，可以通过以下几个步骤进行排查：使用MySQL的查询日志：可以在MySQL的配置文件中启用查询日志（query log）。启用查询日志后，MySQL会记录下执行的所有SQL语句和执行时间。通过分析查询日志，可以找到执"
article: false
---

> 来源：[如何定位慢 SQL 产生的原因](https://www.yuque.com/tulingzhouyu/db22bv/mxkpebq5d2dygsoz)
