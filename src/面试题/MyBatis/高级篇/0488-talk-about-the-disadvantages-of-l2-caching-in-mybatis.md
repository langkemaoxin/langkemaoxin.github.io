---
title: "讲讲MyBatis中二级缓存的缺点？"
sidebarGroup: "高级篇"
shortTitle: "讲讲MyBatis中二级缓存的缺点？"
order: 488
date: 2026-06-10
category: "面试题"
tag:
  - "面试题"
description: "二级缓存主要用来加速数据的访问。比如说，我们要从数据库中获取一些数据，但是每次都直接去数据库查询会有点慢，这时候二级缓存就能派上用场。它会把之前查询过的结果存起来，下次如果还需要同样的数据，就可以直接从缓存里拿，这样就不用再去数据库那里查询"
article: false
---

> 来源：[讲讲MyBatis中二级缓存的缺点？](https://www.yuque.com/tulingzhouyu/db22bv/aex0mfigrga4llrm)
