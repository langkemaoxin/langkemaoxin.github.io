...
> **Kubernetes 系列 · 第 23/30 篇**  
> 上一篇：[《部署方法横向对比——二进制、RKE/RKE2、k0s、sealos 与 kubespray》](/云原生/k8s/k8s-22-deploy-methods)  
> 下一篇：[《集群日志收集——ELK 与 EFK》](/云原生/k8s/k8s-24-logging-elk-efk)
...
关于 CRI 接口本身，[第 8 篇](/云原生/k8s/k8s-08-hpa-cri-crd)已经讲过；kubeadm 标准部署流程见[第 21 篇](/云原生/k8s/k8s-21-deploy-kubeadm-ha)。本文聚焦：**四种容器运行时怎么选、两种国产 OS 上怎么装、以及国产化环境的差异坑清单**。
...
集群跑起来后，日志收集是下一个绕不开的运维课题——下一篇讲 [ELK 与 EFK](/云原生/k8s/k8s-24-logging-elk-efk)。
