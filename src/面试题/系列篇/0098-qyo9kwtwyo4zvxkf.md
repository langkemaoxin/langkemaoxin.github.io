---
title: "👍 Java性能调优面试题突击课"
sidebarGroup: "系列篇"
shortTitle: "👍 Java性能调优面试题突击课"
order: 98
date: 2026-01-28
category: "面试题"
tag:
  - "面试题"
description: "你能解释一下什么是JVM吗？它是如何工作的？我们都知道在Windows系统里面一个软件安装包是exe文件对吧。但是在MacOS里面exe文件是不能够安装的，只能安装dmg后缀的安装包。同样的Mac系统里的安装包在Windows里面是无法安装"
article: false
---

> 来源：[👍 Java性能调优面试题突击课](https://www.yuque.com/tulingzhouyu/db22bv/qyo9kwtwyo4zvxkf)
