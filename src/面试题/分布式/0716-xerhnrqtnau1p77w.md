...
title: "一文了解Paxos 算法"
sidebarGroup: "分布式"
shortTitle: "一文了解Paxos 算法"
order: 716
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "本文主要介绍了 Paxos 算法，包括 Basic Paxos 和 Multi Paxos。Basic Paxos 算法中存在提议者、接受者、学习者三种角色，通过准备和接受两个阶段达成共识，还讲解了接受者存在已通过提案的情况。Multi P"
article: false
---

> 来源：[一文了解Paxos 算法](https://www.yuque.com/tulingzhouyu/db22bv/xerhnrqtnau1p77w)
