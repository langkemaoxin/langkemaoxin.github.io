---
title: "Seata是什么？它的工作原理是什么？"
sidebarGroup: "SpringCloud"
shortTitle: "Seata是什么？它的工作原理是什么？"
order: 558
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "Seata是一款开源的分布式事务解决方案，它提供了一个简单、高性能和易于使用的分布式事务服务。Seata的工作原理是基于两阶段提交协议的演变，通过将业务数据和回滚日志记录在同一个本地事务中提交，释放本地锁和连接资源，然后通过异步提交的方式快"
article: false
---

> 来源：[Seata是什么？它的工作原理是什么？](https://www.yuque.com/tulingzhouyu/db22bv/ri4rc7begwh2dbd6)
