...
sidebarGroup: "Mysql"
shortTitle: "MyISAM索引与InnoDB索引的区别？"
order: 380
date: 2026-03-17
category: "面试题"
tag:
  - "面试题"
description: "MyISAM和InnoDB是MySQL中两种常见的存储引擎，它们在索引实现上存在以下区别：存储方式：MyISAM使用非聚簇索引，索引文件和数据文件是分开的；而InnoDB使用聚簇索引，将索引和数据一起存储在同一个文件中。锁机制：MyISAM"
article: false
---

> 来源：[MyISAM索引与InnoDB索引的区别？](https://www.yuque.com/tulingzhouyu/db22bv/ltffxdbt9aezpykp)
