---
title: "搜索引擎设计：信息搜索怎么避免大海捞针"
sidebarGroup: "项目设计场景题"
shortTitle: "搜索引擎设计：信息搜索怎么避免大海捞针"
order: 811
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "我们准备开发一个针对全网内容的搜索引擎，产品名称为“Bingoo”。Bingoo的主要技术挑战包括：针对爬虫获取的海量数据，如何高效地进行数据管理；当用户输入搜索词的时候，如何快速查找包含搜索词的网页内容；如何对搜索结果的网页内容进行排序，"
article: false
---

> 来源：[搜索引擎设计：信息搜索怎么避免大海捞针](https://www.yuque.com/tulingzhouyu/db22bv/swd3eq7yo68qwugs)
...
![image](/面试题/项目设计场景题/0811-search-engine-design-avoid-needle-in-haystack/img-ee4f378c4f7a.png)

分布式爬虫通过存储服务器将爬取的网页存储到分布式文件集群HDFS，为了提高存储效率，网页将被压缩后存储。存储的时候，网页一个文件挨着一个文件地连续存储，存储格式如下。

![image](/面试题/项目设计场景题/0811-search-engine-design-avoid-needle-in-haystack/img-3c3c41d3e06f.png)
...
![image](/面试题/项目设计场景题/0811-search-engine-design-avoid-needle-in-haystack/img-eb6e744b50a0.png)

然后遍历所有的正排索引，再按照“单词→docID列表”的方式组织起来，就是倒排索引了。

![image](/面试题/项目设计场景题/0811-search-engine-design-avoid-needle-in-haystack/img-ae72e0c68d41.png)
...
![image](/面试题/项目设计场景题/0811-search-engine-design-avoid-needle-in-haystack/img-eef2648c12d5.png)
...
![image](/面试题/项目设计场景题/0811-search-engine-design-avoid-needle-in-haystack/img-ccbe5bb9596b.jpg)
...
![image](/面试题/项目设计场景题/0811-search-engine-design-avoid-needle-in-haystack/img-6c236cfb6808.jpg)

第一个链表遍历到自己的最后一个元素，才和第二个链表的第一个元素相同。那么第一个链表能不能跳过前面那些元素呢？很自然，我们想到可以用**跳表**来实现，如下图。

![image](/面试题/项目设计场景题/0811-search-engine-design-avoid-needle-in-haystack/img-509b016e62b5.jpg)
...
![image](/面试题/项目设计场景题/0811-search-engine-design-avoid-needle-in-haystack/img-d1b11fe0b93e.png)
...
![image](/面试题/项目设计场景题/0811-search-engine-design-avoid-needle-in-haystack/img-3786a41c1fd0.png)
