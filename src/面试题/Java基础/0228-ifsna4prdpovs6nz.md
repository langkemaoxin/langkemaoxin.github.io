---
title: "讲讲你对CountDownLatch的理解"
sidebarGroup: "Java基础"
shortTitle: "讲讲你对CountDownLatch的理解"
order: 228
date: 2026-02-27
category: "面试题"
tag:
  - "面试题"
description: "CountDownLatch是Java中用于多线程协作的辅助类，它可以让一个或多个线程等待其他线程完成某个任务后再继续执行。CountDownLatch通过一个计数器来实现，计数器的初始值可以设置为等待的线程数量。每个线程在完成任务后都会调"
article: false
---

> 来源：[讲讲你对CountDownLatch的理解](https://www.yuque.com/tulingzhouyu/db22bv/ifsna4prdpovs6nz)
