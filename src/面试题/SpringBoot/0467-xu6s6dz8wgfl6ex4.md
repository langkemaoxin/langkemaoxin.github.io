...
shortTitle: "为什么SpringBoot的jar可以直接运行？"
order: 467
date: 2026-03-25
category: "面试题"
tag:
  - "面试题"
description: "Spring Boot的可执行JAR文件之所以可以直接运行，原因如下：第一个关键点： Spring Boot提供了一个Maven插件（spring-boot-maven-plugin），用于将应用程序打包成可执行的JAR文件。通过执行mvn"
article: false
---

> 来源：[为什么SpringBoot的jar可以直接运行？](https://www.yuque.com/tulingzhouyu/db22bv/xu6s6dz8wgfl6ex4)
