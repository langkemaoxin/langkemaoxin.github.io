---
title: "MySQL踩坑笔记，加了唯一索引还会出现重复数据？"
sidebarGroup: "Mysql"
shortTitle: "MySQL踩坑笔记，加了唯一索引还会出现重复数据？"
order: 344
date: 2026-07-23
category: "面试题"
tag:
  - "面试题"
description: "还原问题表结构如下：-- 表格式 CREATE TABLE `student_course` (   `id` bigint NOT NULL,   `student_id` bigint NOT NULL,   `course_id` b"
article: false
---

> 来源：[MySQL踩坑笔记，加了唯一索引还会出现重复数据？](https://www.yuque.com/tulingzhouyu/db22bv/ac3uu4txf07ypf8q)
...
![image](/面试题/Mysql/0344-mysql-pit-notes-add-a-unique-index-and-duplicate-data-will/img-4d4f2c6f5481.png)

接下来，我们再插入两条`xxx_id`为`null`的数据，其中第三条数据跟第二条数据中`student_id`、`course_id`和`xxx_id`字段值都一样.

![image](/面试题/Mysql/0344-mysql-pit-notes-add-a-unique-index-and-duplicate-data-will/img-7453964e121d.png)
...
![image](/面试题/Mysql/0344-mysql-pit-notes-add-a-unique-index-and-duplicate-data-will/img-dec3e9087158.png)
