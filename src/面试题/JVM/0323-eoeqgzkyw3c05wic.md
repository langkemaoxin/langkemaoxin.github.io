...
title: "可以打破双亲委派机制吗"
sidebarGroup: "JVM"
shortTitle: "可以打破双亲委派机制吗"
order: 323
date: 2026-08-08
category: "面试题"
tag:
  - "面试题"
description: "是的，Java中的双亲委派机制（Parent Delegation Model）可以被打破。双亲委派机制默认的加载类逻辑是：当一个类加载器需要加载某个类时，先请求它的父类加载器进行加载，只有在父加载器找不到该类时，它才会尝试自己加载。为了打"
article: false
---

> 来源：[可以打破双亲委派机制吗](https://www.yuque.com/tulingzhouyu/db22bv/eoeqgzkyw3c05wic)
