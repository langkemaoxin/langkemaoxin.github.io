---
title: "29.知识蒸馏的原理及适用场景"
sidebarGroup: "云计算"
shortTitle: "29.知识蒸馏的原理及适用场景"
order: 1436
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "一、答题思路知识蒸馏（Knowledge Distillation）是一种模型压缩技术，核心思想是将复杂模型（教师模型）的知识迁移到简单模型（学生模型）中，在保持性能的同时降低计算成本。回答需覆盖以下维度：原理：教师模型输出软标签（概率分布"
article: false
---

> 来源：[29.知识蒸馏的原理及适用场景](https://www.yuque.com/tulingzhouyu/db22bv/vuirs22d7z30zut9)

### 一、答题思路

![image](/面试题/云计算/1436-knowledge-distillation-principles-use-cases/img-3a646b1c3693.png)
...
![image](/面试题/云计算/1436-knowledge-distillation-principles-use-cases/img-9bae852ef5d4.png)
...
3. **温度参数**：设置温度系数T=5，平滑概率分布，使学生模型学习到“风筝与塑料袋的视觉相似性”等隐性知识。 **结果**：
...
2. **领域知识注入**：在蒸馏损失中加入政策关键词权重（如“FATF标准”权重提升30%）。 **结果**：
...
![image](/面试题/云计算/1436-knowledge-distillation-principles-use-cases/img-917b25827b91.png)
...
- **温度参数（T）**：放大输出分布的熵值，使学生模型更易学习复杂关系，公式：
![](/面试题/云计算/1436-knowledge-distillation-principles-use-cases/img-42437d058398.svg)
- **损失函数**：，其中α平衡软硬标签权重。
![](/面试题/云计算/1436-knowledge-distillation-principles-use-cases/img-fe02353b8800.svg)
...
![image](/面试题/云计算/1436-knowledge-distillation-principles-use-cases/img-bffa4bac3258.png)
