---
title: "17.什么是大模型epoch和学习率"
sidebarGroup: "云计算"
shortTitle: "17.什么是大模型epoch和学习率"
order: 1448
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "以下是从面试开发工程师岗位的专业回答框架，结合实际项目案例（金融领域文本生成模型训练）项目背景参数设置与调优效果验证关键发现示例回答答题思路（结构化拆解）基础定义：用技术+业务双视角解释概念Epoch：模型遍历全体训练数据的完整周期，相当于"
article: false
---

> 来源：[17.什么是大模型epoch和学习率](https://www.yuque.com/tulingzhouyu/db22bv/vfcdglwwrmmrcadg)
...
- 当模型预测错误时，参数调整幅度为： [ \Delta w = 0.00005 \times \text{梯度值} ]
- 如果某权重梯度是 1000，实际调整量： ( 0.00005 \times 1000 = 0.05 )
