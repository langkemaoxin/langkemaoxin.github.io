...
tag:
  - "面试题"
description: "MySql在什么情况会加锁？有哪些锁 在 MySQL 中，加锁的情况主要包括以下几种：事务中的写操作： 当一个事务执行更新操作（如 INSERT、UPDATE、DELETE）时，MySQL 会自动对涉及的数据行加上排他锁，防止其他事务对相同"
article: false
---

> 来源：[短视频](https://www.yuque.com/tulingzhouyu/db22bv/tqn9wy9itq1812ak)
