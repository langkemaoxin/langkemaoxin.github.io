...
title: "说说你对泛型的理解"
sidebarGroup: "Java基础"
shortTitle: "说说你对泛型的理解"
order: 197
date: 2026-07-20
category: "面试题"
tag:
  - "面试题"
description: "简答：泛型是Java中的一个特性，它允许我们在定义类、接口或方法时使用类型参数，以实现代码的通用性和安全性。泛型的目的是在编译时进行类型检查，并提供编译期间的类型安全。泛型的理解包括以下几个方面：首先，泛型提供了代码重用和通用性。通过使用泛"
article: false
---

> 来源：[说说你对泛型的理解](https://www.yuque.com/tulingzhouyu/db22bv/eenepwcu5me70mre)
...
![image](/面试题/Java基础/0197-tell-me-about-your-understanding-of-generics/img-9de0fb02662c.png)
...
![image](/面试题/Java基础/0197-tell-me-about-your-understanding-of-generics/img-98d29a0d3c2e.png)
...
![image](/面试题/Java基础/0197-tell-me-about-your-understanding-of-generics/img-3becc311abcb.png)
...
![image](/面试题/Java基础/0197-tell-me-about-your-understanding-of-generics/img-308a9a8fdd35.png)
...
![image](/面试题/Java基础/0197-tell-me-about-your-understanding-of-generics/img-18a50f0effc7.png)
...
![image](/面试题/Java基础/0197-tell-me-about-your-understanding-of-generics/img-f9d44e357b40.png)

![image](/面试题/Java基础/0197-tell-me-about-your-understanding-of-generics/img-9841065bc159.png)

格式

![image](/面试题/Java基础/0197-tell-me-about-your-understanding-of-generics/img-85177a841a32.png)

![image](/面试题/Java基础/0197-tell-me-about-your-understanding-of-generics/img-46195778523a.png)
...
![image](/面试题/Java基础/0197-tell-me-about-your-understanding-of-generics/img-1187dff0d518.png)

![image](/面试题/Java基础/0197-tell-me-about-your-understanding-of-generics/img-b36ee7783d88.png)
...
![image](/面试题/Java基础/0197-tell-me-about-your-understanding-of-generics/img-af573f9ffb30.png)
...
![image](/面试题/Java基础/0197-tell-me-about-your-understanding-of-generics/img-832fb50cb971.png)
...
明明我们在 <> 中传入了两种不同的数据类型，那为什么它们的类信息还是相同呢？ 这是因为，在编译期间，所有的泛型信息都会被擦除， ArrayList< Integer > 和 ArrayList< String >类型，**在编译后都会变成ArrayList类型**。

**那么是不是所有的类型参数被擦除后都以 Object 类进行替换呢**？

答案是否定的，大部分情况下，类型参数 T 被擦除后都会以 Object 类进行替换；而有一种情况则不是，那就是**使用到了 extends 和 super 语法的有界类型参数**（上界（`T extends Something`）或下界（`T super Something`）)
...
1. 泛型的继承 泛型不具备继承性,但是数据具备继承性   此时,泛型里面写的什么类型,那么就传递什么类型的数据
