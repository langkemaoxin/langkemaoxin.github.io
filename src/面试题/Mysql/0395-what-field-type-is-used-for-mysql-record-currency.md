---
title: "MySQL 记录货币用什么字段类型"
sidebarGroup: "Mysql"
shortTitle: "MySQL 记录货币用什么字段类型"
order: 395
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "在MySQL中记录货币金额，一般推荐使用DECIMAL字段类型。DECIMAL字段类型用于存储精确的定点数值，可以指定总共的位数和小数点后的位数。这使得它非常适合用于存储货币金额，因为货币金额通常需要精确到小数点后几位。以下是一个示例创建D"
article: false
---

> 来源：[MySQL 记录货币用什么字段类型](https://www.yuque.com/tulingzhouyu/db22bv/hp83cf520z8e45du)
