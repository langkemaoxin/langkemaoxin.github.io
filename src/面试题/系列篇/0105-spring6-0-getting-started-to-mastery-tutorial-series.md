...
![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-a63f8c100d90.png)
...
![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-2cf1e93e71c4.png)

### 配置环境变量

![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-57e114c26e18.png)

新开一个cmd测试：

![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-ad39ba283aff.png)
...
![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-99ec9a71edf7.png)
...
![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-b1a551b0c1a7.png)

那么可以执行cl.exe，如果是中文，那就得修改为英文。

![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-0939a2165e9e.png)

通过Visual Studio Installer来修改，比如：

![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-eda4513eb8ee.png)

可能一开始只选择了中文，手动选择英文，去掉中文，然后安装即可。

再次检查

![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-bc39ddffcf62.png)
...
![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-73ac1e111aee.png)

我们可以直接把graalvm当作普通的jdk的使用

![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-3fe105976565.png)
...
![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-871c9cc11442.png)

此时的class文件因为有main方法，所以用java命令可以运行

![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-374c2ec0ff35.png)

我们也可以利用native-image来编译：

![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-35aa908e4d60.png)

编译需要一些些。。。。。。。时间。

![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-213757be1ad4.png)

编译完了之后就会在当前目录生成一个exe文件：

![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-f81f494ae886.png)

我们可以直接运行这个exe文件：

![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-9cb6cf825858.png)
...
![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-993690461289.png)

![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-44d15c961ea1.png)
...
![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-7492fe2f3fd6.png)

执行完之后，就能看到docker镜像了：

![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-fdbc03cb9765.png)
...
![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-e9660b87f84c.png)
...
![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-082b295af3c7.png)
...
![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-e3a498928a75.png)
...
![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-0f2ef46d5441.png)

发现native:compile命令对应的实现类为NativeCompileMojo，并且会先执行package这个命令，从而会执行process-aot命令，因为spring-boot-maven-plugin插件中有如下配置：

![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-5b53c1afd40a.png)

我们可以执行`mvn help:describe -Dplugin=org.springframework.boot:spring-boot-maven-plugin -Ddetail`

![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-d38529823f79.png)
...
![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-9c92855c2f77.png)
...
![image](/面试题/系列篇/0105-spring6-0-getting-started-to-mastery-tutorial-series/img-aa855d1f65d4.png)
