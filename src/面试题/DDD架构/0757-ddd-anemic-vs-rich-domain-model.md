---
title: "DDD 中的贫血模型和充血模型有什么区别"
sidebarGroup: "DDD架构"
shortTitle: "DDD 中的贫血模型和充血模型有什么区别"
order: 757
date: 2026-04-17
category: "面试题"
tag:
  - "面试题"
description: "DDD中的贫血模型和充血模型都是领域模型的表现形式，但是它们在设计和实现上有着显著的区别。主要区别在于领域对象是否包含业务逻辑。贫血模型（Anemic Domain Model）是面向过程编程的一种表现形式。贫血模型的实体只包含数据属性和对"
article: false
---

> 来源：[DDD 中的贫血模型和充血模型有什么区别](https://www.yuque.com/tulingzhouyu/db22bv/mq2vkccbiqgss7kg)
