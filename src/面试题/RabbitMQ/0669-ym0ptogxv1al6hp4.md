---
title: "RabbitMQ 中有哪几种交换机类型？"
sidebarGroup: "RabbitMQ"
shortTitle: "RabbitMQ 中有哪几种交换机类型？"
order: 669
date: 2026-06-04
category: "面试题"
tag:
  - "面试题"
description: "RabbitMQ 支持多种交换机（Exchange）类型，每种类型都用于不同的消息路由和分发策略：Direct Exchange：这种交换机根据消息的路由键（Routing Key）将消息发送到与之完全匹配的队列。只有当消息的路由键与队列绑"
article: false
---

> 来源：[RabbitMQ 中有哪几种交换机类型？](https://www.yuque.com/tulingzhouyu/db22bv/ym0ptogxv1al6hp4)
