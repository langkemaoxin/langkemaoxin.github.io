---
title: "16.大模型意图识别是怎么做的"
sidebarGroup: "云计算"
shortTitle: "16.大模型意图识别是怎么做的"
order: 1449
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "一、答题思路定义与核心任务：用通俗语言解释意图识别的目标（从用户输入中解析出意图），并关联实际场景（如客服、智能助手）。  技术实现流程：分步骤拆解意图识别的典型流程（数据准备→模型训练→部署优化）。  大模型的核心作用：强调预训练模型（如"
article: false
---

> 来源：[16.大模型意图识别是怎么做的](https://www.yuque.com/tulingzhouyu/db22bv/pr84bz7y1zth07zg)
