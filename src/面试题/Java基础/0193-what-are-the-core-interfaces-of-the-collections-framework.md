---
title: "Java中的集合框架有哪些核心接口"
sidebarGroup: "Java基础"
shortTitle: "Java中的集合框架有哪些核心接口"
order: 193
date: 2026-07-12
category: "面试题"
tag:
  - "面试题"
description: "Java中的集合框架提供了一组接口和类，用于存储和操作数据集合。其中一些核心接口包括：Collection接口：是集合框架中最通用的接口，用于表示一组对象。它是List、Set和Queue接口的父接口，定义了对集合进行基本操作的方法。Lis"
article: false
---

> 来源：[Java中的集合框架有哪些核心接口](https://www.yuque.com/tulingzhouyu/db22bv/dl0w237u3ngawt4p)
