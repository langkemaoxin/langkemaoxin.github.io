---
title: "Netty是如何实现零拷贝的"
sidebarGroup: "Netty"
shortTitle: "Netty是如何实现零拷贝的"
order: 612
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "零拷贝（Zero-Copy）是一种优化技术，旨在减少或完全消除数据在内存中的复制过程，从而提高系统的性能和效率。在传统的数据传输过程中，数据可能会被多次复制，例如从磁盘到内核缓冲区，然后从内核缓冲区复制到用户缓冲区，再从用户缓冲区复制到另一"
article: false
---

> 来源：[Netty是如何实现零拷贝的](https://www.yuque.com/tulingzhouyu/db22bv/ekoctkf5nztzo0ky)
...
1. **缓冲区的切片（Slicing）和复制（Duplication）**：
