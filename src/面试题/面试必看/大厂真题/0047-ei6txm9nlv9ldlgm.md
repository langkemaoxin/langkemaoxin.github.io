...
sidebarGroup: "大厂真题"
shortTitle: "String 为什么要设计成不可变的"
order: 47
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "String被设计成不可变的有以下几个原因：线程安全：由于String是不可变的，多个线程可以同时访问同一个String对象而无需担心数据被修改。这使得String在多线程环境下是线程安全的。缓存Hash值：由于String是不可变的，它的"
article: false
---

> 来源：[String 为什么要设计成不可变的](https://www.yuque.com/tulingzhouyu/db22bv/ei6txm9nlv9ldlgm)
