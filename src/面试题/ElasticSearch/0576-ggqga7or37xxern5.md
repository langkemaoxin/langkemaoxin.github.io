---
title: "了解ElasticSearch 深翻页的问题及解决吗"
sidebarGroup: "ElasticSearch"
shortTitle: "了解ElasticSearch 深翻页的问题及解决吗"
order: 576
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "是的，我了解ElasticSearch的深翻页问题及其解决方法。ElasticSearch的深翻页问题主要与分页查询有关。在分页查询时，每次都需要对所有数据进行排序，然后取出指定范围的文档，这会导致查询效率低下和资源浪费。对于数据量较小（f"
article: false
---

> 来源：[了解ElasticSearch 深翻页的问题及解决吗](https://www.yuque.com/tulingzhouyu/db22bv/ggqga7or37xxern5)
