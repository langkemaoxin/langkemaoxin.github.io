---
title: "讲一下 ZooKeeper 的持久化机制"
sidebarGroup: "Zookeeper"
shortTitle: "讲一下 ZooKeeper 的持久化机制"
order: 621
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "Zookeeper的持久化机制主要涉及两种数据存储方式：内存存储和磁盘存储。内存存储：这是Zookeeper默认的数据存储方式。在内存存储中，Zookeeper将所有数据保存在内存中，而不是磁盘上。当Zookeeper关闭或发生故障时，内存"
article: false
---

> 来源：[讲一下 ZooKeeper 的持久化机制](https://www.yuque.com/tulingzhouyu/db22bv/ugbio6opgz73qh7w)
