---
title: "SpringMVC的拦截器和过滤器有什么区别？执行顺序？"
sidebarGroup: "高级篇"
shortTitle: "SpringMVC的拦截器和过滤器有什么区别？执行顺序？"
order: 441
date: 2026-05-06
category: "面试题"
tag:
  - "面试题"
description: "拦截器和过滤器在Web应用中都扮演着请求和响应处理的角色，但它们之间存在一些关键区别。首先，归属不同。拦截器是SpringMVC框架的一部分，而过滤器是Servlet规范的一部分。拦截器主要用于对控制器层的请求进行处理，它们提供了更细粒度的"
article: false
---

> 来源：[SpringMVC的拦截器和过滤器有什么区别？执行顺序？](https://www.yuque.com/tulingzhouyu/db22bv/ls1c6qxmrgedfwvf)
