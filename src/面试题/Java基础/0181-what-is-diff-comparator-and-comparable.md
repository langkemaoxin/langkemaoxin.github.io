---
title: "Comparator与Comparable有什么区别"
sidebarGroup: "Java基础"
shortTitle: "Comparator与Comparable有什么区别"
order: 181
date: 2026-06-30
category: "面试题"
tag:
  - "面试题"
description: "Comparator和Comparable都是Java中用于对象排序的接口，它们之间有一些关键的区别。Comparable接口是在对象自身的类中实现的，它定义了对象的自然排序方式。一个类实现了Comparable接口后，可以使用compar"
article: false
---

> 来源：[Comparator与Comparable有什么区别](https://www.yuque.com/tulingzhouyu/db22bv/rihz8qgxpcbgkdam)
