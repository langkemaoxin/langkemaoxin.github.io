---
title: "添加索引真的不会锁表吗？（online DDL）"
sidebarGroup: "Mysql"
shortTitle: "添加索引真的不会锁表吗？（online DDL）"
order: 334
date: 2026-05-27
category: "面试题"
tag:
  - "面试题"
description: "1.MySQL DDL执行方式MySQL5.5以及之前的版本，通常更改数据表结构操作(DDL)会阻塞对表数据的增删改操作(DML)。MySQL5.6提供Online DDL之后可支持DDL与DML操作同时执行，降低了DDL期间对业务延迟带来"
article: false
---

> 来源：[添加索引真的不会锁表吗？（online DDL）](https://www.yuque.com/tulingzhouyu/db22bv/kg0v6b4qtul15k1p)
...
![image](/面试题/Mysql/0334-does-adding-an-index-really-lock-the-table-online-ddl/img-44b3d42f6681.png)

![image](/面试题/Mysql/0334-does-adding-an-index-really-lock-the-table-online-ddl/img-12a99c4343ab.png)

![image](/面试题/Mysql/0334-does-adding-an-index-really-lock-the-table-online-ddl/img-5ba8713fbad4.png)
