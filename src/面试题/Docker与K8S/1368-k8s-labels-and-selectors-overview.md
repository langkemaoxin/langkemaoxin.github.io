---
title: "请简述Kubernetes中的Labels和Selectors的作用"
sidebarGroup: "Docker与K8S"
shortTitle: "请简述Kubernetes中的Labels和Selectors的作用"
order: 1368
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "Labels和Selectors是Kubernetes中的重要概念，它们主要用于标识和选择资源对象。Labels是附加在资源对象上的键值对标签。它们具有以下作用：标识和组织资源：Labels可以用于标识和组织Kubernetes中的资源，例"
article: false
---

> 来源：[请简述Kubernetes中的Labels和Selectors的作用](https://www.yuque.com/tulingzhouyu/db22bv/hgx8gs1g3nlqt6ze)
