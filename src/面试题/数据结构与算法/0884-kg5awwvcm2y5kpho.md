---
title: "说说你对排序 - 插入排序的理解"
sidebarGroup: "数据结构与算法"
shortTitle: "说说你对排序 - 插入排序的理解"
order: 884
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "插入排序是一种简单直观的排序算法。它将待排序的数组分为已排序和未排序两部分，初始时已排序部分只有一个元素。然后，从未排序部分选择一个元素，并将其插入到已排序部分的正确位置，以保持整体有序。具体实现步骤如下：从第二个元素开始，将其作为当前需要"
article: false
---

> 来源：[说说你对排序 - 插入排序的理解](https://www.yuque.com/tulingzhouyu/db22bv/kg5awwvcm2y5kpho)
