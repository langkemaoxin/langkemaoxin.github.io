...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-eca11779c258.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-fc36699c1f39.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-6a29b9bb2cd8.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-92995f81ea4b.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-035f92f68496.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-3aca9f382994.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-6f4112f7259a.png)

1. 选择文件夹并在 Trae 中将其打开。

你将看到以下授权弹窗：

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-c0ba4e61b00f.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-2cd330fd0ba2.png)

1. 点击 **从 GitHub 克隆**。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-56d0405f7ac4.png)

你将看到以下授权弹窗。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-caaf9690ad79.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-c2461baada91.png)

1. 点击 **复制并继续访问 GitHub**。

已复制授权码，然后你将看到以下弹窗：

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-65571ddd63a3.png)

1. 点击 **打开**。

你将前往 GitHub 上的登录授权页面。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-10a9429cd66e.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-7c34ea263d7b.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-6a5ea32fae64.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-22f529bf0f8f.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-579ceceb00b6.png)

1. 在弹窗中选择该仓库的存储地址，然后点击 **选择为存储库目标**。

Trae 开始克隆该仓库。克隆完毕后，你会看到以下弹窗。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-94010ecf154c.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-af5ed5f7e93e.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-c2ab5a0033c3.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-916366ea4759.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-a037b7dd1768.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-b02aaf6c2a58.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-59dbc4b12ace.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-752e5cf5d1a1.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-2dc5aea54d64.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-bcbb2f93fc03.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-67e87e8b23c0.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-ecb7e698d2f8.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-f91aa6f2c98d.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-1275a4719b6c.png)

### 生成并运行命令

根据你的需求，AI 助手会适时推荐必要的 Shell 命令供你运行（以下图为例）。你可以选择运行或跳过某个命令，AI 助手会根据你的操作完成后续的工作。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-7ff7732f592c.png)

点击 **运行** 后，终端将运行该命令。命令运行后，AI 助手会自动读取并分析运行结果。如果运行异常，AI 助手会自动分析原因，并给出建议解决方案。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-366363801e65.png)

若命令运行成功，你可以点击命令卡片右上角的 **终端** 按钮，然后在终端中查看该命令的运行日志。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-75e3b1c3bb3d.png)

### 预览成果

AI 助手完成开发需求后，会提供 **预览** 按钮。点击后，Trae 会打开 **Webview** 窗口，用于展示开发成果。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-4cec9b902acd.png)

预览过程中，若你继续与 AI 助手对话，修改需求，开发成果会在 **Webview** 窗中实时更新。

在 **Webview** 窗口的右上角，点击 **在浏览器中打开** 按钮，可在浏览器中打开窗口，预览开发成果。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-3c9c3a1b952e.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-258a095c7c2c.png)

对话框中展示本次回退会影响的文件。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-8c13e3b1dda7.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-5b35397c747d.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-9a287a816299.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-7f3db4204453.png)

- **处理单文件内的所有代码变更**：在编辑器内打开文件，点击上方提示条中的 **接受** 按钮（快捷键：macOS 为 Command + Enter；Windows 为 Ctrl + Enter）或 **拒绝** 按钮（快捷键：macOS 为 Command + Backspace；Windows 为 Ctrl + Backspace），批量接受或拒绝当前文件内的所有代码变更。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-2c5ab0936e4e.png)

- **处理单处代码变更**：点击编辑器内某个代码变更右上角的** ^Y** 按钮（快捷键：macOS 为 Control + Y；Windows 为 Alt + Y）或 **^N** 按钮（快捷键：macOS 为 Control + N；Windows 为 Alt + N），接受或拒绝该变更。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-14a04090d823.png)

此外，对于对话中生成的代码块，你可以进行以下处理：

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-631acf8be946.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-f1cb640b3fc3.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-f8be5d5a854d.png)

对话框中展示本次回退会影响的文件。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-b9784cfd4ce2.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-f737073c9405.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-771da4f3bb48.png)

### 开始问答

在内嵌对话输入框中输入你的需求，包括为代码添加注释、解释选中的代码、优化选中的代码等等，然后点击右侧的 **发送** 按钮或敲击回车键。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-91a2f2d23016.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-2ac52ffa211b.png)

### 重试对话

若 AI 助手生成的内容不符合你的要求，你可以点击对话框左下方的 **重试** 按钮，重新发起一轮同样的对话，让 AI 助手再次尝试回答。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-8c0a6263df23.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-699f740e8d41.webp)

1. (可选) 继续添加编辑器中的其他内容片段，或同时添加其他来源的上下文。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-719a00986c1f.webp)

1. 在上下文旁，输入你的问题，然后发送给 AI 助手。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-2c59e1d68eba.webp)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-e89a8f673e23.webp)

1. (可选) 继续添加终端中的其他内容片段，或同时添加其他来源的上下文。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-7a8d1b88456f.webp)

1. 在上下文旁，输入你的问题，然后发送给 AI 助手。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-5216acfabbdb.webp)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-3631fec05cb5.webp)

1. 在列表中选择 **Code**（或在 **#** 符号后手动输入 **Code**），然后按下回车键。

列表将展示编辑器中当前打开的文件中存在的函数和类。将鼠标悬浮在列表中的某个条目后，左侧会展示该函数或类的代码内容，供你预览。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-2f1be047677e.webp)

1. 若推荐的函数和类非你所需，在 **#Code:** 后输入你想要的函数或类的名称或关键词。

AI 助手将在项目内搜索相关函数和类，并展示在列表中，你可以进行预览。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-05009f681139.webp)

1. 从列表中选择需指定为上下文的函数或类。
2. 在输入框的代码标识后，输入你的问题并发送。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-80312486f8ac.webp)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-b1e3f7a8d768.webp)

1. 在列表中选择 **File**（或在 **#** 符号后手动输入 **File**），然后按下回车键。

列表展示近期在编辑器中打开过的文件。将鼠标悬浮在列表中的某个条目后，左侧会展示该文件所在的目录。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-643c3e16a12c.webp)

1. 若推荐的文件非你所需，在 **#File:** 后输入你想要的文件的名称或关键词。

AI 助手将在项目内搜索相关文件并展示在列表中。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-e45d3fd4e180.webp)

1. 从列表中选择需指定为上下文的文件。
2. 在输入框的文件标识后，输入你的问题并发送。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-a85f8f9dcb36.webp)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-ca27d337374c.webp)

1. 在列表中选择 **Folder**（或在 **#** 符号后手动输入 **Folder**），然后按下回车键。

列表展示与编辑器中当前所打开文件相关的文件夹。将鼠标悬浮在列表中的某个条目后，左侧会展示该文件夹所在的目录。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-8d1c56614589.webp)

1. 若推荐的文件夹非你所需，在 **#Folder:** 后输入你想要的文件夹的名称或关键词。

AI 助手将在项目内搜索相关文件夹并展示在列表中。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-ed6e58b1a7f5.webp)

1. 从列表中选择需指定为上下文的文件夹。
2. 在输入框的文件夹标识后，输入你的问题并发送。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-22585f1555dd.webp)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-1be5d97616c9.webp)

1. 在列表中选择 **Workspace**（或在 **#** 符号后手动输入 **Workspace**）。
2. 在输入框的 Workspace 标识后，输入你的问题并发送。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-11fca2338db1.webp)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-91b71795e0ff.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-6034bb9eb778.gif)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-03e0148badda.gif)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-ecc90310af26.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-0dec31b1a10f.png)

Trae 打开 **设置** 窗口，默认展示 **通用** 设置部分。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-5bd443ef0c23.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-f33144ebbc97.png)

- 在 **快捷键设置** 处，点击 **去设置** 按钮，然后在 **键盘快捷键** 窗口中修改快捷键相关设置。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-33b369b8e88d.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-cf586df68fb1.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-7ede4f915e77.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-1c02f81e463f.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-4cd9a6fe8a81.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-2788ebe071ce.png)

停止索引
若代码索引构建过程中出现了异常情况，你期望停止构建，则可以点击 **取消构建 **按钮，本地索引构建将被暂停。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-2636b6595833.png)

重新构建
若你期望重启构建，则可以点击 **重新构建 **按钮，继续上一次的构建。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-37437c6f1003.png)

删除索引
若你期望清空代码索引，则可以点击 **清空** 按钮。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-b58a8050d12a.png)
...
![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-f3d6c58bd882.png)

1. 在列表中，右击某一快捷键条目。

界面上显示快捷菜单。

![image](/面试题/AI大模型/1473-thnro65tussqiu38/img-d74e6b45aac6.png)
