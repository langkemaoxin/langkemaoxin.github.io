...
sidebarGroup: "Java基础"
shortTitle: "final，finally，finalize的区别"
order: 171
date: 2026-03-22
category: "面试题"
tag:
  - "面试题"
description: "在Java中，final、finally和finalize是三个不同的关键字，它们具有不同的作用和用法。final：final是一个修饰符，可以用于修饰类、方法和变量。用于修饰类时，表示该类不能被继承，即为最终类。用于修饰方法时，表示该方法"
article: false
---

> 来源：[final，finally，finalize的区别](https://www.yuque.com/tulingzhouyu/db22bv/cuwys8d1r3gki8dv)
