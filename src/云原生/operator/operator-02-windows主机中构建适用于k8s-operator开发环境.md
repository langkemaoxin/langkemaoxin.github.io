...
![image-20230215173826410](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230215173826410.png)

![image-20230215173911784](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230215173911784.png)

## 1.2 开启wsl功能

![image-20230220150450428](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230220150450428.png)

![image-20230220150757090](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230220150757090.png)

![image-20230220150834508](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230220150834508.png)

![image-20230220150923625](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230220150923625.png)
...
![image-20230209123449122](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230209123449122.png)

> 如果不想设置用户名和密码，可以选择使用ctrl+c结束后直接使用管理员用户使用。

~~~powershell
如果想安装Ubuntu-22.04，按下面的方式安装即可。
...
![image-20230209125349452](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230209125349452.png)

![image-20230209125507021](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230209125507021.png)

![image-20230209125525292](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230209125525292.png)

![image-20230209125743173](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230209125743173.png)

![image-20230209125801051](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230209125801051.png)

![image-20230209130122596](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230209130122596.png)

![image-20230209130720345](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230209130720345.png)

![image-20230209130347134](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230209130347134.png)

![image-20230209130456373](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230209130456373.png)

![image-20230209130533116](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230209130533116.png)

![image-20230209130614947](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230209130614947.png)
...
![image-20230215152017737](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230215152017737.png)
...
![image-20230215152444486](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230215152444486.png)

![image-20230215152733439](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230215152733439.png)

![image-20230215152841847](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230215152841847.png)

![image-20230215152919540](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230215152919540.png)

![image-20230215152951098](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230215152951098.png)
...
![img](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/562987-20220114201905023-573450383.png)
...
![image-20230213155110943](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230213155110943.png)
...
![image-20230215155056983](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230215155056983.png)

![image-20230215155117780](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230215155117780.png)

> 回车后生成文件

![image-20230215155304945](/云原生/operator/operator-02-windows主机中构建适用于k8s-operator开发环境/image-20230215155304945.png)
