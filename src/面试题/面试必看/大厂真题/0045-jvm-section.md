...
tag:
  - "面试题"
description: "JVM内存划分1、JVM运行时数据区域堆、方法区（元空间）、虚拟机栈、本地方法栈、程序计数器。Heap(堆)：对象的实例以及数组的内存都是要在堆上进行分配的，堆是线程共享的一块区域，用来存放对象实例，也是垃圾回收（GC）的主要区域；开启逃逸"
article: false
---

> 来源：[JVM篇](https://www.yuque.com/tulingzhouyu/db22bv/gu4keuyemo2sfi71)
...
![image](/面试题/面试必看/大厂真题/0045-jvm-section/img-25e57cdb7968.png)
...
![image](/面试题/面试必看/大厂真题/0045-jvm-section/img-13c5470f5fc3.png)
...
![image](/面试题/面试必看/大厂真题/0045-jvm-section/img-7aede7f0b0ec.png)
...
![image](/面试题/面试必看/大厂真题/0045-jvm-section/img-1be0b5f0c2ad.png)
...
![image](/面试题/面试必看/大厂真题/0045-jvm-section/img-ce419692389b.png)
...
![image](/面试题/面试必看/大厂真题/0045-jvm-section/img-1f7553c3a62a.png)
...
![image](/面试题/面试必看/大厂真题/0045-jvm-section/img-33ae0e4cb292.png)
...
![image](/面试题/面试必看/大厂真题/0045-jvm-section/img-3b0d5c4cf84c.png)
