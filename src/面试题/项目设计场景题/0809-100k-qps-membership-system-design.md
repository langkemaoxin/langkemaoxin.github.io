---
title: "10W QPS 的会员系统，如何设计"
sidebarGroup: "项目设计场景题"
shortTitle: "10W QPS 的会员系统，如何设计"
order: 809
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "会员系统是一种基础系统，跟公司所有业务线的下单主流程密切相关。如果会员系统出故障，会导致用户无法下单，影响范围是全公司所有业务线。所以，会员系统必须保证高性能、高可用，提供稳定、高效的基础服务。随着同程和艺龙两家公司的合并，越来越多的系统需"
article: false
---

> 来源：[10W QPS 的会员系统，如何设计](https://www.yuque.com/tulingzhouyu/db22bv/bzhxgkvpz1ieknkc)
...
![image](/面试题/项目设计场景题/0809-100k-qps-membership-system-design/img-4ba4681b1a0a.png)
...
![image](/面试题/项目设计场景题/0809-100k-qps-membership-system-design/img-e4b4839a80e6.png)
...
![image](/面试题/项目设计场景题/0809-100k-qps-membership-system-design/img-23a4c0264ecc.png)
...
![image](/面试题/项目设计场景题/0809-100k-qps-membership-system-design/img-86af65530934.png)

会员系统的接口耗时：

![image](/面试题/项目设计场景题/0809-100k-qps-membership-system-design/img-c736fcf2f999.png)
...
![image](/面试题/项目设计场景题/0809-100k-qps-membership-system-design/img-80b65ecc8367.png)
...
![image](/面试题/项目设计场景题/0809-100k-qps-membership-system-design/img-0ea49746c282.png)
...
![image](/面试题/项目设计场景题/0809-100k-qps-membership-system-design/img-1d62f8e77f60.png)
...
![image](/面试题/项目设计场景题/0809-100k-qps-membership-system-design/img-fb7b2d29fcfb.png)
...
![image](/面试题/项目设计场景题/0809-100k-qps-membership-system-design/img-cd14bca1a84b.png)
...
![image](/面试题/项目设计场景题/0809-100k-qps-membership-system-design/img-b96530ef1c02.png)
...
![image](/面试题/项目设计场景题/0809-100k-qps-membership-system-design/img-8e5dc07da2a1.png)
...
![image](/面试题/项目设计场景题/0809-100k-qps-membership-system-design/img-258a464d6d15.png)

所以，整体的实施流程如下：

![image](/面试题/项目设计场景题/0809-100k-qps-membership-system-design/img-d860aa3cb630.png)
...
![image](/面试题/项目设计场景题/0809-100k-qps-membership-system-design/img-cfa5496af445.png)

如果 dal 组件故障或 MySQL 数据库挂了，可以把读写切到 ES，等 MySQL 恢复了，再把数据同步到 MySQL，最后把读写再切回到 MySQL 数据库。

如下图所示：

![image](/面试题/项目设计场景题/0809-100k-qps-membership-system-design/img-45fa019c0fd0.png)
...
![image](/面试题/项目设计场景题/0809-100k-qps-membership-system-design/img-0b583bb3af18.png)
...
![image](/面试题/项目设计场景题/0809-100k-qps-membership-system-design/img-c374c4e30a69.png)
