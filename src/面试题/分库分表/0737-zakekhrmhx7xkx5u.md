---
title: "ShardingSphere如何保证分布式事务一致性？"
sidebarGroup: "分库分表"
shortTitle: "ShardingSphere如何保证分布式事务一致性？"
order: 737
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "ShardingSphere 保证分布式事务一致性的方式主要有两种：XA事务和柔性事务。XA事务通过在准备阶段和提交阶段进行两阶段锁，来保证分布式事务的一致性。在准备阶段，ShardingSphere 会对所有的数据库节点进行锁定，保证在事"
article: false
---

> 来源：[ShardingSphere如何保证分布式事务一致性？](https://www.yuque.com/tulingzhouyu/db22bv/zakekhrmhx7xkx5u)
