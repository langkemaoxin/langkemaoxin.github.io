---
title: "说下Spring AOP底层原理"
sidebarGroup: "大厂真题"
shortTitle: "说下Spring AOP底层原理"
order: 49
date: 2026-06-07
category: "面试题"
tag:
  - "面试题"
description: "Spring AOP全称是面向切面编程，是Spring框架的一个重要特性，它通过在运行时动态地将额外的行为（如日志记录、事务管理等）织入到应用程序的特定方法或代码块中。底层原理主要基于动态代理和字节码操作来实现。对于动态代理Spring A"
article: false
---

> 来源：[说下Spring AOP底层原理](https://www.yuque.com/tulingzhouyu/db22bv/ktxx6egnrskqmooq)
