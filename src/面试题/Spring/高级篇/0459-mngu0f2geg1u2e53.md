---
title: "Spring-Ioc容器的加载过程"
sidebarGroup: "高级篇"
shortTitle: "Spring-Ioc容器的加载过程"
order: 459
date: 2026-06-13
category: "面试题"
tag:
  - "面试题"
description: "Spring 的 IOC 容器工作的过程，其实可以划分为两个阶段：配置解析阶段和Bean 的创建段。其中配置解析阶段主要做的工作是加载和解析配置文件，将配置的bean解析成 BeanDefinition。整个过程是： 读取配置：通过Bean"
article: false
---

> 来源：[Spring-Ioc容器的加载过程](https://www.yuque.com/tulingzhouyu/db22bv/mngu0f2geg1u2e53)
