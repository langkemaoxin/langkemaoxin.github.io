---
title: "什么是领域驱动设计中的 CQRS 模式？"
sidebarGroup: "DDD架构"
shortTitle: "什么是领域驱动设计中的 CQRS 模式？"
order: 761
date: 2026-04-18
category: "面试题"
tag:
  - "面试题"
description: "领域驱动设计（DDD）中的CQRS模式是一种架构模式，它将系统中的操作分为两类：命令（Command）与查询（Query）。CQRS 模式强调了应用程序要将命令和查询愤慨处理。命令是对会引起数据发生变化的操作的总称，如新增、更新、删除等操作"
article: false
---

> 来源：[什么是领域驱动设计中的 CQRS 模式？](https://www.yuque.com/tulingzhouyu/db22bv/qbpaiq7m9eybl51b)
