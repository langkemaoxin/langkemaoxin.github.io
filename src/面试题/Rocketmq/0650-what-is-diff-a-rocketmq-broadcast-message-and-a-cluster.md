---
title: "RocketMQ 的广播消息和集群消息有什么区别？"
sidebarGroup: "Rocketmq"
shortTitle: "RocketMQ 的广播消息和集群消息有什么区别？"
order: 650
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "广播消息和集群消息是 RocketMQ 的两种不同的消息消费模式。其中广播模式意味着一条消息会被发送到所有订阅了这个主题 Topic 的消费者，而所有消费者都会收到相同的消息副本。集群模式意味着一条消息只会分发给订阅了这个主题 Topic "
article: false
---

> 来源：[RocketMQ 的广播消息和集群消息有什么区别？](https://www.yuque.com/tulingzhouyu/db22bv/kaotnpk87d1nv74n)
