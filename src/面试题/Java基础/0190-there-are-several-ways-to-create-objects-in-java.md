...
sidebarGroup: "Java基础"
shortTitle: "Java 创建对象有几种方式"
order: 190
date: 2026-06-03
category: "面试题"
tag:
  - "面试题"
description: "在Java中，有以下几种常见的方式来创建对象：使用new关键字：这是最常见的创建对象的方式。通过调用类的构造函数，使用new关键字可以在内存中分配一个新的对象。使用反射：Java的反射机制允许在运行时动态地创建对象。通过获取类的Class对"
article: false
---

> 来源：[Java 创建对象有几种方式](https://www.yuque.com/tulingzhouyu/db22bv/to9l38c4s92yehkd)
