---
title: "加密后的数据该如何支持模糊查询"
sidebarGroup: "Mysql"
shortTitle: "加密后的数据该如何支持模糊查询"
order: 354
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "在日常工作中，我们经常会有一些模糊查询的条件，比如说按照手机号模糊查询，或者是身份证号码。正常情况下我们可以使用select * from user where mobile like %123%来模糊查询，但是这种方式是在你的手机号码没有"
article: false
---

> 来源：[加密后的数据该如何支持模糊查询](https://www.yuque.com/tulingzhouyu/db22bv/xgl9a1fah7cppdil)
...
![image](/面试题/Mysql/0354-how-can-encrypted-data-support-fuzzy-queries/img-7d13a8a8969b.png)
...
![image](/面试题/Mysql/0354-how-can-encrypted-data-support-fuzzy-queries/img-041b23800399.png)
