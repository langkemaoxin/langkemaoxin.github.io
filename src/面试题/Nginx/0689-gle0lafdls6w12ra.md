---
title: "NGINX的事件驱动模型是什么？为什么这种模型对性能有益？"
sidebarGroup: "Nginx"
shortTitle: "NGINX的事件驱动模型是什么？为什么这种模型对性能有益？"
order: 689
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "NGINX使用一种称为\"事件驱动\"或\"事件驱动非阻塞\"模型的架构来处理客户端请求和服务器操作。这个模型在高并发环境下对性能非常有益，因为它可以在单个线程中有效地处理大量的并发连接，而无需为每个连接创建一个新的线程或进程。NGINX的事件驱动"
article: false
---

> 来源：[NGINX的事件驱动模型是什么？为什么这种模型对性能有益？](https://www.yuque.com/tulingzhouyu/db22bv/gle0lafdls6w12ra)
