...
shortTitle: "携程亿级高并发架构改造实践"
order: 828
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "本次分享内容业务背景描述存储重构(SQLServer 转到 MySQL、核心和非核心隔离、消息替代轮询)架构升级(系统合并、前后端分离)总结一、前言本次分享将介绍在业务持续发展环境中，复杂系统的改造过程以及实施的一些经验，希望能给面对同样问"
article: false
---

> 来源：[携程亿级高并发架构改造实践](https://www.yuque.com/tulingzhouyu/db22bv/mf3m6dug2ombuyqe)
...
![image](/面试题/项目设计场景题/0828-ctrip-billion-scale-high-concurrency-refactor/img-112c3a81231c.png)
...
![image](/面试题/项目设计场景题/0828-ctrip-billion-scale-high-concurrency-refactor/img-cc04d32bab49.png)

复制分发改造前

初期，梳理出所有依赖的系统以及相关 SQL 语句，涉及到几乎所有度假子系统，针对各个系统对于原始数据的需求与转 MySQL 的过程同步进行，迁移数据并提供替代直接访问 DB 的 API，下游系统接入 API 切换数据源。改造后的依赖如下图。

![image](/面试题/项目设计场景题/0828-ctrip-billion-scale-high-concurrency-refactor/img-b54919d290ab.png)
...
![image](/面试题/项目设计场景题/0828-ctrip-billion-scale-high-concurrency-refactor/img-d00c1a5c1bf2.png)
...
> *DR （Disaster Recovery ）灾备，是一种关键的业务连续性计划（BCP）策略，用于确保在发生意外情况（如硬件故障、网络攻击、自然灾害等）时，关键业务数据和系统能够迅速恢复。通过对核心数据和非核心数据进行隔离，企业可以更有效地管理资源，优先保护最关键的资产，并根据不同数据的价值和重要性，制定差异化的备份和灾难恢复策略。这种方法不仅提高恢复效率，还能在成本控制方面实现优化。*
...
![image](/面试题/项目设计场景题/0828-ctrip-billion-scale-high-concurrency-refactor/img-08f7dce4321a.png)
...
![image](/面试题/项目设计场景题/0828-ctrip-billion-scale-high-concurrency-refactor/img-94b6eb4bb7cc.jpg)
...
![image](/面试题/项目设计场景题/0828-ctrip-billion-scale-high-concurrency-refactor/img-31884da84c59.png)

系统合并前后对比

## **3.1 系统合并**

![image](/面试题/项目设计场景题/0828-ctrip-billion-scale-high-concurrency-refactor/img-2127d1394eac.png)
...
![image](/面试题/项目设计场景题/0828-ctrip-billion-scale-high-concurrency-refactor/img-46849332b912.png)
...
![image](/面试题/项目设计场景题/0828-ctrip-billion-scale-high-concurrency-refactor/img-65772507dadf.png)
