...
![image](/面试题/AI大模型/1477-pgswxy26zlgb4eq9/img-17e29fac1324.png)
...
![image](/面试题/AI大模型/1477-pgswxy26zlgb4eq9/img-b85b60ddde78.png)

🌈** 步骤二：回到ollama的官网，搜索框里搜索deepseek-r1，选择要安装的模型**

![image](/面试题/AI大模型/1477-pgswxy26zlgb4eq9/img-6675107e68da.png)

点击下拉框，可以看到多个版本，区别是参数不一样，数字越大，代表参数越多，性能就越强，但也对计算机的性能要求较高。

![image](/面试题/AI大模型/1477-pgswxy26zlgb4eq9/img-0985c26ba5a4.png)

模型版本怎么选？电脑配置不行的，建议选择1.5B版本，这个模型有15亿参数，属于最轻量的Deepseek版本，电脑配置好点的，可以选择7b以上的。

**🌈 步骤三：复制右边的这串代码“ollama run deepseek-r1:1.5b”**

![image](/面试题/AI大模型/1477-pgswxy26zlgb4eq9/img-b094e7c4e210.png)

**🌈 步骤四：安装模型**

按下键盘上的win+R，调出运行窗口，输入cmd回车，调出命令行窗口。

![image](/面试题/AI大模型/1477-pgswxy26zlgb4eq9/img-b1e43f6006ec.png)

**把复制的代码“ollama run deepseek-r1:1.5b”粘贴到命令行中，再点击回车，如下图所示。**

![image](/面试题/AI大模型/1477-pgswxy26zlgb4eq9/img-bba1125fd7c4.png)

按回车键之后，就会开始安装，会有百分比的进度条，如下图所示

![image](/面试题/AI大模型/1477-pgswxy26zlgb4eq9/img-46a73dad25fb.png)

跑到了100%之后，就代表安装完成了，就可以和他对话了。

![image](/面试题/AI大模型/1477-pgswxy26zlgb4eq9/img-b579cdc49498.png)
...
![image](/面试题/AI大模型/1477-pgswxy26zlgb4eq9/img-2c50c9515e02.png)
...
![image](/面试题/AI大模型/1477-pgswxy26zlgb4eq9/img-71b784d016e4.png)

点击右下角的设置，设置好模型，选择Ollama API，最后选择已经安装好的模型就可以了。

![image](/面试题/AI大模型/1477-pgswxy26zlgb4eq9/img-0d944737e0ad.png)
