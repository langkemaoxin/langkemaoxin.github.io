...
shortTitle: "如何设计一个秒杀系统"
order: 795
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "前言：说起秒杀，我想你肯定不陌生，近些年，从双十一购物到春节抢红包，再到 12306 抢火车票，“秒杀”的场景处处可见。简单来说，秒杀就是在同一个时刻有大量的请求争抢购买同一个商品并完成交易的过程，用技术的行话来说就是大量的并发读和并发写。"
article: false
---

> 来源：[如何设计一个秒杀系统](https://www.yuque.com/tulingzhouyu/db22bv/zmh8bxm30a2a81p2)
...
![image](/面试题/项目设计场景题/0795-flash-sale-system-design/img-6a8811a70117.png)

通常分布式系统结构图如下：

![image](/面试题/项目设计场景题/0795-flash-sale-system-design/img-4885f7a2ad41.png)

总的思路可以按照业务流程 每个环节 ，从 拦截 和 分摊来考虑。如上图中可以
...
用户请求的页面返回后，浏览器渲染这个页面还要包含其他的额外请求，比如说，这个页面依赖的 CSS/JavaScript、图片，以及 Ajax 请求等等都定义为“额外请求”，这些额外请求应该尽量少。因为浏览器每发出一个请求都多少会有一些消耗。
...
![image](/面试题/项目设计场景题/0795-flash-sale-system-design/img-007a2784ad99.png)
...
![image](/面试题/项目设计场景题/0795-flash-sale-system-design/img-b796d6ccd126.png)
...
![image](/面试题/项目设计场景题/0795-flash-sale-system-design/img-abaf62fc77d4.png)
...
![image](/面试题/项目设计场景题/0795-flash-sale-system-design/img-037d2b3c6ed0.jpg)
...
![image](/面试题/项目设计场景题/0795-flash-sale-system-design/img-7a574e430031.jpg)
...
![image](/面试题/项目设计场景题/0795-flash-sale-system-design/img-39613d0a0c2b.png)

这三种动静分离方案各有优缺点，一般选择哪种取决于具体的应用场景和需求，以下是详细介绍：
...
![image](/面试题/项目设计场景题/0795-flash-sale-system-design/img-7711a3a5edca.png)
...
![image](/面试题/项目设计场景题/0795-flash-sale-system-design/img-0390f1a50376.png)
...
**第一个目的**是防止部分买家使用秒杀器在参加秒杀时作弊。2011 年秒杀非常火的时候，秒杀器也比较猖獗，因而没有达到全民参与和营销的目的，所以系统增加了答题来限制秒杀器。增加答题后，下单的时间基本控制在 2s 后，秒杀器的下单比例也大大下降。答题页面如下图所示。

![image](/面试题/项目设计场景题/0795-flash-sale-system-design/img-ddc3f3a269fb.png)
...
![image](/面试题/项目设计场景题/0795-flash-sale-system-design/img-29ef4f10abf4.png)
...
![image](/面试题/项目设计场景题/0795-flash-sale-system-design/img-e7a1f078ce30.png)
...
![image](/面试题/项目设计场景题/0795-flash-sale-system-design/img-07c28210e801.png)
...
最后我们总结一波在高并发场景下，如果业务复杂导致请求积压过多，可以采取以下几种策略来优化系统性能，确保请求能够被及时处理：
