---
title: "什么是Docker Swarm？请简述其作用和使用场景"
sidebarGroup: "Docker与K8S"
shortTitle: "什么是Docker Swarm？请简述其作用和使用场景"
order: 1373
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "Docker Swarm是Docker公司推出的用于管理Docker集群的工具，可以将多个Docker节点组织成一个单一的虚拟主机，实现对Docker资源的统一管理和调度。Docker Swarm的作用主要有以下几点：集群管理：Docker"
article: false
---

> 来源：[什么是Docker Swarm？请简述其作用和使用场景](https://www.yuque.com/tulingzhouyu/db22bv/bens87u0rux44l4t)
