---
title: "SpringBoot为什么要禁止循环依赖"
sidebarGroup: "SpringBoot"
shortTitle: "SpringBoot为什么要禁止循环依赖"
order: 463
date: 2026-06-10
category: "面试题"
tag:
  - "面试题"
description: "循环依赖大家都知道，也被折磨过，在 SpringBoot2.6.0的版本默认禁止了循环依赖，如果程序中出现循环依赖就会报错。当然并没有一锤子打死，也提供了开启允许循环依赖的配置，只需要在配置文件中开启即可：spring: main: all"
article: false
---

> 来源：[SpringBoot为什么要禁止循环依赖](https://www.yuque.com/tulingzhouyu/db22bv/fab361bxoeyy7vvg)
