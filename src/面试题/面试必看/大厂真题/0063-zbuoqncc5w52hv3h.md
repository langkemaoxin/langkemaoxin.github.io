---
title: "MySQL 索引底层结构为什么使用 B+树"
sidebarGroup: "大厂真题"
shortTitle: "MySQL 索引底层结构为什么使用 B+树"
order: 63
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "MySQL索引底层结构使用B+树的主要原因有以下几点：能够支持快速的查找：B+树是一种平衡多路查找树，树的高度相对较低，能够快速定位到目标数据。在具有大量数据的情况下，B+树的查找效率更高。有序性：B+树的特点是节点上的键值是有序排列的，这"
article: false
---

> 来源：[MySQL 索引底层结构为什么使用 B+树](https://www.yuque.com/tulingzhouyu/db22bv/zbuoqncc5w52hv3h)
