---
title: "Spring Boot 实现OCR图片文字识别"
sidebarGroup: "综合篇"
shortTitle: "Spring Boot 实现OCR图片文字识别"
order: 155
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "1、前言之前在某一个项目中，客户要求根据上传的文档图片系统自动识别图片内容，这就需要到了OCR技术，我们公司一般做法通常是使用阿里云或腾讯云的OCR图片识别（大厂的训练量更多更大，识别更精准）无奈客户资金有限，又希望我们满足需求，最后我们决"
article: false
---

> 来源：[Spring Boot 实现OCR图片文字识别](https://www.yuque.com/tulingzhouyu/db22bv/yog2483rordgfvtl)
...
![image](/面试题/综合篇/0155-spring-boot-implements-ocr-image-text-recognition/img-2ed614df2c05.png)
...
> 
![image](/面试题/综合篇/0155-spring-boot-implements-ocr-image-text-recognition/img-850bf96e22fc.png)

![image](/面试题/综合篇/0155-spring-boot-implements-ocr-image-text-recognition/img-e22bfcdebcb1.png)

> 使用Apifox或Postman进行调试，这里使用Postman测试效果如下：
> 
![image](/面试题/综合篇/0155-spring-boot-implements-ocr-image-text-recognition/img-1d0fcdbb3351.png)
