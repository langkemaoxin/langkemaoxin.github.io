---
title: "MySQL多表查询时有哪些连接方式"
sidebarGroup: "Mysql"
shortTitle: "MySQL多表查询时有哪些连接方式"
order: 387
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "当进行多表查询时，在 MySQL 中常用的连接方式有以下几种：内连接（INNER JOIN）：返回同时满足连接条件的行。它通过比较连接列的值，将两个或多个表中匹配的行组合在一起。左外连接（LEFT JOIN）：返回左表中的所有行，以及与左表"
article: false
---

> 来源：[MySQL多表查询时有哪些连接方式](https://www.yuque.com/tulingzhouyu/db22bv/udp8geadisobv5wd)
