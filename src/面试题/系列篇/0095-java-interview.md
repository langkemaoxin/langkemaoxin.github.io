...
![image](/面试题/系列篇/0095-java-interview/img-1aee14de77c9.png)
...
![image](/面试题/系列篇/0095-java-interview/img-6a4649f3dfdf.png)

以下API，只能拿到泛型的个数，不能拿到具体的泛型类型

![image](/面试题/系列篇/0095-java-interview/img-153575ceaffd.png)

通过放射可以往List添加不同类型的元素，因为类型其实被擦除了，变成了Object

![image](/面试题/系列篇/0095-java-interview/img-fc2e7d62fda0.png)

泛型虽然被擦除了，但是具体的泛型信息还是被保存在了字节码中

![image](/面试题/系列篇/0095-java-interview/img-21c897f75a26.png)

所以还是有一些方式可以很方便的获取到泛型的真实类型的

![image](/面试题/系列篇/0095-java-interview/img-ea93c579cd80.png)

![image](/面试题/系列篇/0095-java-interview/img-b1a39e68df1d.png)

![image](/面试题/系列篇/0095-java-interview/img-21c4e17a1124.png)

另外，对于JVM，如果对每个泛型类型都生成不同的目标代码，假如现在有10个不同泛型的List，就要生成10份字节码，这样会造成不仅造成代码膨胀，而且一份字节码对应一个Class对象，占据大量的内存。

## Java中有哪些类加载器

![image](/面试题/系列篇/0095-java-interview/img-998db443f2ad.png)
...
![image](/面试题/系列篇/0095-java-interview/img-f744554585f4.png)
...
![image](/面试题/系列篇/0095-java-interview/img-c843dec32d91.png)
...
![image](/面试题/系列篇/0095-java-interview/img-4986372e1380.png)

 

![image](/面试题/系列篇/0095-java-interview/img-c7986dafa5a8.png)
...
![image](/面试题/系列篇/0095-java-interview/img-68e967d5c544.png)
...
![image](/面试题/系列篇/0095-java-interview/img-e7669a0a98ab.png)
...
![image](/面试题/系列篇/0095-java-interview/img-636f9ef6ee37.png)

## Spring用到了哪些设计模式

![image](/面试题/系列篇/0095-java-interview/img-28bbdaa54758.png)
...
![image](/面试题/系列篇/0095-java-interview/img-482273bdeb14.png)

a字段是主键，对应主键索引，bcd三个字段组成一个联合索引，e字段一个索引

### 1. 不符合最左匹配原则

![image](/面试题/系列篇/0095-java-interview/img-69f17d142a66.png)

去掉b=1的条件就不符合最左匹配原则了，导致所有失效

![image](/面试题/系列篇/0095-java-interview/img-81fda71e1c52.png)

### 2. 不正确的Like查询

不用like能走索引：

![image](/面试题/系列篇/0095-java-interview/img-09a303f6382b.png)

正常使用like：

![image](/面试题/系列篇/0095-java-interview/img-5e7dd39e0898.png)

不正确使用like：

![image](/面试题/系列篇/0095-java-interview/img-fcc30dcf674a.png)

### 3. 对索引列进行了计算或使用了函数

![image](/面试题/系列篇/0095-java-interview/img-d71b3ae53100.png)

![image](/面试题/系列篇/0095-java-interview/img-7c7d47de95f1.png)

### 4. 索引列进行了类型转换

e字段的类型是vachar，下面这个sql需要把e字段中的字符转换成数字，会导致索引失效

![image](/面试题/系列篇/0095-java-interview/img-8b2725481215.png)

### 5. <>不等于导致索引失效

b=1可以走索引，b<>1就不能走索引

![image](/面试题/系列篇/0095-java-interview/img-038dea75ee08.png)

### 6. order by导致索引失效

就算利用索引，但是由于是select * 所以需要回表，而且回表成本比较高，所以不会走索引。

![image](/面试题/系列篇/0095-java-interview/img-eecde4dbd977.png)

如果是select b就需要回表了，就会选择走索引

![image](/面试题/系列篇/0095-java-interview/img-eec55da6b228.png)

### 7. 使用or导致索引失效

![image](/面试题/系列篇/0095-java-interview/img-5d1908501150.png)

### 8. select * 导致索引失效

![image](/面试题/系列篇/0095-java-interview/img-f9e66b466b6e.png)
...
![image](/面试题/系列篇/0095-java-interview/img-8310c6148773.png)
...
![image](/面试题/系列篇/0095-java-interview/img-e4413d17ceae.png)
...
![image](/面试题/系列篇/0095-java-interview/img-9bb64e87b26c.png)
...
![image](/面试题/系列篇/0095-java-interview/img-d2e3e9d7b14e.png)
...
![image](/面试题/系列篇/0095-java-interview/img-e8c90bc9d70c.png)
...
![image](/面试题/系列篇/0095-java-interview/img-c645f14108bc.png)
...
![image](/面试题/系列篇/0095-java-interview/img-b6985e3d4e1d.png)
...
![image](/面试题/系列篇/0095-java-interview/img-365d06f3795f.jpg)
...
![image](/面试题/系列篇/0095-java-interview/img-a52b92f2267f.png)
...
![image](/面试题/系列篇/0095-java-interview/img-eb95f5398635.png)
...
![image](/面试题/系列篇/0095-java-interview/img-f5a51294f032.gif)

 

![image](/面试题/系列篇/0095-java-interview/img-aec804965394.gif)
...
![image](/面试题/系列篇/0095-java-interview/img-29dcba2e4740.jpg)
...
![image](/面试题/系列篇/0095-java-interview/img-08ea69cdcd3b.jpg)
...
![image](/面试题/系列篇/0095-java-interview/img-43099d292a65.jpg)
...
![image](/面试题/系列篇/0095-java-interview/img-9a2404620d3a.png)
