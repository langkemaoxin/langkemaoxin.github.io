---
title: "MVCC 是什么？它的底层原理是什么"
sidebarGroup: "大厂真题"
shortTitle: "MVCC 是什么？它的底层原理是什么"
order: 64
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "MVCC（Multi-Version Concurrency Control），即多版本并发控制，是一种数据库的并发控制机制。它的目标是在保证数据一致性和隔离性的同时，提供更好的并发性能。MVCC的底层原理如下：每一行数据都有多个版本：在M"
article: false
---

> 来源：[MVCC 是什么？它的底层原理是什么](https://www.yuque.com/tulingzhouyu/db22bv/imvzgquf4f1ggyor)
