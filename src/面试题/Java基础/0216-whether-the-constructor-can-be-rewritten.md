...
title: "构造器是否可被重写"
sidebarGroup: "Java基础"
shortTitle: "构造器是否可被重写"
order: 216
date: 2026-07-12
category: "面试题"
tag:
  - "面试题"
description: "构造器在Java中是一种特殊的方法，用于创建和初始化对象。与其他普通方法不同，构造器的名称必须与类名一致，并且没有返回类型。在Java中，构造器不能被直接重写。子类无法定义与父类相同名称和参数的构造器。这是因为构造器是用于创建对象并初始化其"
article: false
---

> 来源：[构造器是否可被重写](https://www.yuque.com/tulingzhouyu/db22bv/hgs3wvvp6gg7uzwd)
