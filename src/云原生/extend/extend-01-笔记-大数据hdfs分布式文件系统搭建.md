---
title: 【笔记】大数据HDFS分布式文件系统搭建
sidebarGroup: 扩展专题
shortTitle: 01 【笔记】大数据HDFS分布式文件系统搭建
order: 1
...
tag:
  ...
  - 云原生
  - 课程笔记
description: 1.1 大数据HDFS分布式文件系统搭建 这里我们使用5台节点来安装分布式文件系统，每台节点给了4G内存，4个core，并且每台节点已经关闭防火墙、配置主机名、设置yum源、各个节点时间同步、各个节点...
---
