---
title: "BIO、NIO、AIO有什么区别"
sidebarGroup: "Java基础"
shortTitle: "BIO、NIO、AIO有什么区别"
order: 177
date: 2026-07-11
category: "面试题"
tag:
  - "面试题"
description: "他们三者都是Java中常用的I/O模型，我们从以下三个维度进行对比：阻塞与非阻塞：BIO是阻塞式I/O模型，线程会一直被阻塞等待操作完成。NIO是非阻塞式I/O模型，线程可以去做其他任务，当I/O操作完成时得到通知。AIO也是非阻塞式I/O"
article: false
---

> 来源：[BIO、NIO、AIO有什么区别](https://www.yuque.com/tulingzhouyu/db22bv/dpxl834qsx20hfn3)
