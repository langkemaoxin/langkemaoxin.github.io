...
![image-20220922173954226](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20220922173954226.png)

![image-20220922174311230](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20220922174311230.png)

![image-20220922174332481](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20220922174332481.png)

![image-20220922174429882](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20220922174429882.png)

![image-20220922175512664](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20220922175512664.png)

![image-20220922175634327](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20220922175634327.png)

![image-20220922175533321](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20220922175533321.png)

![image-20220922175658657](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20220922175658657.png)

![image-20220922175600095](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20220922175600095.png)
...
![image-20220922185507731](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20220922185507731.png)

![image-20220922185532487](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20220922185532487.png)

![image-20230227154833118](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227154833118.png)
...
![image-20230227155554904](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227155554904.png)

![image-20230227155814484](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227155814484.png)

完成后，点击**确定**。新创建的用户将显示在**用户**页面。

![image-20230227155836285](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227155836285.png)
...
![image-20230227160333677](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227160333677.png)

![image-20230227160439550](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227160439550.png)

![image-20230227160544176](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227160544176.png)

![image-20230227160701077](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227160701077.png)
...
![image-20230227160729237](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227160729237.png)
...
![image-20230227161057131](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227161057131.png)

2.在企业空间列表页面，点击**创建**，输入企业空间的名称（例如 **yanxuan-workspace**），并将用户 `ws-admin` 设置为企业空间管理员。完成后，点击**创建**。

![image-20230227162134732](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227162134732.png)

![image-20230227162238966](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227162238966.png)

![image-20230227162302919](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227162302919.png)
...
![image-20230227162435251](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227162435251.png)

![image-20230227162532514](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227162532514.png)

4.邀请 `project-admin` 和 `project-regular` 进入企业空间，分别授予 `demo-workspace-self-provisioner` 和 `demo-workspace-viewer` 角色，点击**确定**。

![image-20230227162629619](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227162629619.png)

![image-20230227162714942](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227162714942.png)
...
![image-20230227162743295](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227162743295.png)
...
![image-20230227162941204](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227162941204.png)

![image-20230227163007206](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227163007206.png)

2.输入项目名称（例如 `yanxuan-project`），点击**确定**。您还可以为项目添加别名和描述。

![image-20230227163050655](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227163050655.png)
...
![image-20230227163152590](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227163152590.png)

![image-20230227163229901](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227163229901.png)

![image-20230227163311803](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227163311803.png)

![image-20230227163343165](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227163343165.png)
...
![image-20230227163627977](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227163627977.png)
...
![image-20221021235714102](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20221021235714102.png)

![image-20221021235838690](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20221021235838690.png)

![image-20221021235910131](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20221021235910131.png)

![image-20221022000034118](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20221022000034118.png)

![image-20221022000103051](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20221022000103051.png)

![image-20221022000159140](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20221022000159140.png)

![image-20221022000310077](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20221022000310077.png)
...
![image-20230227163913250](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227163913250.png)

![image-20230227163940410](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227163940410.png)

2.输入 DevOps 项目名称（例如 `yanxuan-devops`），然后点击**确定**，也可以为该项目添加别名和描述。

![image-20230227164038505](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227164038505.png)

![image-20230227164101039](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227164101039.png)

3.点击刚创建的项目查看其详细页面。

![image-20230227164139310](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227164139310.png)

4.转到 **DevOps 项目设置**，然后选择 **DevOps 项目成员**。点击**邀请**授予 `project-regular` 用户 `operator` 的角色，允许其创建流水线和凭证。

![image-20230227164211991](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227164211991.png)

![image-20230227164252895](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227164252895.png)

![image-20230227164314075](/云原生/paas/paas-08-kubesphere多租户系统应用/image-20230227164314075.png)
