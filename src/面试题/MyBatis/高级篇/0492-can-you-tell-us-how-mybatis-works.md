---
title: "能说说MyBatis的工作原理吗？"
sidebarGroup: "高级篇"
shortTitle: "能说说MyBatis的工作原理吗？"
order: 492
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "首先，我们知道MyBatis是一个优秀的持久层框架，它是用来简化数据库操作的。传统地，如果没有使用框架，我们可能需要手写大量的JDBC代码，处理很多的资源管理和异常处理。但MyBatis帮我们抽象了这一部分。好，让我们来看一下MyBatis"
article: false
---

> 来源：[能说说MyBatis的工作原理吗？](https://www.yuque.com/tulingzhouyu/db22bv/afgcfcyf1fmsg7zi)
