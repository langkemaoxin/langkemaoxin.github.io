---
title: "Zookeeper 对节点的 watch 监听通知是永久的吗"
sidebarGroup: "Zookeeper"
shortTitle: "Zookeeper 对节点的 watch 监听通知是永久的吗"
order: 625
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "在 ZooKeeper 中，节点监视（watch）通知不是永久的，而是一次性触发。当客户端注册一个监视事件，例如监视一个节点的数据变化或子节点的变化时，如果相应的节点状态发生了变化，ZooKeeper 会通知客户端，并触发监视事件。一旦监视"
article: false
---

> 来源：[Zookeeper 对节点的 watch 监听通知是永久的吗](https://www.yuque.com/tulingzhouyu/db22bv/kfyc3piccqefvefr)
