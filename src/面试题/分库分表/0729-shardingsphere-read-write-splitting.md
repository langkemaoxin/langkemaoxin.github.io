---
title: "ShardingSphere 的读写分离是如何实现的？"
sidebarGroup: "分库分表"
shortTitle: "ShardingSphere 的读写分离是如何实现的？"
order: 729
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "读写分离是ShardingSphere 的重要功能。主要负责将 SQL 语句根据他们的执行逻辑不同，路由到不同的数据库中执行。读写分离功能只负责 SQL 路由，而不负责不同数据库之间的数据同步。通常，MySQL 的数据同步是通过 MySQL"
article: false
---

> 来源：[ShardingSphere 的读写分离是如何实现的？](https://www.yuque.com/tulingzhouyu/db22bv/cnbdvsnzgdoz0vpi)
