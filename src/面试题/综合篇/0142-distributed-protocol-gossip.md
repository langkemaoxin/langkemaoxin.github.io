...
title: "分布式协议Gossip"
sidebarGroup: "综合篇"
shortTitle: "分布式协议Gossip"
order: 142
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "Gossip Protocol也叫Epidemic Protocol（流行病协议），还有其他名称，如流言算法、疫情传播算法等。该协议的发布最早是在1987年8月温哥华举行的第六届ACM分布式计算原理的学术会议上，该论文介绍了几种用于分发更新"
article: false
---

> 来源：[分布式协议Gossip](https://www.yuque.com/tulingzhouyu/db22bv/wpogs3206ta8ff72)
...
![](/面试题/综合篇/0142-distributed-protocol-gossip/img-612578b70e62.svg)

![](/面试题/综合篇/0142-distributed-protocol-gossip/img-50d659b723fd.svg)

即复杂度，

![](/面试题/综合篇/0142-distributed-protocol-gossip/img-6b576563042d.svg)

为每个人的朋友圈数量，

![](/面试题/综合篇/0142-distributed-protocol-gossip/img-95f26e8e26b5.svg)
...
> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2023/jpeg/8380143/1686987989796-18e4f4a7-07b4-4ed9-af4d-5b9e0858a85c.jpeg)
...
> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2023/jpeg/8380143/1686988506806-d6d65d69-8753-4535-a946-71b34e6a3d79.jpeg)

每个节点都会定期随机选择节点池中的一些节点，通过交换数据内容来解决两者之间的任何差异。如上图T1、T2、T3表示不同时间点各节点通知周边节点数据交互的示例。

> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2023/jpeg/8380143/1686988654222-972eb152-9d0b-4403-90f1-cc56794f1d8e.jpeg)
...
> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2023/jpeg/8380143/1686989056784-d3e1eda7-5096-408d-8043-be9a5205c37d.jpeg)
...
> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2023/jpeg/8380143/1686989570822-63c9117a-62ec-49a5-af11-3a7481baf9f9.jpeg)
...
O(log2n)，n为总节点数
O((m*n)t)，n为节点数(递减)，m为更新消息数，t为周期数
1.可靠
2.定时重复
3.可容错
1.消息冗余
...
> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2023/jpeg/8380143/1686989985364-32295808-3b26-41e2-8c7e-fc93f0a24236.jpeg)
...
> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2023/jpeg/8380143/1686990063749-2d3f0741-a18c-459a-815c-6c9517804574.jpeg)
...
> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2023/jpeg/8380143/1686990215795-e611febf-fbcb-4785-8975-4d77231b45b3.jpeg)
...
假设每个节点在每个周期被感染的概率都是固定的

![](/面试题/综合篇/0142-distributed-protocol-gossip/img-5d3fa6537cab.svg)

，每个个节点接收数据更新i周期仍再次接收冗余数据的概率为pi，这里将再次接收更新数据的无效冗余操作称之为复发，之后在i+1周期后复发的概率为pi+1；假设节点总数为n，那么

- **拉模式（Pull）复发概率** 根据拉模式（Pull）特点，每次都要进行数据推送，由其他节点对比返回后决定是否更新，其他被感染节点数据因此每个节点都有可能在下一个周期产生复发现象
![](/面试题/综合篇/0142-distributed-protocol-gossip/img-60182aaa6abc.svg)
- **推模式（Push）** 复发概率 根据推模式（Push）特点，每次推送后会记录，因此会推送节点会递减
![](/面试题/综合篇/0142-distributed-protocol-gossip/img-eecca547fa1a.svg)
- **推拉模式（Push&Pull）** 复发概率 可参考**拉模式（Pull）**
...
- **最终一致性** 消息会以一传十、十传百的指数级速度在网络中传播，因此系统状态的不一致可以在很快的时间内收敛到一致，消息传播速度达到了**logN**
