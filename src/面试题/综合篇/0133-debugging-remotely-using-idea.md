---
title: "使用 IDEA 远程 Debug 调试"
sidebarGroup: "综合篇"
shortTitle: "使用 IDEA 远程 Debug 调试"
order: 133
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "背景有时候我们需要进行远程的debug，本文研究如何进行远程debug，以及使用 IDEA 远程debug的过程中的细节。看完可以解决你的一些疑惑。配置远程debug的服务，以springboot微服务为例(springcloud的应该差不"
article: false
---

> 来源：[使用 IDEA 远程 Debug 调试](https://www.yuque.com/tulingzhouyu/db22bv/vn7vhycdiffiva47)
...
![image](/面试题/综合篇/0133-debugging-remotely-using-idea/img-fc15b4c1d8c2.png)

![image](/面试题/综合篇/0133-debugging-remotely-using-idea/img-6459f4a7aab1.png)
...
![image](/面试题/综合篇/0133-debugging-remotely-using-idea/img-72a346a0b67a.png)
...
![image](/面试题/综合篇/0133-debugging-remotely-using-idea/img-13fafb08cdee.png)
...
![image](/面试题/综合篇/0133-debugging-remotely-using-idea/img-8eb9448b71ff.png)

如果加上 @Transational 就不会有两条记录了，`dropframe`的时候事务没被提交，再次执行该插入代码也不会插入2条。

##### 关于什么是drop frame

![image](/面试题/综合篇/0133-debugging-remotely-using-idea/img-701e395db7a6.png)
