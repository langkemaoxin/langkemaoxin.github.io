---
title: "UNION 与UNION ALL 的区别？"
sidebarGroup: "Mysql"
shortTitle: "UNION 与UNION ALL 的区别？"
order: 397
date: 2026-04-15
category: "面试题"
tag:
  - "面试题"
description: "UNION和UNION ALL是在SQL中用于合并查询结果集的操作符，它们之间存在以下区别：UNION：UNION用于合并两个或多个查询结果集，并去除重复的行。它将多个查询的结果合并为一个结果集，并自动去除重复的行。在执行UNION操作时，"
article: false
---

> 来源：[UNION 与UNION ALL 的区别？](https://www.yuque.com/tulingzhouyu/db22bv/nttmmftsi3uchf8s)
