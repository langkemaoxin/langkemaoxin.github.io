---
title: "SpringBoot的启动原理？"
sidebarGroup: "SpringBoot"
shortTitle: "SpringBoot的启动原理？"
order: 466
date: 2026-08-05
category: "面试题"
tag:
  - "面试题"
description: "运行Main方法： 应用程序启动始于Main方法的执行。在Main方法中，创建了一个SpringApplication实例，用于引导应用程序的启动。同时，SpringApplication会根据spring.factories文件加载并注册"
article: false
---

> 来源：[SpringBoot的启动原理？](https://www.yuque.com/tulingzhouyu/db22bv/xspr2fqxkyo63s1l)
