...
- [如果没有权限系统：一步步「发明」Windows 权限](Windows/permissions/windows-permission-acl-ad.md)：单概念递进版 ACL / AD，把 Windows 权限模型真正讲透。
...
这个站用来沉淀我在工作和自学里真正啃过的东西：**.NET / Java 源码调试**、**大数据与 Hadoop**、**Windows 权限与环境**、**AI 工程化与自动化**，以及一点用 B1 词汇量读论文的英语笔记。
...
- [AI](Ai/)：Playwright、RAG、本地大模型与 Agent
