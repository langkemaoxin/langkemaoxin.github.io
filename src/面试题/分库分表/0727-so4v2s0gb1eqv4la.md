---
title: "ShardingSphere的核心模块有哪些？他们是如何工作的？"
sidebarGroup: "分库分表"
shortTitle: "ShardingSphere的核心模块有哪些？他们是如何工作的？"
order: 727
date: 2026-05-19
category: "面试题"
tag:
  - "面试题"
description: "ShardingSphere 是一个分布式数据库中间件，它由多个核心模块组成，包括 Sharding-JDBC、Sharding-Proxy 和 Sharding-Sidecar。Sharding-JDBC 是 ShardingSphere"
article: false
---

> 来源：[ShardingSphere的核心模块有哪些？他们是如何工作的？](https://www.yuque.com/tulingzhouyu/db22bv/so4v2s0gb1eqv4la)
