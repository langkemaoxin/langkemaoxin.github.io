---
title: "什么是守护线程？与普通线程的区别"
sidebarGroup: "Java基础"
shortTitle: "什么是守护线程？与普通线程的区别"
order: 192
date: 2026-08-05
category: "面试题"
tag:
  - "面试题"
description: "守护线程是在程序运行时在后台提供一种支持性的线程。与普通线程相比，守护线程有以下几个区别：终止条件：当所有用户线程结束时，守护线程会自动停止。换句话说，守护线程不会阻止程序的终止，即使它们还没有执行完任务。生命周期：守护线程的生命周期与主线"
article: false
---

> 来源：[什么是守护线程？与普通线程的区别](https://www.yuque.com/tulingzhouyu/db22bv/smvpftyn0rowlbxc)
