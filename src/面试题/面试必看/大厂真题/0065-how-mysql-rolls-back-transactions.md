...
title: "Mysql是如何回滚事务的"
sidebarGroup: "大厂真题"
shortTitle: "Mysql是如何回滚事务的"
order: 65
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "MySQL使用了Undo Log（回滚日志）来实现事务的回滚操作。当一个事务需要回滚时，MySQL会根据事务的Undo Log来撤销对数据库的修改操作，将数据恢复到事务开始之前的状态。具体的回滚过程如下：事务回滚触发：当事务发生异常、被显式"
article: false
---

> 来源：[Mysql是如何回滚事务的](https://www.yuque.com/tulingzhouyu/db22bv/hbrw3hgh7pzao0qh)
