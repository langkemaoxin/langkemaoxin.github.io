---
title: "在Kubernetes中，如何进行存储管理"
sidebarGroup: "Docker与K8S"
shortTitle: "在Kubernetes中，如何进行存储管理"
order: 1359
date: 2026-04-08
category: "面试题"
tag:
  - "面试题"
description: "在Kubernetes中，存储管理是通过Volume和Persistent Volume（PV）进行的。Volume是提供持久化存储的抽象概念，映射到Pod内的容器。Kubernetes提供了多种Volume类型，如emptyDir、hos"
article: false
---

> 来源：[在Kubernetes中，如何进行存储管理](https://www.yuque.com/tulingzhouyu/db22bv/tns9fz0trvise04a)
