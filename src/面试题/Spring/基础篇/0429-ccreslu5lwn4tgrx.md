---
title: "说一下Spring的事务传播行为"
sidebarGroup: "基础篇"
shortTitle: "说一下Spring的事务传播行为"
order: 429
date: 2026-07-15
category: "面试题"
tag:
  - "面试题"
description: "事务的传播特性指的是当一个事务方法被另一个事务方法调用时，这个事务方法应该如何进行？  Spring框架提供了多种事务传播行为：REQUIRED：如果当前存在事务，则加入该事务，如果当前没有事务，则创建一个新的事务。这是最常用的传播行为，也"
article: false
---

> 来源：[说一下Spring的事务传播行为](https://www.yuque.com/tulingzhouyu/db22bv/ccreslu5lwn4tgrx)
