...
![image-20221109104658045](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109104658045.png)

![image-20221109104750553](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109104750553.png)

![image-20221109104816259](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109104816259.png)

![image-20221109104903316](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109104903316.png)

![image-20221109105127951](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109105127951.png)

![image-20221109105202153](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109105202153.png)

## 2.2 创建项目部署apisix

接下来我们创建一个名为 `apisix-system` 的项目。进入项目页面后，选择在「应用负载」中创建「应用」的方式来部署 Apache APISIX，并选择 `apisix` 应用模版开始进行部署。

![image-20221109105658653](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109105658653.png)

![image-20221109105939507](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109105939507.png)

![image-20221109110002581](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109110002581.png)

![image-20221109110045357](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109110045357.png)

![image-20221109110111199](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109110111199.png)

![image-20221109110138894](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109110138894.png)

![image-20221109110223655](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109110223655.png)
...
![image-20221109110658198](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109110658198.png)

![image-20221109110330279](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109110330279.png)

![image-20221109110413153](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109110413153.png)

> 将应用命名为 `apisix` 以避免多个组件（Gateway, Dashboard, Ingress Controller）的工作负载及服务名称产生不匹配的情况

![image-20221109110833621](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109110833621.png)
...
![image-20221109113704158](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109113704158.png)

![image-20221109123103193](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109123103193.png)
...
![image-20221109123317951](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109123317951.png)

>使用默认的用户名及密码 `admin` 登录 Apache APISIX Dashboard，可以进入「系统信息」页面即可查看到我们当前连接管理的「Apache APISIX 节点」的信息。

![image-20221109123612289](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109123612289.png)

![image-20221109123704546](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109123704546.png)

# 三、使用 Apache APISIX Ingress Controller

## 3.1 创建应用及服务

![image-20221109161849128](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109161849128.png)

![image-20221109161923916](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109161923916.png)

![image-20221109162319539](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109162319539.png)

![image-20221109162345681](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109162345681.png)

![image-20221109162432991](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109162432991.png)

![image-20221109162537262](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109162537262.png)

![image-20221109162610104](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109162610104.png)

![image-20221109162748503](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109162748503.png)

![image-20221109162811501](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109162811501.png)

![image-20221109162854956](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109162854956.png)

## 3.2 创建应用路由

![image-20221109163033289](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109163033289.png)

![image-20221109163108714](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109163108714.png)

![image-20221109163132116](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109163132116.png)

![image-20221109163231783](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109163231783.png)

> 上图域名应该为 web1.msb.com

其添加 `kubernetes.io/ingress.class`: `apisix` 的键值。

![image-20221109163416790](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109163416790.png)

![image-20221109163441802](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109163441802.png)
...
![image-20221109163556918](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109163556918.png)

![image-20221109163621176](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109163621176.png)
...
![image-20221109165846499](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109165846499.png)

![image-20221109165910450](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109165910450.png)

![image-20221109165954202](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109165954202.png)

![image-20221109170028563](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109170028563.png)

![image-20221109170103129](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109170103129.png)

![image-20221109170237754](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109170237754.png)
...
![image-20221109170411633](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109170411633.png)

![image-20221109170506973](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109170506973.png)
...
![image-20221109174310129](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109174310129.png)

![image-20221109174414209](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109174414209.png)

在弹出的「编辑设置」面板中，进入到 `apisix` 容器的编辑界面，找到「端口设置」，添加一个新的名为 `prom` 的端口映射到容器的 `9091` 端口，保存后 `apisix` 工作负载会重启。

![image-20221109174527098](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109174527098.png)

![image-20221109174555094](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109174555094.png)

![image-20221109174626720](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109174626720.png)

![image-20221109174654052](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109174654052.png)
...
![image-20221109175515781](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109175515781.png)

![image-20221109175533569](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109175533569.png)

## 5.3 将 Apache APISIX 网关指标接入自定义监控面板

下面我们在项目左侧菜单列表中找到「监控告警」中的「自定义监控」，开始「创建」自定义监控面板。

![image-20221109175709225](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109175709225.png)

![image-20221109175743396](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109175743396.png)

在弹出窗口中填入「名称」，选择「自定义」监控模版，并进入「下一步」的监控面板创建。

![image-20221109175851208](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109175851208.png)
...
![image-20221109180006622](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109180006622.png)

![image-20221109180124305](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109180124305.png)
...
![image-20221109180217506](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109180217506.png)

![image-20221109180250706](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109180250706.png)

![image-20221109180541126](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109180541126.png)

![image-20221109180831113](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109180831113.png)

![image-20221109180903391](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109180903391.png)

![image-20221109180931561](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109180931561.png)
...
![image-20221109181158263](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109181158263.png)

![image-20221109181325139](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109181325139.png)

![image-20221109181400046](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109181400046.png)

![image-20221109181425851](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109181425851.png)

![image-20221109181453369](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109181453369.png)

![image-20221109181512687](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109181512687.png)

![image-20221109181552815](/云原生/paas/paas-04-kubesphere中集成apisix/image-20221109181552815.png)
