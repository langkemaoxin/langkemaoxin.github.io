...
sidebarGroup: "高级篇"
shortTitle: "Spring 框架中都用到了哪些设计模式？"
order: 444
date: 2026-05-03
category: "面试题"
tag:
  - "面试题"
description: "简单工厂：BeanFactory：Spring的BeanFactory充当工厂，负责根据配置信息创建Bean实例。它是一种工厂模式的应用，根据指定的类名或ID创建Bean对象。工厂方法：FactoryBean：FactoryBean接口允许"
article: false
---

> 来源：[Spring 框架中都用到了哪些设计模式？](https://www.yuque.com/tulingzhouyu/db22bv/yc279v327deg3wvi)
