...
sidebarGroup: "Redis"
shortTitle: "REDIS集群会有写操作丢失吗？为什么"
order: 533
date: 2026-01-20
category: "面试题"
tag:
  - "面试题"
description: "在Redis集群中，由于采用了主从复制模型的异步复制机制，写操作有一定的丢失风险。当客户端向主节点发送写操作时，主节点会立即返回成功响应，而不等待所有从节点执行复制。如果主节点在执行完写操作后出现故障或网络问题，导致从节点无法及时接收到复制"
article: false
---

> 来源：[REDIS集群会有写操作丢失吗？为什么](https://www.yuque.com/tulingzhouyu/db22bv/abu38cy825eemlr9)
