---
title: "通俗易懂-MySQL常用函数解析"
sidebarGroup: "Mysql"
shortTitle: "通俗易懂-MySQL常用函数解析"
order: 345
date: 2026-05-27
category: "面试题"
tag:
  - "面试题"
description: "数学函数count()count()、count(field) 统计某个结果集中的总数量，field为要统计的字段。select count( 1 ) from order_details;sum()sum(field) 统计某个字段累计的"
article: false
---

> 来源：[通俗易懂-MySQL常用函数解析](https://www.yuque.com/tulingzhouyu/db22bv/hoh5yl13z8ue2kak)

![image](/面试题/Mysql/0345-easy-to-understand-mysql-common-function-parsing/img-7d0c44401863.png)
