---
title: "说说你对排序 - 快速排序的理解"
sidebarGroup: "数据结构与算法"
shortTitle: "说说你对排序 - 快速排序的理解"
order: 883
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "快速排序是一种高效的排序算法，基于分治思想。它的核心思路是通过选择基准元素，将待排序数组划分为两个子数组，其中一个子数组的元素都小于基准元素，另一个子数组的元素都大于基准元素。然后对这两个子数组递归执行快速排序，最终得到整个数组有序。具体实"
article: false
---

> 来源：[说说你对排序 - 快速排序的理解](https://www.yuque.com/tulingzhouyu/db22bv/de2vls9oqxkqb36p)
