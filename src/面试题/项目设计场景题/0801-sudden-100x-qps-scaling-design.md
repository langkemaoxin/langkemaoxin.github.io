---
title: "如果系统 QPS 突然提升 100 倍你会怎么设计"
sidebarGroup: "项目设计场景题"
shortTitle: "如果系统 QPS 突然提升 100 倍你会怎么设计"
order: 801
date: 2026-02-01
category: "面试题"
tag:
  - "面试题"
description: "围绕支撑高并发的业务场景怎么设计系统才合理？面对超高的并发，首先硬件层面机器要能扛得住，其次架构设计做好微服务的拆分，代码层面各种缓存、削峰、解耦等等问题要处理好，数据库层面做好读写分离、分库分表，稳定性方面要保证有监控，熔断限流降级该有的"
article: false
---

> 来源：[如果系统 QPS 突然提升 100 倍你会怎么设计](https://www.yuque.com/tulingzhouyu/db22bv/tpoubgsg1lcnqk12)
...
![image](/面试题/项目设计场景题/0801-sudden-100x-qps-scaling-design/img-7e3a93a2f25d.jpg)

于是，集群架构的架构开始出现，单机无法抗住的压力，最简单的办法就是水平拓展横向扩容了，这样，通过负载均衡把压力流量分摊到不同的机器上，暂时是解决了单点导致服务不可用的问题。

![image](/面试题/项目设计场景题/0801-sudden-100x-qps-scaling-design/img-5530b882f520.jpg)

但是随着业务的发展，在一个项目里维护所有的业务场景使开发和代码维护变得越来越困难，一个简单的需求改动都需要发布整个服务，代码的合并冲突也会变得越来越频繁，同时线上故障出现的可能性越大。微服务的架构模式就诞生了。

![image](/面试题/项目设计场景题/0801-sudden-100x-qps-scaling-design/img-bf53dee03e4f.jpg)
...
![image](/面试题/项目设计场景题/0801-sudden-100x-qps-scaling-design/img-e2f6fdc196dd.jpg)
...
![image](/面试题/项目设计场景题/0801-sudden-100x-qps-scaling-design/img-4f1d3bb5c64a.jpg)
...
![image](/面试题/项目设计场景题/0801-sudden-100x-qps-scaling-design/img-1865ad77ddbf.jpg)
...
![image](/面试题/项目设计场景题/0801-sudden-100x-qps-scaling-design/img-46e5a7f68b27.jpg)
...
![image](/面试题/项目设计场景题/0801-sudden-100x-qps-scaling-design/img-156f87c727bd.jpg)
...
![image](/面试题/项目设计场景题/0801-sudden-100x-qps-scaling-design/img-50b71d18794d.jpg)
...
![image](/面试题/项目设计场景题/0801-sudden-100x-qps-scaling-design/img-e2489e4ba32f.jpg)
...
![image](/面试题/项目设计场景题/0801-sudden-100x-qps-scaling-design/img-3c49de0002f7.jpg)
...
![image](/面试题/项目设计场景题/0801-sudden-100x-qps-scaling-design/img-2f1693fdcddf.jpg)
...
![image](/面试题/项目设计场景题/0801-sudden-100x-qps-scaling-design/img-a51d3c9cdde4.jpg)
...
![image](/面试题/项目设计场景题/0801-sudden-100x-qps-scaling-design/img-0890ff2af1f6.jpg)
...
![image](/面试题/项目设计场景题/0801-sudden-100x-qps-scaling-design/img-6c3eb5f3a39f.jpg)

#### 缓存穿透

缓存穿透是指查询不存在缓存中的数据，每次请求都会打到DB，就像缓存不存在一样。

![image](/面试题/项目设计场景题/0801-sudden-100x-qps-scaling-design/img-d73c4f98001c.jpg)
...
![image](/面试题/项目设计场景题/0801-sudden-100x-qps-scaling-design/img-5ef1c9a6ef02.jpg)

#### 缓存雪崩

当某一时刻发生大规模的缓存失效的情况，比如你的缓存服务宕机了，会有大量的请求进来直接打到DB上，这样可能导致整个系统的崩溃，称为雪崩。雪崩和击穿、热key的问题不太一样的是，他是指大规模的缓存都过期失效了。

![image](/面试题/项目设计场景题/0801-sudden-100x-qps-scaling-design/img-ce0da262a700.jpg)
...
![image](/面试题/项目设计场景题/0801-sudden-100x-qps-scaling-design/img-d970b07fa6b8.jpg)
