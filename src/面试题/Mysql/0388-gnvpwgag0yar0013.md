...
title: "什么是最左前缀原则？"
sidebarGroup: "Mysql"
shortTitle: "什么是最左前缀原则？"
order: 388
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "最左前缀原则（Leftmost Prefix Rule）是索引在数据库查询中的一种使用规则。它指的是在使用复合索引时，索引的最左边的连续几个列会被用于查询过滤条件的匹配。具体来说，如果在表中创建了一个复合索引，包含多个列 A、B、C，那么最"
article: false
---

> 来源：[什么是最左前缀原则？](https://www.yuque.com/tulingzhouyu/db22bv/gnvpwgag0yar0013)
