...
title: "谈谈MySQL事务隔离级别"
sidebarGroup: "大厂真题"
shortTitle: "谈谈MySQL事务隔离级别"
order: 56
date: 2026-06-07
category: "面试题"
tag:
  - "面试题"
description: "MySQL事务隔离级别是指在并发环境下，事务之间相互隔离的程度。MySQL提供了四个事务隔离级别，分别是读未提交、读已提交、可重复读和串行化。读未提交是最低的隔离级别，事务之间相互影响最大。一个事务可以读取到另一个事务尚未提交的数据，可能会"
article: false
---

> 来源：[谈谈MySQL事务隔离级别](https://www.yuque.com/tulingzhouyu/db22bv/czr6nlmzzwy3ko1z)
