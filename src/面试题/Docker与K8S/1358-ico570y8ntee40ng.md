---
title: "简述Kubernetes中的Deployment、StatefulSet、DaemonSet的区别"
sidebarGroup: "Docker与K8S"
shortTitle: "简述Kubernetes中的Deployment、StatefulSet、DaemonSet的区别"
order: 1358
date: 2026-04-08
category: "面试题"
tag:
  - "面试题"
description: "Kubernetes中的Deployment、StatefulSet和DaemonSet有以下区别：应用场景：Deployment适用于无状态的应用场景。也就是说，即使一个Pod失败，也不需要从这个Pod中恢复数据。一般来说，开发一个有状态"
article: false
---

> 来源：[简述Kubernetes中的Deployment、StatefulSet、DaemonSet的区别](https://www.yuque.com/tulingzhouyu/db22bv/ico570y8ntee40ng)
