---
title: "如何判断一个对象是否可以被回收"
sidebarGroup: "Java基础"
shortTitle: "如何判断一个对象是否可以被回收"
order: 165
date: 2026-04-23
category: "面试题"
tag:
  - "面试题"
description: "对象存活判断在堆里存放着几乎所有的Java对象实例，在GC执行垃圾回收之前，首先需要区分出内存中哪些是存活对象，哪些是已经死亡的对象。只有被标记为己经死亡的对象，GC才会在执行垃圾回收时，释放掉其所占用的内存空间，因此这个过程我们可以称为垃"
article: false
---

> 来源：[如何判断一个对象是否可以被回收](https://www.yuque.com/tulingzhouyu/db22bv/qwxwgiugvbcrl5np)
...
![image](/面试题/Java基础/0165-how-to-tell-if-an-object-can-be-recycled/img-3b84b3de2c23.jpg)
...
![image](/面试题/Java基础/0165-how-to-tell-if-an-object-can-be-recycled/img-1bd56363ca83.png)
