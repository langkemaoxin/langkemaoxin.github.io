...
![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-6d0804580df4.png)
...
![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-2c6b9b03487f.png)
...
![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-1ab86c6caa40.png)
...
![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-44c15bee1d3e.png)
...
![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-cd5ebfe4ca28.png)
...
![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-907b7da68cdb.png)

**在Java语言里，类型的加载、连接、初始化都是在程序运行期间完成的**，这种策略让类加载时稍微增加一些性能开销，但也为Java应用提供了高度的灵活性，Java天生可以动态扩展的语言特性就是基于运行期动态加载和动态连接这个特点实现的。

![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-8c47c10808e4.png)
...
![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-4b440768d2b0.png)
...
![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-8e7f6d5a4c40.png)
...
![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-5734c9f83eb5.png)
...
![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-d01c1ea27926.png)

而在 G1 回收器中，其将一大块的内存分为许多细小的区块，从而不要求内存是连续的。

![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-492e795b7734.png)
...
![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-36c4d25af8ce.png)
...
![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-88c2931ca315.png)

上面是基于JDK17截图的Java工具集，已经删除了VisualVM了，在此我们基于GCEasy来进行GC日志分析。

官网地址为：[https://gceasy.io/](https://gceasy.io/) 它有在线分析版和离线分析版都可以使用～

![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-955c756b09ff.png)

![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-17d07171275a.png)

![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-adf83fc1b042.png)
...
![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-6c67be755a2a.png)
...
![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-b99d3d0aa53f.png)
...
![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-9c5030355c40.png)

再点击 **See stacktrace** 看看线程栈基本就能定位到问题代码了。

![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-89d65136819d.png)
...
![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-21d0d38fdead.png)

在 char[] 上点击右键，选择 List objects -> with incoming references，就可以列出所有的 char[] 实例，以及每个 char[] 的整个引用关系链：

![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-7f8708840f1f.png)
...
![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-ddef8ffe24ce.png)

如果希望看到完整内容的话，可以右键选择 Copy->Value，把值复制到剪贴板或保存到文件中：

![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-8e67657383ff.png)

### 线程栈 — 分析代码

可以点击工具栏的第五个按钮，打开线程视图来分析 OOMTest 执行什么逻辑。

![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-9e0fc1a1d821.png)
...
![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-e6278756644d.png)

输入 help 命令，可以看到所有支持的命令列表。这里主要会用到 dashboard、thread、jad、watch 等命令，来定位高CPU的问题。

![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-87e4f338cb82.png)

### dashboard — 展示整体情况

`dashboard` 命令整体展示了进程所有线程、内存、GC 等情况，可以明显看到两个CPU占用很高的线程，从线程名字来看应该是线程池的线程。

![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-c1c61fe5c5aa.png)
...
![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-23e2649a9834.png)

### watch — 监控参数

如果想要观察方法的入参和出参，可以用 watch 命令来观察：

![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-884e04c787a7.png)

### jad — 反编译

![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-e0d104e5972f.png)
...
![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-92b93f75de87.png)

然后修改下源码：添加了一行输出日志

![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-edf28e4da85a.png)

2、使用 mc 命令反编译源文件

反编译后会生成对应的 class 文件：

![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-05764f68313d.png)

3、使用 redefine 重载类

![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-b1fb74a8d306.png)

就可以看到控制台已经在输出我们打印的日志了：

![image](/面试题/系列篇/0098-java-performance-tuning-interview-assignment/img-7871f4a558c5.png)
