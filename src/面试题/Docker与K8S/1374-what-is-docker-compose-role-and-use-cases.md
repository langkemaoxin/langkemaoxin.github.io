---
title: "什么是Docker Compose？请简述其作用和使用场景"
sidebarGroup: "Docker与K8S"
shortTitle: "什么是Docker Compose？请简述其作用和使用场景"
order: 1374
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "Docker Compose是一个用于定义和运行多个Docker容器的工具。它使用YAML文件来配置应用程序的服务，并允许您通过一个命令来启动、停止和重启应用中的所有服务。Docker Compose的主要作用是简化容器的管理和部署。它使得"
article: false
---

> 来源：[什么是Docker Compose？请简述其作用和使用场景](https://www.yuque.com/tulingzhouyu/db22bv/rom9qfq3573znyct)
