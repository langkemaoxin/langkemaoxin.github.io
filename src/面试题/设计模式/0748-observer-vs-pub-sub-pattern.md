---
title: "观察者模式和发布-订阅模式有什么异同？它们在哪些情况下会被使用？"
sidebarGroup: "设计模式"
shortTitle: "观察者模式和发布-订阅模式有什么异同？它们在哪些情况下会被使用？"
order: 748
date: 2026-04-20
category: "面试题"
tag:
  - "面试题"
description: "观察者模式（Observer Pattern）和发布-订阅模式（Publish-Subscribe Pattern）都是用于处理对象之间的一对多依赖关系，但它们在实现方式和应用场景上有一些异同。观察者模式：观察者模式定义了一种一对多的依赖关"
article: false
---

> 来源：[观察者模式和发布-订阅模式有什么异同？它们在哪些情况下会被使用？](https://www.yuque.com/tulingzhouyu/db22bv/pz4f14mz4qra7p7i)
