---
title: "Redis中key过期了一定会立即删除吗"
sidebarGroup: "Redis"
shortTitle: "Redis中key过期了一定会立即删除吗"
order: 516
date: 2026-05-06
category: "面试题"
tag:
  - "面试题"
description: "在 Redis 中，键的过期和实际删除并不是实时的，Redis 采用了一种惰性删除（lazy deletion）和定期删除（periodic expiration）相结合的机制来处理过期键。以下是这两种机制的具体运作方式：1. 惰性删除（L"
article: false
---

> 来源：[Redis中key过期了一定会立即删除吗](https://www.yuque.com/tulingzhouyu/db22bv/uxfs5b661xuythb5)
