...
title: "MySQL 索引分类?"
sidebarGroup: "Mysql"
shortTitle: "MySQL 索引分类?"
order: 379
date: 2026-01-13
category: "面试题"
tag:
  - "面试题"
description: "在MySQL中，索引按照索引列的类型可以分为以下几种：主键索引：用于唯一标识每一条记录，主键索引的值不允许重复且不能为空，并且一个表只能有一个主键索引。唯一索引：用于保证索引列的值唯一，允许为空值，但是一个表可以有多个唯一索引。普通索引：没"
article: false
---

> 来源：[MySQL 索引分类?](https://www.yuque.com/tulingzhouyu/db22bv/og4ypsxhigzk3d06)
