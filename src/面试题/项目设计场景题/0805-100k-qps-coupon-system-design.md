---
title: "如何从零搭建10W QPS 高并发优惠券系统"
sidebarGroup: "项目设计场景题"
shortTitle: "如何从零搭建10W QPS 高并发优惠券系统"
order: 805
date: 2025-12-30
category: "面试题"
tag:
  - "面试题"
description: "春节活动中，多个业务方都有发放优惠券的需求，且对发券的 QPS 量级有明确的需求。所有的优惠券发放、核销、查询都需要一个新系统来承载。因此，我们需要设计、开发一个能够支持十万级 QPS 的券系统，并且对优惠券完整的生命周期进行维护。需求拆解"
article: false
---

> 来源：[如何从零搭建10W QPS 高并发优惠券系统](https://www.yuque.com/tulingzhouyu/db22bv/ygrp9ooiwlt6tv2e)
...
![image](/面试题/项目设计场景题/0805-100k-qps-coupon-system-design/img-2f80c551b57e.png)
...
![image](/面试题/项目设计场景题/0805-100k-qps-coupon-system-design/img-038d012d1466.png)

数据结构 ER 图

与系统架构对应的，我们需要建立对应的 MySQL 数据存储表。

![image](/面试题/项目设计场景题/0805-100k-qps-coupon-system-design/img-e65b08f079c3.png)
...
![image](/面试题/项目设计场景题/0805-100k-qps-coupon-system-design/img-9603b40cd925.png)
...
![image](/面试题/项目设计场景题/0805-100k-qps-coupon-system-design/img-efabc67311b3.png)
...
![image](/面试题/项目设计场景题/0805-100k-qps-coupon-system-design/img-63ae9d8b560e.png)

在业务逻辑中，我们在建券模板的时候，就将这种热点券模板做库存拆分，后续扣减库存时，也扣减相应的子库存即可。

**建券**

![image](/面试题/项目设计场景题/0805-100k-qps-coupon-system-design/img-037b7b186969.png)

**库存扣减**

![image](/面试题/项目设计场景题/0805-100k-qps-coupon-system-design/img-9c970b8cd1f0.png)
...
![image](/面试题/项目设计场景题/0805-100k-qps-coupon-system-design/img-226432543db8.png)
