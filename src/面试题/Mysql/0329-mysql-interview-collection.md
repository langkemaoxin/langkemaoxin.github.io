...
title: "💎 MySQL面试题合集"
sidebarGroup: "Mysql"
shortTitle: "💎 MySQL面试题合集"
order: 329
date: 2026-07-31
category: "面试题"
tag:
  - "面试题"
description: "1. 说说你对 MySQL 锁的理解1.MySQL中的锁分类按粒度分表锁、行锁和页锁三种，按类型分读锁和写锁(都属于悲观锁)"
article: false
---

> 来源：[💎 MySQL面试题合集](https://www.yuque.com/tulingzhouyu/db22bv/so6mi5fptaanzosx)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-9223aa52b07e.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-9abf16e1a4d0.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-1d5d70c121b2.gif)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-c9bcaca8fd94.gif)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-8ea6fe10575b.gif)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-0d56653225fb.gif)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-9d9bd8ece445.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-f51604fb81b8.png)

```plsql
Explain SELECT * FROM user1 WHERE name LIKE 'A%' and age = 40;
```

![image](/面试题/Mysql/0329-mysql-interview-collection/img-ebe0c245d7cc.png)

使用索引下推实现，**认真观看数据流转步骤**

![image](/面试题/Mysql/0329-mysql-interview-collection/img-349075864886.png)

```plsql
Explain SELECT * FROM user1 WHERE name LIKE 'A%' and age = 40;
```

![image](/面试题/Mysql/0329-mysql-interview-collection/img-d11b0ecfce1f.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-dd059a2f868a.jpg)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-e0688cc9a1a8.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-618f292fb368.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-c861bcf8000c.jpg)

![image](/面试题/Mysql/0329-mysql-interview-collection/img-90a7377c50da.jpg)

![image](/面试题/Mysql/0329-mysql-interview-collection/img-db34193f3e2b.jpg)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-54231dcfb624.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-7c7da179fc75.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-72ce882d1d23.jpg)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-22fb90e0676a.png)

添加索引后：

![image](/面试题/Mysql/0329-mysql-interview-collection/img-54341735d802.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-eb35e81871cd.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-d5e36a33e496.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-645a2788ec78.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-1edd08c61842.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-062246f5f292.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-0c0b2080ccab.png)

![image](/面试题/Mysql/0329-mysql-interview-collection/img-d18015119bfb.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-858070b27f40.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-3de80c7908bc.png)

不同事务是否可见可参看如下高低水位图。

![image](/面试题/Mysql/0329-mysql-interview-collection/img-da396da1c478.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-92970d4a71ad.png)

![image](/面试题/Mysql/0329-mysql-interview-collection/img-829efcbdf58f.png)
...
1. 下一个版本的列`name`的内容是`'北冥-2'`

1. 该版本的`trx_id`值为`2`
2. 也在`trx_ids`列表内
3. 所以也不符合要求，继续跳到下一个版本。

1. 下一个版本的列`name`的内容是`'北冥'`
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-5f43799d717d.png)

![image](/面试题/Mysql/0329-mysql-interview-collection/img-85a7c06bfe3e.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-275280c51464.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-6a83c9b37963.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-a3047fafe7ca.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-6f473cbbb1c1.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-5a06c5e43f84.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-f30d28ab9c07.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-7d7479d40832.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-fcf198f0f107.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-7651f6f7b3c6.png)

![image](/面试题/Mysql/0329-mysql-interview-collection/img-73663b642b36.png)

![image](/面试题/Mysql/0329-mysql-interview-collection/img-ef2873a0d41a.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-a6c51a743a72.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-c3e0a1be5362.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-f3fa35c06317.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-3537a2dbe22b.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-02b673dd32b6.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-e170c5d368fd.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-2af5268d98ed.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-5f600a7457b3.png)

```plsql
SELECT actors, SUM(price) FROM movies GROUP BY actors WITH ROLLUP;
```

![image](/面试题/Mysql/0329-mysql-interview-collection/img-3d48db65da80.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-b3d414c61136.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-e92a66a206a5.png)

![image](/面试题/Mysql/0329-mysql-interview-collection/img-200e01d68dd7.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-dc6b471a8ddc.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-63c0f2c3e24b.png)
...
> 索引名：idx_customer_id、idx_order_date
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-c98cc62c9341.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-5735a71a1c08.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-364bb438b72a.png)

```sql
SELECT * FROM products WHERE category NOT IN ('Electronics', NULL);
```

![image](/面试题/Mysql/0329-mysql-interview-collection/img-6ab6e7b4a799.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-0b489628f50f.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-14870dd1b215.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-b380fd1cc8a8.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-9eb585ed4444.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-d76d561d43ee.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-f126f02eaca8.png)
...
-
10000132（offset=997）
10000142（offset=1000）

10000123（offset=996）
10000133（offset=998）
10000143（offset=1001）

10000223（offset=1002）
10000233（offset=1003）
10000243（offset=1004）
...
> 嵌入图板：[打开](https://cdn.nlark.com/yuque/0/2024/jpeg/35268836/1715860885880-bce23c76-9328-4d1f-9046-f922b2a1c577.jpeg)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-500c6075e67a.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-d08f56473ff4.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-673bf1e9b7ec.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-514e3471323b.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-59c91fd15944.png)

```plsql
cd /var/lib/mysql
```

![image](/面试题/Mysql/0329-mysql-interview-collection/img-65c1f23951a6.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-15bcef6665d1.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-3a4146da6bfa.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-b81c015d52bc.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-c83a1f2c9f1b.png)

idx_city 索引树，叶子节点存储的是**主键 id**。还有一棵 id 主键聚族索引树，我们再画出聚族索引树图吧

![image](/面试题/Mysql/0329-mysql-interview-collection/img-aa0cd5a61d5d.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-aea6340ca532.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-d476cf49c413.png)
...
![image](/面试题/Mysql/0329-mysql-interview-collection/img-344a6c067056.png)
