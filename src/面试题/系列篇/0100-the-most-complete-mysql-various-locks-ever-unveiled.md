---
title: "😇 史上最全MySQL各种锁详解"
sidebarGroup: "系列篇"
shortTitle: "😇 史上最全MySQL各种锁详解"
order: 100
date: 2026-03-01
category: "面试题"
tag:
  - "面试题"
description: "一、前言锁是计算机在执行多线程或线程时用于并发访问同一共享资源时的同步机制，MySQL中的锁是在服务器层或者存储引擎层实现的，保证了数据访问的一致性与有效性。MySQL锁可以按模式分类为：乐观锁与悲观锁。按粒度分可以分为全局锁、表级锁、页级"
article: false
---

> 来源：[😇 史上最全MySQL各种锁详解](https://www.yuque.com/tulingzhouyu/db22bv/gsvr7pnyd5w504pt)

![image](/面试题/系列篇/0100-the-most-complete-mysql-various-locks-ever-unveiled/img-de27313096af.png)
...
![image](/面试题/系列篇/0100-the-most-complete-mysql-various-locks-ever-unveiled/img-f1d6ac5a84dd.png)
