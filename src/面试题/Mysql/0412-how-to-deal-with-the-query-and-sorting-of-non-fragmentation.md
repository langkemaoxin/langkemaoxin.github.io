---
title: "分表后非分片键的查询、排序怎么处理"
sidebarGroup: "Mysql"
shortTitle: "分表后非分片键的查询、排序怎么处理"
order: 412
date: 2026-03-16
category: "面试题"
tag:
  - "面试题"
description: "在使用分表后，非分片键的查询和排序可以通过以下方式进行处理：联合查询：如果需要执行涉及多个分表的查询，可以使用联合查询（UNION）或者连接查询（JOIN）来合并结果。将查询条件应用到对应的分表，然后将结果联合起来返回给用户。扫描所有分表："
article: false
---

> 来源：[分表后非分片键的查询、排序怎么处理](https://www.yuque.com/tulingzhouyu/db22bv/lk72ltf37te36x28)
