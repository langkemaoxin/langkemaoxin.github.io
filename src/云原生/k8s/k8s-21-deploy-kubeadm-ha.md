...
> **Kubernetes 系列 · 第 21/30 篇**  
> 上一篇：[《容器内 JVM 参数解析与生产优化》](/云原生/k8s/k8s-20-jvm-in-container)  
> 下一篇：[《部署方法横向对比——二进制、RKE/RKE2、k0s、sealos 与 kubespray》](/云原生/k8s/k8s-22-deploy-methods)
...
> 💡 本文聚焦 kubeadm：它是官方推荐路径，也是 kubekey 等工具的底层实现——学会了 kubeadm，其它工具的排障也就有了抓手。各部署方法的深度对比见[下一篇](/云原生/k8s/k8s-22-deploy-methods)。
